...
class USequencesKt___USequencesKt {
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM408constructorimpl = 0;
        while (it.hasNext()) {
            iM408constructorimpl = UInt.m408constructorimpl(iM408constructorimpl + UInt.m408constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
    ...
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM408constructorimpl = 0;
        while (it.hasNext()) {
            iM408constructorimpl = UInt.m408constructorimpl(iM408constructorimpl + it.next().getData());
        }
        return iM408constructorimpl;
    }
    ...
    public static final long sumOfULong(Sequence<ULong> sequence) {
        ...
        long jM487constructorimpl = 0;
        while (it.hasNext()) {
            jM487constructorimpl = ULong.m487constructorimpl(jM487constructorimpl + it.next().getData());
        }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM408constructorimpl = 0;
        while (it.hasNext()) {
            iM408constructorimpl = UInt.m408constructorimpl(iM408constructorimpl + UInt.m408constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM408constructorimpl;
    }
}
