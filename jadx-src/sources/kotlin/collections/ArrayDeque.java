...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final void removeRangeShiftPreceding(int fromIndex, int toIndex) {
        ...
        while (fromIndex > 0) {
            ...
            ArraysKt___ArraysJvmKt.copyInto(objArr, objArr, i3 + 1, i5 + 1, i2);
    ...
    public boolean removeAll(Collection<? extends Object> elements) {
        ...
        if (!isEmpty() && this.elementData.length != 0) {
            ...
            if (i2 < iPositiveMod2) {
                ...
                for (int i5 = 0; i5 < iPositiveMod2; i5++) {
                    Object[] objArr2 = this.elementData;
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (iPositiveMod2 < iPositiveMod) {
                ...
                if (i7 <= objArr8.length) {
                    ...
                    int length3 = iPositiveMod - (i7 - objArr8.length);
