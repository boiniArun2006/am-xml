...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == coroutineSingletons) {
            if (androidx.concurrent.futures.j.n(RESULT, this, coroutineSingletons, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(Object result) {
        while (true) {
            ...
            CoroutineSingletons coroutineSingletons = CoroutineSingletons.UNDECIDED;
            if (obj == coroutineSingletons) {
                if (androidx.concurrent.futures.j.n(RESULT, this, coroutineSingletons, result)) {
                    return;
                }
            } else {
                ...
                if (androidx.concurrent.futures.j.n(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
