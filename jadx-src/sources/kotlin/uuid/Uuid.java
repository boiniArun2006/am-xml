...
public final class Uuid implements Serializable {
    ...
    private static final Comparator<Uuid> LEXICAL_ORDER = new Comparator() { // from class: kotlin.uuid.j
    ...
    public static final class Companion {
        ...
        public final Uuid m1785fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$0(Uuid a2, Uuid b2) {
        ...
        return j2 != b2.mostSignificantBits ? Long.compare(ULong.m487constructorimpl(j2) ^ Long.MIN_VALUE, ULong.m487constructorimpl(b2.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m487constructorimpl(a2.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m487constructorimpl(b2.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m481boximpl(ULong.m487constructorimpl(getMostSignificantBits())), ULong.m481boximpl(ULong.m487constructorimpl(getLeastSignificantBits())));
    }
