...
public final class Charsets {
    ...
    static {
        Charset charsetForName = Charset.forName(com.google.android.exoplayer2.C.UTF8_NAME);
        Intrinsics.checkNotNullExpressionValue(charsetForName, "forName(...)");
        UTF_8 = charsetForName;
        Charset charsetForName2 = Charset.forName(com.google.android.exoplayer2.C.UTF16_NAME);
        ...
        Charset charsetForName4 = Charset.forName(com.google.android.exoplayer2.C.UTF16LE_NAME);
        Intrinsics.checkNotNullExpressionValue(charsetForName4, "forName(...)");
        UTF_16LE = charsetForName4;
        Charset charsetForName5 = Charset.forName(com.google.android.exoplayer2.C.ASCII_NAME);
        Intrinsics.checkNotNullExpressionValue(charsetForName5, "forName(...)");
        US_ASCII = charsetForName5;
        Charset charsetForName6 = Charset.forName(com.google.android.exoplayer2.C.ISO88591_NAME);
