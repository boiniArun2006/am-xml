...
final class LinesIterator implements Iterator<String>, KMappedMarker {
    ...
    public boolean hasNext() {
        ...
        for (int i7 = this.tokenStartIndex; i7 < length2; i7++) {
            char cCharAt = this.string.charAt(i7);
            if (cCharAt == '\n' || cCharAt == '\r') {
                i2 = (cCharAt == '\r' && (i3 = i7 + 1) < this.string.length() && this.string.charAt(i3) == '\n') ? 2 : 1;
                length = i7;
                this.state = 1;
    ...
    public String next() {
        ...
        this.state = 0;
        int i2 = this.delimiterStartIndex;
        int i3 = this.tokenStartIndex;
        this.tokenStartIndex = this.delimiterLength + i2;
        return this.string.subSequence(i3, i2).toString();
    }
}
