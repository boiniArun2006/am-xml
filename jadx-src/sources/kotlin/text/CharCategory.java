...
public final class CharCategory {
    ...
    public static final CharCategory LOWERCASE_LETTER = new CharCategory("LOWERCASE_LETTER", 2, 2, LHbnkhI.ZlxyrgftnZtNNHW);
    ...
    public static final class Companion {
        ...
        public final CharCategory valueOf(int category) {
            ...
            throw new IllegalArgumentException(YmsTEL.VwBxRNaQkySM + category + " is not defined.");
        }
    }
    ...
    public final boolean contains(char c2) {
        if (Character.getType(c2) == this.value) {
            return true;
        }
        return false;
    }
