...
public final class UHexExtensionsKt {
    ...
    private static final byte hexToUByte(String str, HexFormat format) {
        ...
        return UByte.m331constructorimpl(HexExtensionsKt.hexToByte(str, format));
    }
    ...
    private static final byte[] hexToUByteArray(String str, HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return UByteArray.m384constructorimpl(HexExtensionsKt.hexToByteArray(str, format));
    }
    ...
    private static final int hexToUInt(String str, HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return UInt.m408constructorimpl(HexExtensionsKt.hexToInt(str, format));
    }
    ...
    private static final long hexToULong(String str, HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return ULong.m487constructorimpl(HexExtensionsKt.hexToLong(str, format));
    }
    ...
    private static final short hexToUShort(String str, HexFormat format) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(format, "format");
        return UShort.m594constructorimpl(HexExtensionsKt.hexToShort(str, format));
    }
    ...
    private static final String m1626toHexString8M7LxHw(int i2, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1627toHexString8M7LxHw$default(int i2, HexFormat format, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final String m1628toHexString8UJCmI(long j2, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1629toHexString8UJCmI$default(long j2, HexFormat format, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final String m1630toHexStringZQbaR00(byte b2, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1631toHexStringZQbaR00$default(byte b2, HexFormat format, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final String m1632toHexStringlZCiFrA(byte[] toHexString, int i2, int i3, HexFormat format) {
    ...
    static /* synthetic */ String m1633toHexStringlZCiFrA$default(byte[] toHexString, int i2, int i3, HexFormat format, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i2 = 0;
        }
        if ((i5 & 2) != 0) {
            i3 = UByteArray.m390getSizeimpl(toHexString);
        }
        if ((i5 & 4) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
    ...
    private static final String m1634toHexStringr3ox_E0(short s2, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1635toHexStringr3ox_E0$default(short s2, HexFormat format, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final String m1636toHexStringzHuV2wU(byte[] toHexString, HexFormat format) {
        Intrinsics.checkNotNullParameter(toHexString, "$this$toHexString");
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1637toHexStringzHuV2wU$default(byte[] toHexString, HexFormat format, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            format = HexFormat.INSTANCE.getDefault();
        }
        Intrinsics.checkNotNullParameter(toHexString, "$this$toHexString");
