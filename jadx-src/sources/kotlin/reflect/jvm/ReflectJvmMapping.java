...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        Member memberMo1583getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1583getMember();
        if (memberMo1583getMember instanceof Constructor) {
            return (Constructor) memberMo1583getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo1583getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo1583getMember();
        if (memberMo1583getMember instanceof Method) {
            return (Method) memberMo1583getMember;
        }
        return null;
    }
