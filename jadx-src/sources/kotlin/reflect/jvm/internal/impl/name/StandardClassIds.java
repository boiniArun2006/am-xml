...
public final class StandardClassIds {
    ...
    static {
        ...
        FqName fqNameChild5 = fqNameChild4.child(Name.identifier(RedirectEvent.f62801i));
        ...
        FqName fqNameChild8 = fqName.child(Name.identifier(RedirectEvent.f62801i));
        ...
        Annotation = StandardClassIdsKt.baseId(qwlyMfUJj.QLuEJ);
        ...
        KProperty0 = StandardClassIdsKt.reflectId(SzFNXybiSxdx.cikyz);
