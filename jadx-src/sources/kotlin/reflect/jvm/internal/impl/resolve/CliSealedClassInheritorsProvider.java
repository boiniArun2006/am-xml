        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo1593getContributedClassifier = memberScope.mo1593getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    classDescriptor2 = classifierDescriptorMo1593getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1593getContributedClassifier : classifierDescriptorMo1593getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) classifierDescriptorMo1593getContributedClassifier).getClassDescriptor() : null;
                }
