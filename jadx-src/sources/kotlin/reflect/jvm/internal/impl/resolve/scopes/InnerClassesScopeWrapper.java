...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo1593getContributedClassifier(Name name, LookupLocation location) {
        ...
        if (classifierDescriptorMo1593getContributedClassifier != null) {
            ClassDescriptor classDescriptor = classifierDescriptorMo1593getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo1593getContributedClassifier : null;
            if (classDescriptor != null) {
                return classDescriptor;
            }
            if (classifierDescriptorMo1593getContributedClassifier instanceof TypeAliasDescriptor) {
                return (TypeAliasDescriptor) classifierDescriptorMo1593getContributedClassifier;
            }
        }
        return null;
    }
    ...
    public void mo1597recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo1597recordLookup(name, location);
    }
