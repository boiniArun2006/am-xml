...
public class OverridingUtil {
    ...
    */
    private static /* synthetic */ void $$$reportNull$$$0(int i2) {
        String str;
        int i3;
        if (i2 != 11 && i2 != 12 && i2 != 16 && i2 != 21 && i2 != 93 && i2 != 96 && i2 != 101 && i2 != 42 && i2 != 43) {
            switch (i2) {
                default:
                    switch (i2) {
                        default:
        ...
        switch (i2) {
            ...
            case 48:
            case 49:
                objArr[2] = SzFNXybiSxdx.NdgIRsLCHSUnxma;
                break;
            case 50:
            case 51:
            case 52:
    ...
    public static <H> Collection<H> extractMembersOverridableInBothWays(H h2, Collection<H> collection, Function1<H, CallableDescriptor> function1, Function1<H, Unit> function12) {
        ...
        arrayList.add(h2);
        CallableDescriptor callableDescriptorInvoke = function1.invoke(h2);
    ...
    */
    ...
    private TypeCheckerState createTypeCheckerState(List<TypeParameterDescriptor> list, List<TypeParameterDescriptor> list2) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            map.put(list.get(i2).getTypeConstructor(), list2.get(i2).getTypeConstructor());
        }
    ...
    public static OverrideCompatibilityInfo getBasicOverridabilityProblem(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2) {
        ...
        if (!callableDescriptor.getName().equals(callableDescriptor2.getName())) {
            return OverrideCompatibilityInfo.incompatible(wDgKoYAES.LOFpd);
        }
    ...
    public static <D extends CallableDescriptor> boolean overrides(D d2, D d4, boolean z2, boolean z3) {
        if (d2 == null) {
            $$$reportNull$$$0(13);
        }
        if (d4 == null) {
        ...
        if (!d2.equals(d4) && DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(d2.getOriginal(), d4.getOriginal(), z2, z3)) {
            return true;
        }
    ...
    public static <H> H selectMostSpecificMember(Collection<H> collection, Function1<H, CallableDescriptor> function1) {
        ...
        CallableDescriptor callableDescriptorInvoke = function1.invoke(h4);
        for (H h5 : collection) {
            CallableDescriptor callableDescriptorInvoke2 = function1.invoke(h5);
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z2) {
        ...
        if (typeParameters.size() != typeParameters2.size()) {
            while (i2 < listCompiledValueParameters.size()) {
                if (!KotlinTypeChecker.DEFAULT.equalTypes(listCompiledValueParameters.get(i2), listCompiledValueParameters2.get(i2))) {
        ...
        for (int i3 = 0; i3 < typeParameters.size(); i3++) {
            if (!areTypeParametersEquivalent(typeParameters.get(i3), typeParameters2.get(i3), typeCheckerStateCreateTypeCheckerState)) {
        ...
        while (i2 < listCompiledValueParameters.size()) {
            if (!areTypesEquivalent(listCompiledValueParameters.get(i2), listCompiledValueParameters2.get(i2), typeCheckerStateCreateTypeCheckerState)) {
