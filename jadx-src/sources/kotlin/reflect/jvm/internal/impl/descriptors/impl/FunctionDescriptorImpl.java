...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    protected FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        if (!copyConfiguration.newContextReceiverParameters.isEmpty()) {
            ...
            for (ReceiverParameterDescriptor receiverParameterDescriptor2 : copyConfiguration.newContextReceiverParameters) {
                ...
                int i3 = i2 + 1;
                arrayList2.add(DescriptorFactory.createContextReceiverParameterForCallable(functionDescriptorImplCreateSubstitutedCopy, kotlinTypeSubstitute2, ((ImplicitContextReceiver) receiverParameterDescriptor2.getValue()).getCustomLabelName(), receiverParameterDescriptor2.getAnnotations(), i2));
        ...
        if (receiverParameterDescriptor4 != null) {
            ...
            zArr[c2] = (zArr[c2] ? 1 : 0) | (receiverParameterDescriptorSubstitute != copyConfiguration.dispatchReceiverParameter ? (char) 1 : c2);
        ...
        boolean z2 = (zArr[c2] ? 1 : 0) | (kotlinTypeSubstitute != copyConfiguration.newReturnType ? (char) 1 : c2);
        zArr[c2] = z2;
        if (z2 == 0 && copyConfiguration.justForTypeSubstitution) {
            return this;
        }
    ...
    public FunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List<ReceiverParameterDescriptor> list, List<? extends TypeParameterDescriptor> list2, List<ValueParameterDescriptor> list3, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility) {
        ...
        for (int i2 = 0; i2 < list2.size(); i2++) {
            TypeParameterDescriptor typeParameterDescriptor = list2.get(i2);
        ...
        for (int i3 = 0; i3 < list3.size(); i3++) {
            ValueParameterDescriptor valueParameterDescriptor = list3.get(i3);
