...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo1594reportSupertypeLoopError(kotlinType);
        }
    ...
    protected abstract void mo1594reportSupertypeLoopError(KotlinType kotlinType);

    protected abstract List<KotlinType> resolveUpperBounds();

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    protected AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z2, int i2, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo1592getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo1592getSupertypes();
        if (listMo1592getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo1592getSupertypes;
    }
