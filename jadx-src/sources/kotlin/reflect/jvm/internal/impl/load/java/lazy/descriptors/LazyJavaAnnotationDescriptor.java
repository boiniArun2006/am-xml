...
public final class LazyJavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    private final LazyJavaResolverContext f70202c;
    ...
    public LazyJavaAnnotationDescriptor(LazyJavaResolverContext c2, JavaAnnotation javaAnnotation, boolean z2) {
        ...
        this.fqName$delegate = c2.getStorageManager().createNullableLazyValue(new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$$Lambda$0
        ...
        this.type$delegate = c2.getStorageManager().createLazyValue(new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$$Lambda$1
            private final LazyJavaAnnotationDescriptor arg$0;
        ...
        this.allValueArguments$delegate = c2.getStorageManager().createLazyValue(new Function0(this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$$Lambda$2
            private final LazyJavaAnnotationDescriptor arg$0;
    ...
    private final ClassDescriptor createTypeForMissingDependencies(FqName fqName) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f70202c.getModule(), ClassId.Companion.topLevel(fqName), this.f70202c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses());
    }
    ...
    private final ConstantValue<?> resolveFromAnnotation(JavaAnnotation javaAnnotation) {
        return new AnnotationValue(new LazyJavaAnnotationDescriptor(this.f70202c, javaAnnotation, false, 4, null));
    }
    ...
    private final ConstantValue<?> resolveFromJavaClassObjectType(JavaType javaType) {
        return KClassValue.Companion.create(this.f70202c.getTypeResolver().transformJavaType(javaType, JavaTypeAttributesKt.toAttributes$default(TypeUsage.COMMON, false, false, null, 7, null)));
    }
    ...
    private final ConstantValue<?> resolveFromArray(Name name, List<? extends JavaAnnotationArgument> list) {
        ...
        if (annotationParameterByName == null || (arrayType = annotationParameterByName.getType()) == null) {
            arrayType = this.f70202c.getComponents().getModule().getBuiltIns().getArrayType(Variance.INVARIANT, ErrorUtils.createErrorType(ErrorTypeKind.UNKNOWN_ARRAY_ELEMENT_TYPE_OF_ANNOTATION_ARGUMENT, new String[0]));
    ...
    public static final SimpleType type_delegate$lambda$2(LazyJavaAnnotationDescriptor lazyJavaAnnotationDescriptor) {
        ...
        ClassDescriptor classDescriptorMapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(JavaToKotlinClassMapper.INSTANCE, fqName, lazyJavaAnnotationDescriptor.f70202c.getModule().getBuiltIns(), null, 4, null);
        if (classDescriptorMapJavaToKotlin$default == null) {
            ...
            if (javaClassResolve != null) {
                classDescriptorMapJavaToKotlin$default = lazyJavaAnnotationDescriptor.f70202c.getComponents().getModuleClassResolver().resolveClass(javaClassResolve);
            } else {
                classDescriptorMapJavaToKotlin$default = null;
            }
            if (classDescriptorMapJavaToKotlin$default == null) {
