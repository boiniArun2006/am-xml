...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    public JavaAnnotationDescriptor(final LazyJavaResolverContext c2, JavaAnnotation javaAnnotation, FqName fqName) {
        ...
        this.type$delegate = c2.getStorageManager().createLazyValue(new Function0(c2, this) { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaAnnotationDescriptor$$Lambda$0
