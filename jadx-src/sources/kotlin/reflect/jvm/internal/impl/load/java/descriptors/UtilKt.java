...
public final class UtilKt {
    public static final List<ValueParameterDescriptor> copyValueParameters(Collection<? extends KotlinType> newValueParameterTypes, Collection<? extends ValueParameterDescriptor> oldValueParameters, CallableDescriptor callableDescriptor) {
        ...
        Intrinsics.checkNotNullParameter(callableDescriptor2, gUxOLwRQBPPLC.ncrxSXOZ);
        ...
        for (Pair pair : listZip) {
            ...
            arrayList.add(new ValueParameterDescriptorImpl(callableDescriptor2, null, index, annotations, name, kotlinType, zDeclaresDefaultValue, zIsCrossinline, zIsNoinline, arrayElementType, source));
