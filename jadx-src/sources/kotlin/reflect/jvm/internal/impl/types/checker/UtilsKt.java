...
public final class UtilsKt {
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (DeclarationDescriptor declarationDescriptorMo1591getDeclarationDescriptor = typeConstructor.mo1591getDeclarationDescriptor(); declarationDescriptorMo1591getDeclarationDescriptor != null; declarationDescriptorMo1591getDeclarationDescriptor = declarationDescriptorMo1591getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo1591getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + declarationDescriptorMo1591getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType kotlinType : constructor2.mo1592getSupertypes()) {
