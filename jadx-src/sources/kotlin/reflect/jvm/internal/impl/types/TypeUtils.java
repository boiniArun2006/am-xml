...
public class TypeUtils {
    ...
    */
    private static /* synthetic */ void $$$reportNull$$$0(int i2) {
        String str;
        int i3;
        if (i2 != 4 && i2 != 9 && i2 != 11 && i2 != 15 && i2 != 17 && i2 != 19 && i2 != 26 && i2 != 35 && i2 != 48 && i2 != 53 && i2 != 6 && i2 != 7) {
            switch (i2) {
                case 56:
                case 57:
                case 58:
    ...
    private static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo1592getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> collectionMo1592getSupertypes = kotlinType.getConstructor().mo1592getSupertypes();
        ArrayList arrayList = new ArrayList(collectionMo1592getSupertypes.size());
        Iterator<KotlinType> it = collectionMo1592getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1591getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo1591getDeclarationDescriptor();
        }
        return null;
    }
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1591getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo1592getSupertypes().iterator();
            while (it.hasNext()) {
                if (isNullableType(it.next())) {
                    return true;
                }
