...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    private static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i2, Object obj) throws IOException {
    ...
    private static int computeElementSize(WireFormat.FieldType fieldType, int i2, Object obj) {
        ...
        if (key.getLiteJavaType() == WireFormat.JavaType.MESSAGE) {
            if (key.isRepeated()) {
                ...
                if (value instanceof MessageLite) {
                    ...
                    throw new IllegalArgumentException(HrvQKfmFZJudBc.qaATXMiFaV);
                }
            }
        }
        return true;
