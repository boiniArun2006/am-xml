...
class LiteralByteString extends ByteString {
    ...
    protected int partialHash(int i2, int i3, int i5) {
        return hashCode(i2, this.bytes, getOffsetIntoBytes() + i3, i5);
    }
    ...
    boolean equalsRange(LiteralByteString literalByteString, int i2, int i3) {
    ...
    static int hashCode(int i2, byte[] bArr, int i3, int i5) {
