...
final class OpenEndDoubleRange implements OpenEndRange<Double> {
    ...
    public OpenEndDoubleRange(double d2, double d4) {
        this._start = d2;
        this._endExclusive = d4;
    }
