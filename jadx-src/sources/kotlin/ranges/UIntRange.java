...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt>, OpenEndRange<UInt> {
    ...
    public static /* synthetic */ void m1539getEndExclusivepVg5ArA$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1540containsWZ4Q5Ns(((UInt) comparable).getData());
    }
    ...
    public String toString() {
        return ((Object) UInt.m454toStringimpl(getFirst())) + ".." + ((Object) UInt.m454toStringimpl(getLast()));
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m1540containsWZ4Q5Ns(int value) {
    ...
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return UInt.m402boximpl(m1541getEndExclusivepVg5ArA());
    }

    /* JADX INFO: renamed from: getEndExclusive-pVg5ArA, reason: not valid java name */
    public int m1541getEndExclusivepVg5ArA() {
        if (getLast() != -1) {
            return UInt.m408constructorimpl(getLast() + 1);
        }
    ...
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m402boximpl(m1542getEndInclusivepVg5ArA());
    }

    /* JADX INFO: renamed from: getEndInclusive-pVg5ArA, reason: not valid java name */
    public int m1542getEndInclusivepVg5ArA() {
        return getLast();
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m402boximpl(m1543getStartpVg5ArA());
    }

    /* JADX INFO: renamed from: getStart-pVg5ArA, reason: not valid java name */
    public int m1543getStartpVg5ArA() {
        return getFirst();
    }
