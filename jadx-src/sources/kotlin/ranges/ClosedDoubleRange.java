...
final class ClosedDoubleRange implements ClosedFloatingPointRange<Double> {
    ...
    public ClosedDoubleRange(double d2, double d4) {
        this._start = d2;
