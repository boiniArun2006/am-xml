...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m1548getEndExclusivesVKNKU$annotations() {
    }
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1549containsVKZWuLQ(((ULong) comparable).getData());
    }
    ...
    public String toString() {
        return ((Object) ULong.m533toStringimpl(getFirst())) + ".." + ((Object) ULong.m533toStringimpl(getLast()));
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1549containsVKZWuLQ(long value) {
    ...
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m481boximpl(m1550getEndExclusivesVKNKU());
    }

    /* JADX INFO: renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m1550getEndExclusivesVKNKU() {
        if (getLast() != -1) {
            return ULong.m487constructorimpl(getLast() + ULong.m487constructorimpl(((long) 1) & 4294967295L));
        }
    ...
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m481boximpl(m1551getEndInclusivesVKNKU());
    }

    /* JADX INFO: renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m1551getEndInclusivesVKNKU() {
        return getLast();
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m481boximpl(m1552getStartsVKNKU());
    }

    /* JADX INFO: renamed from: getStart-s-VKNKU, reason: not valid java name */
    public long m1552getStartsVKNKU() {
        return getFirst();
    }
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m487constructorimpl(getFirst() ^ ULong.m487constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m487constructorimpl(getLast() ^ ULong.m487constructorimpl(getLast() >>> 32)));
    }
