...
public class RangesKt__RangesKt {
    ...
    public static final ClosedFloatingPointRange<Double> rangeTo(double d2, double d4) {
        return new ClosedDoubleRange(d2, d4);
    }

    @SinceKotlin(version = "1.9")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final OpenEndRange<Double> rangeUntil(double d2, double d4) {
        return new OpenEndDoubleRange(d2, d4);
    }

    @SinceKotlin(version = "1.1")
    public static ClosedFloatingPointRange<Float> rangeTo(float f3, float f4) {
        return new ClosedFloatRange(f3, f4);
    }

    @SinceKotlin(version = "1.9")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final OpenEndRange<Float> rangeUntil(float f3, float f4) {
