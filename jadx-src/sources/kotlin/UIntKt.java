...
public final class UIntKt {
    ...
    private static final int toUInt(byte b2) {
        return UInt.m408constructorimpl(b2);
    }
    ...
    private static final int toUInt(short s2) {
        return UInt.m408constructorimpl(s2);
    }
    ...
    private static final int toUInt(int i2) {
        return UInt.m408constructorimpl(i2);
    }
    ...
    @WasExperimental(markerClass = {ExperimentalUnsignedTypes.class})
    @InlineOnly
    private static final int toUInt(float f3) {
        return UnsignedKt.doubleToUInt(f3);
    }
