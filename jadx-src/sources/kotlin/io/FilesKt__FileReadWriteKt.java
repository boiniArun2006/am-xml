...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final void appendText(File file, String text, Charset charset) {
        Intrinsics.checkNotNullParameter(file, QiDPjiOCZHDS.OSXcISZW);
    ...
    public static final void forEachBlock(File file, int i2, Function2<? super byte[], ? super Integer, Unit> action) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
    ...
    public static byte[] readBytes(File file) {
        ...
        try {
            ...
            int i5 = 0;
            while (i3 > 0) {
                int i7 = fileInputStream.read(bArrCopyInto, i5, i3);
                if (i7 < 0) {
                    break;
                }
                i3 -= i7;
            ...
            if (i3 > 0) {
                bArrCopyInto = Arrays.copyOf(bArrCopyInto, i5);
    ...
    public static final List<String> readLines(File file, Charset charset) {
        ...
        forEachLine(file, charset, new Function1() { // from class: kotlin.io.j
    ...
    public static void writeTextImpl(OutputStream outputStream, String text, Charset charset) throws IOException {
        ...
        while (i2 < text.length()) {
            ...
            text.getChars(i2, i5, cArrArray, i3);
            charBufferAllocate.limit(iMin + i3);
            i3 = 1;
            if (!charsetEncoderNewReplaceEncoder.encode(charBufferAllocate, byteBufferByteBufferForEncoding, i5 == text.length()).isUnderflow()) {
