...
public final class ByteStreamsKt {
    ...
    private static final ByteArrayInputStream byteInputStream(String str, Charset charset) {
        ...
        Intrinsics.checkNotNullExpressionValue(bytes, YjqZUJsVmhcjko.USlIjcA);
