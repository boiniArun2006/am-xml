...
public final class TextStreamsKt {
    ...
    public static final List<String> readLines(Reader reader) {
        ...
        forEachLine(reader, new Function1() { // from class: kotlin.io.w6
