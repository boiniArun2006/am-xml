...
public final class RandomKt {
    ...
    public static final void checkRangeBounds(double d2, double d4) {
        if (d4 <= d2) {
            throw new IllegalArgumentException(boundsErrorMessage(Double.valueOf(d2), Double.valueOf(d4)).toString());
        }
    }
