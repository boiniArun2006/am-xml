...
public final class n implements InterfaceC2201j {
    ...
    public static final n f69439n = new n();
    ...
    public Tracker n(Context context) {
        ...
        return new Tracker.GoogleMobileAds(context, null, MobileAds.getRequestConfiguration().getTagForChildDirectedTreatment() == 1, new Function1() { // from class: jQ.j
