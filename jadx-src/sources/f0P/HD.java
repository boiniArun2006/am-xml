...
public abstract class HD extends Fragment implements j9J.w6 {

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    private volatile BGJ.Wre f64252O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private ContextWrapper f64253n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private boolean f64255t;
    private final Object J2 = new Object();

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private boolean f64254r = false;
    ...
    private void ViF() {
        if (this.f64253n == null) {
            this.f64253n = BGJ.Wre.rl(super.getContext(), this);
            this.f64255t = Z7.j.n(super.getContext());
        }
    }

    public final BGJ.Wre WPU() {
        if (this.f64252O == null) {
    ...
    public Context getContext() {
        if (super.getContext() == null && !this.f64255t) {
            return null;
        }
        ViF();
        return this.f64253n;
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f64253n;
