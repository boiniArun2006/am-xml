...
public final class n implements InterfaceC2201j {
    ...
    public static final n f67193n = new n();

    @Override // k.InterfaceC2201j
    public Tracker n(final Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        return new Tracker.AppLovin(context, null, !AppLovinPrivacySettings.isUserConsentSet(context) || AppLovinPrivacySettings.hasUserConsent(context), new Function1() { // from class: gBz.j
