...
public abstract class aC {
    public static final void rl(Function0 function0, final Function0 onTermsOfServiceLinkClick, final Function0 onPrivacyPolicyLinkClick, Composer composer, final int i2) {
        ...
        Composer composerKN = composer.KN(-658611620);
        if ((i2 & 6) == 0) {
        ...
        if ((i3 & 147) == 146 && composerKN.xMQ()) {
            ...
            if (ComposerKt.v()) {
                ComposerKt.p5(-658611620, i3, -1, "com.alightcreative.app.motion.activities.creatorprogram.optin.CreatorOptInBottomSheetContent (CreatorOptInBottomSheet.kt:28)");
            }
            Modifier.Companion companion = Modifier.INSTANCE;
            Modifier modifierMUb = PaddingKt.mUb(SizeKt.KN(companion, 0.0f, 1, null), Dp.KN(16), Dp.KN(44));
            ...
            String strT = StringResources_androidKt.t(2132017601, composerKN, 6);
            ...
            TextKt.t(strT, modifierKN, aD.w6.s(), 0L, null, null, null, 0L, null, TextAlign.KN(companion3.n()), 0L, 0, false, 0, 0, null, textStyleIF, composerKN, 432, 0, 65016);
            SpacerKt.n(SizeKt.Z(companion, Dp.KN(24)), composerKN, 6);
            CM.xMQ(StringResources_androidKt.t(2132017600, composerKN, 6), SizeKt.KN(companion, 0.0f, 1, null), aD.w6.s(), TextAlign.KN(companion3.n()), jVar.rl(composerKN, 6).wTp(), CollectionsKt.listOf((Object[]) new QaP[]{new QaP("tos", new P0j.Dsr(true, false, false, true, false, null, 0L, onTermsOfServiceLinkClick, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE, null)), new QaP("pp", new P0j.Dsr(true, false, false, true, false, null, 0L, onPrivacyPolicyLinkClick, Sdk.SDKError.Reason.PROTOBUF_SERIALIZATION_ERROR_VALUE, null))}), composerKN, 432, 0);
            composer2 = composerKN;
            SpacerKt.n(SizeKt.Z(companion, Dp.KN(32)), composer2, 6);
            onAcceptButtonClick = function0;
            Dj7.eO.J2(onAcceptButtonClick, StringResources_androidKt.t(2132017193, composer2, 6), SizeKt.KN(companion, 0.0f, 1, null), null, null, null, 0, 0, 0.0f, null, null, null, false, composer2, (i3 & 14) | RendererCapabilities.DECODER_SUPPORT_MASK, 0, 8184);
            composer2.XQ();
            if (ComposerKt.v()) {
                ComposerKt.M7();
            }
        ...
        if (scopeUpdateScopeGh != null) {
            scopeUpdateScopeGh.n(new Function2() { // from class: nN.Dsr
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return aC.t(onAcceptButtonClick, onTermsOfServiceLinkClick, onPrivacyPolicyLinkClick, i2, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
