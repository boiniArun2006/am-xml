...
@Metadata(d1 = {"\u0000\u0012\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u00012\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0002H\u000b¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"P1", "P2", "Lkotlin/Pair;", "it", "", c.f62177j, "(Lkotlin/Pair;Landroidx/compose/runtime/Composer;I)V"}, k = 3, mv = {1, 9, 0})
final class MovableContentKt$movableContentOf$movableContent$2 extends Lambda implements Function3<Pair<Object, Object>, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function4 f30214n;
    ...
    public final void n(Pair pair, Composer composer, int i2) {
        ...
        if (ComposerKt.v()) {
            ComposerKt.p5(1849814513, i2, -1, "androidx.compose.runtime.movableContentOf.<anonymous> (MovableContent.kt:80)");
        }
        this.f30214n.invoke(pair.getFirst(), pair.getSecond(), composer, 0);
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
