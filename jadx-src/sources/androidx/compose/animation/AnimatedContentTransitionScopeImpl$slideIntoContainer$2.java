...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$2 extends Lambda implements Function1<Integer, Integer> {
    ...
    final /* synthetic */ Function1 f15007n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ AnimatedContentTransitionScopeImpl f15008t;
    ...
    public final Integer n(int i2) {
        long j2 = i2;
        return (Integer) this.f15007n.invoke(Integer.valueOf((-IntOffset.gh(this.f15008t.Uo(IntSize.t((j2 & 4294967295L) | (j2 << 32)), this.f15008t.qie()))) - i2));
    }
}
