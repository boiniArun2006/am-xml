...
public final class TransitionKt$animateInt$1 extends Lambda implements Function3<Transition.Segment<Object>, Composer, Integer, SpringSpec<Integer>> {
    ...
    public static final TransitionKt$animateInt$1 f15700n = new TransitionKt$animateInt$1();
    ...
    public final SpringSpec n(Transition.Segment segment, Composer composer, int i2) {
        composer.eF(-785273069);
        if (ComposerKt.v()) {
            ComposerKt.p5(-785273069, i2, -1, "androidx.compose.animation.core.animateInt.<anonymous> (Transition.kt:2074)");
        }
        SpringSpec springSpecQie = AnimationSpecKt.qie(0.0f, 0.0f, 1, 3, null);
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
        composer.Xw();
