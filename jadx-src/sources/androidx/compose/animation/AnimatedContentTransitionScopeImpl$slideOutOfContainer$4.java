...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    final /* synthetic */ AnimatedContentTransitionScopeImpl f15019n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Function1 f15020t;
    ...
    public final Integer n(int i2) {
        State state = (State) this.f15019n.getTargetSizeMap().O(this.f15019n.getTransition().Ik());
        long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.n();
        long j2 = i2;
        return (Integer) this.f15020t.invoke(Integer.valueOf((-IntOffset.qie(this.f15019n.Uo(IntSize.t((j2 & 4294967295L) | (j2 << 32)), packedValue))) + ((int) (packedValue & 4294967295L))));
    }
}
