...
public final class CommitTextCommand implements EditCommand {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(t(), commitTextCommand.t()) && this.newCursorPosition == commitTextCommand.newCursorPosition;
    }
    ...
    public String toString() {
        return "CommitTextCommand(text='" + t() + "', newCursorPosition=" + this.newCursorPosition + ')';
    }
