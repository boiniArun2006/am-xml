...
final class RtlBoundsComparator implements Comparator<SemanticsNode> {
    ...
    public int compare(SemanticsNode a2, SemanticsNode b2) {
        ...
        int iCompare = Float.compare(rectMUb2.getAndroidx.media3.extractor.text.ttml.TtmlNode.RIGHT java.lang.String(), rectMUb.getAndroidx.media3.extractor.text.ttml.TtmlNode.RIGHT java.lang.String());
        if (iCompare != 0) {
            return iCompare;
        }
        ...
        return Float.compare(rectMUb2.getLeft(), rectMUb.getLeft());
    }
}
