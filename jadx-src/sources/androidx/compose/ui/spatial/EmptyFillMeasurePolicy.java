...
final class EmptyFillMeasurePolicy implements MeasurePolicy {
    ...
    public static final EmptyFillMeasurePolicy f33304n = new EmptyFillMeasurePolicy();
    ...
    public MeasureResult rl(MeasureScope measureScope, List list, long j2) {
        return MeasureScope.ER(measureScope, Constraints.qie(j2), Constraints.gh(j2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.spatial.EmptyFillMeasurePolicy$measure$1
