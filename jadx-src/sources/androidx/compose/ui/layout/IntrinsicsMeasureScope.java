...
public final class IntrinsicsMeasureScope implements MeasureScope, IntrinsicMeasureScope {
    ...
    private final /* synthetic */ IntrinsicMeasureScope f32233t;

    @Override // androidx.compose.ui.unit.Density
    public int How(float f3) {
        return this.f32233t.How(f3);
    }

    @Override // androidx.compose.ui.unit.Density
    public int I4p(long j2) {
        return this.f32233t.I4p(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    public long Ik(long j2) {
        return this.f32233t.Ik(j2);
    }

    @Override // androidx.compose.ui.unit.Density
    public long M(long j2) {
        return this.f32233t.M(j2);
    }

    @Override // androidx.compose.ui.layout.IntrinsicMeasureScope
    public boolean Org() {
        return this.f32233t.Org();
    }

    @Override // androidx.compose.ui.unit.Density
    public long ViF(float f3) {
        return this.f32233t.ViF(f3);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    public float Z(long j2) {
        return this.f32233t.Z(j2);
    }
    ...
    public float bzg(float f3) {
        return this.f32233t.bzg(f3);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    public long ck(float f3) {
        return this.f32233t.ck(f3);
    }

    @Override // androidx.compose.ui.unit.Density
    public float getDensity() {
        return this.f32233t.getDensity();
    }

    @Override // androidx.compose.ui.unit.Density
    public float l(float f3) {
        return this.f32233t.l(f3);
    }

    @Override // androidx.compose.ui.unit.Density
    public float rV9(int i2) {
        return this.f32233t.rV9(i2);
    }

    @Override // androidx.compose.ui.unit.Density
    public float tFV(long j2) {
        return this.f32233t.tFV(j2);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* JADX INFO: renamed from: yAc */
    public float getFontScale() {
        return this.f32233t.getFontScale();
    }
    ...
    public IntrinsicsMeasureScope(IntrinsicMeasureScope intrinsicMeasureScope, LayoutDirection layoutDirection) {
        ...
        this.f32233t = intrinsicMeasureScope;
    }
}
