...
final class LayoutKt$materializerOfWithCompositionLocalInjection$1 extends Lambda implements Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Modifier f32246n;
    ...
    public final void n(Composer composer, Composer composer2, int i2) {
        if (ComposerKt.v()) {
            ComposerKt.p5(-55743822, i2, -1, "androidx.compose.ui.layout.materializerOfWithCompositionLocalInjection.<anonymous> (Layout.kt:218)");
        }
        int iN = ComposablesKt.n(composer2, 0);
        Modifier modifierJ2 = ComposedModifierKt.J2(composer2, this.f32246n);
        composer.te(509942095);
        Composer composerN = Updater.n(composer);
        ComposeUiNode.Companion companion = ComposeUiNode.INSTANCE;
        Updater.O(composerN, modifierJ2, companion.nr());
