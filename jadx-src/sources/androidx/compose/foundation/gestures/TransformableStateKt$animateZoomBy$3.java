...
final class TransformableStateKt$animateZoomBy$3 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ Ref.FloatRef f17256O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f17257n;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ AnimationSpec f17258r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f17259t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TransformableStateKt$animateZoomBy$3(Ref.FloatRef floatRef, float f3, AnimationSpec animationSpec, Continuation continuation) {
        super(2, continuation);
        this.f17256O = floatRef;
        this.J2 = f3;
        this.f17258r = animationSpec;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        TransformableStateKt$animateZoomBy$3 transformableStateKt$animateZoomBy$3 = new TransformableStateKt$animateZoomBy$3(this.f17256O, this.J2, this.f17258r, continuation);
        transformableStateKt$animateZoomBy$3.f17259t = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            final TransformScope transformScope = (TransformScope) this.f17259t;
            AnimationState animationStateT = AnimationStateKt.t(this.f17256O.element, 0.0f, 0L, 0L, false, 30, null);
            Float fBoxFloat = Boxing.boxFloat(this.J2);
            AnimationSpec animationSpec = this.f17258r;
            final Ref.FloatRef floatRef = this.f17256O;
            Function1<AnimationScope<Float, AnimationVector1D>, Unit> function1 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animateZoomBy$3.1
                ...
                public final void n(AnimationScope animationScope) {
                    TransformScope.rl(transformScope, floatRef.element == 0.0f ? 1.0f : ((Number) animationScope.O()).floatValue() / floatRef.element, 0L, 0.0f, 6, null);
