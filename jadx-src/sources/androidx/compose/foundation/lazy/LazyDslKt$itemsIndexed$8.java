...
public final class LazyDslKt$itemsIndexed$8 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function5 f18026n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Object[] f18027t;
    ...
    public final void n(LazyItemScope lazyItemScope, int i2, Composer composer, int i3) {
        ...
        if (ComposerKt.v()) {
            ComposerKt.p5(1600639390, i5, -1, "androidx.compose.foundation.lazy.itemsIndexed.<anonymous> (LazyDsl.kt:286)");
        }
        this.f18026n.invoke(lazyItemScope, Integer.valueOf(i2), this.f18027t[i2], composer, Integer.valueOf(i5 & 126));
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
