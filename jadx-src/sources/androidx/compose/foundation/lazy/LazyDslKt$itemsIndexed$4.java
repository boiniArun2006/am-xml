...
public final class LazyDslKt$itemsIndexed$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function5 f18019n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ List f18020t;
    ...
    public final void n(LazyItemScope lazyItemScope, int i2, Composer composer, int i3) {
        ...
        this.f18019n.invoke(lazyItemScope, Integer.valueOf(i2), this.f18020t.get(i2), composer, Integer.valueOf(i5 & 126));
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
