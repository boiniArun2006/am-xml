...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function5 f18674n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ List f18675t;
    ...
    public final void n(LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i2, Composer composer, int i3) {
        ...
        this.f18674n.invoke(lazyStaggeredGridItemScope, Integer.valueOf(i2), this.f18675t.get(i2), composer, Integer.valueOf(i5 & 126));
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
