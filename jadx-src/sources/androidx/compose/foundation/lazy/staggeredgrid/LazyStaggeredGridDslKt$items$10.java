...
public final class LazyStaggeredGridDslKt$items$10 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function4 f18648n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Object[] f18649t;
    ...
    public final void n(LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i2, Composer composer, int i3) {
        ...
        if (ComposerKt.v()) {
            ComposerKt.p5(2101296000, i5, -1, "androidx.compose.foundation.lazy.staggeredgrid.items.<anonymous> (LazyStaggeredGridDsl.kt:480)");
        }
        this.f18648n.invoke(lazyStaggeredGridItemScope, this.f18649t[i2], composer, Integer.valueOf(i5 & 14));
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
