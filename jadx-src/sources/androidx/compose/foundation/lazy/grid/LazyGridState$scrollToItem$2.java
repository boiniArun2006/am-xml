...
final class LazyGridState$scrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ int f18360O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f18361n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ LazyGridState f18362t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    LazyGridState$scrollToItem$2(LazyGridState lazyGridState, int i2, int i3, Continuation continuation) {
        super(2, continuation);
        this.f18362t = lazyGridState;
        this.f18360O = i2;
        this.J2 = i3;
    }
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new LazyGridState$scrollToItem$2(this.f18362t, this.f18360O, this.J2, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.f18361n == 0) {
            ...
            this.f18362t.rV9(this.f18360O, this.J2, true);
