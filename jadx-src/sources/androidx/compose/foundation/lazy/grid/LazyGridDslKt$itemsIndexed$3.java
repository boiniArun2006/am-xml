...
public final class LazyGridDslKt$itemsIndexed$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    final /* synthetic */ Function3 f18224n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ List f18225t;
    ...
    public final long n(LazyGridItemSpanScope lazyGridItemSpanScope, int i2) {
        return ((GridItemSpan) this.f18224n.invoke(lazyGridItemSpanScope, Integer.valueOf(i2), this.f18225t.get(i2))).getPackedValue();
    }
}
