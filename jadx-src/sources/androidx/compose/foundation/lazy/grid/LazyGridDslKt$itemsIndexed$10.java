...
public final class LazyGridDslKt$itemsIndexed$10 extends Lambda implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function5 f18220n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Object[] f18221t;
    ...
    public final void n(LazyGridItemScope lazyGridItemScope, int i2, Composer composer, int i3) {
        ...
        if (ComposerKt.v()) {
            ComposerKt.p5(-911455938, i5, -1, "androidx.compose.foundation.lazy.grid.itemsIndexed.<anonymous> (LazyGridDsl.kt:653)");
        }
        this.f18220n.invoke(lazyGridItemScope, Integer.valueOf(i2), this.f18221t[i2], composer, Integer.valueOf(i5 & 126));
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
    }
