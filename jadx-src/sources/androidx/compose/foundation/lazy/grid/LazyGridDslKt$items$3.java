...
public final class LazyGridDslKt$items$3 extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    ...
    final /* synthetic */ Function2 f18206n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ List f18207t;
    ...
    public final long n(LazyGridItemSpanScope lazyGridItemSpanScope, int i2) {
        return ((GridItemSpan) this.f18206n.invoke(lazyGridItemSpanScope, this.f18207t.get(i2))).getPackedValue();
    }
}
