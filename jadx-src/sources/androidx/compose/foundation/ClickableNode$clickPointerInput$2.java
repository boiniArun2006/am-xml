...
final class ClickableNode$clickPointerInput$2 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
    final /* synthetic */ ClickableNode J2;

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    /* synthetic */ long f16062O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f16063n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f16064t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ClickableNode$clickPointerInput$2(ClickableNode clickableNode, Continuation continuation) {
        super(3, continuation);
        this.J2 = clickableNode;
    }
    ...
    public final Object n(PressGestureScope pressGestureScope, long j2, Continuation continuation) {
        ClickableNode$clickPointerInput$2 clickableNode$clickPointerInput$2 = new ClickableNode$clickPointerInput$2(this.J2, continuation);
        clickableNode$clickPointerInput$2.f16064t = pressGestureScope;
        clickableNode$clickPointerInput$2.f16062O = j2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            PressGestureScope pressGestureScope = (PressGestureScope) this.f16064t;
            long j2 = this.f16062O;
            if (this.J2.getEnabled()) {
                ClickableNode clickableNode = this.J2;
                this.f16063n = 1;
                if (clickableNode.f11(pressGestureScope, j2, this) == coroutine_suspended) {
