...
final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    final /* synthetic */ TextFieldSelectionManager f21004n;
    ...
    TextFieldSelectionManager_androidKt$textFieldMagnifier$1(TextFieldSelectionManager textFieldSelectionManager) {
        super(3);
        this.f21004n = textFieldSelectionManager;
    }
    ...
    public final Modifier t(Modifier modifier, Composer composer, int i2) {
        composer.eF(1980580247);
        if (ComposerKt.v()) {
            ComposerKt.p5(1980580247, i2, -1, "androidx.compose.foundation.text.selection.textFieldMagnifier.<anonymous> (TextFieldSelectionManager.android.kt:50)");
        }
        ...
        boolean zE2 = composer.E2(this.f21004n);
        final TextFieldSelectionManager textFieldSelectionManager = this.f21004n;
        Object objIF2 = composer.iF();
        if (zE2 || objIF2 == companion.n()) {
            objIF2 = new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$1$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public final long n() {
                    return TextFieldSelectionManagerKt.rl(textFieldSelectionManager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.nr(mutableState));
                }
        ...
        if (zP5 || objIF3 == companion.n()) {
            objIF3 = new Function1<Function0<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final Modifier invoke(final Function0 function02) {
                    ...
                    return Magnifier_androidKt.J2(companion2, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void n(long j2) {
                            ...
                            TextFieldSelectionManager_androidKt$textFieldMagnifier$1.O(mutableState3, IntSize.t((((long) density3.How(DpSize.xMQ(j2))) & 4294967295L) | (((long) iHow) << 32)));
                        }
