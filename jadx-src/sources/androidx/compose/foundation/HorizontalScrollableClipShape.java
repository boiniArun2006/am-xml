...
final class HorizontalScrollableClipShape implements Shape {
    ...
    public static final HorizontalScrollableClipShape f16133n = new HorizontalScrollableClipShape();
    ...
    public Outline n(long size, LayoutDirection layoutDirection, Density density) {
        ...
        return new Outline.Rectangle(new Rect(0.0f, -fHow, Float.intBitsToFloat((int) (size >> 32)), Float.intBitsToFloat((int) (size & 4294967295L)) + fHow));
    }
}
