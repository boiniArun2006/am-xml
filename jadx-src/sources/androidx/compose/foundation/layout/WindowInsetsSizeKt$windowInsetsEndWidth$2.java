...
final class WindowInsetsSizeKt$windowInsetsEndWidth$2 extends Lambda implements Function3<WindowInsets, LayoutDirection, Density, Integer> {
    ...
    public static final WindowInsetsSizeKt$windowInsetsEndWidth$2 f17922n = new WindowInsetsSizeKt$windowInsetsEndWidth$2();
    ...
    public final Integer invoke(WindowInsets windowInsets, LayoutDirection layoutDirection, Density density) {
        return Integer.valueOf(layoutDirection == LayoutDirection.f34161t ? windowInsets.nr(density, layoutDirection) : windowInsets.rl(density, layoutDirection));
    }
}
