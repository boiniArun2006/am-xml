...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult nr(MeasureScope measureScope, Measurable measurable, long j2) {
        int iIntValue = ((Number) this.heightCalc.invoke(t(), measureScope)).intValue();
        if (iIntValue == 0) {
            return MeasureScope.ER(measureScope, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$1
        ...
        final Placeable placeableDR0 = measurable.dR0(Constraints.nr(j2, 0, 0, iIntValue, iIntValue, 3, null));
        return MeasureScope.ER(measureScope, placeableDR0.getWidth(), iIntValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
            {
                super(1);
            }
