...
public final class PagerBeyondBoundsModifierKt {
    public static final LazyLayoutBeyondBoundsState n(PagerState pagerState, int i2, Composer composer, int i3) {
        boolean z2;
        if (ComposerKt.v()) {
            ComposerKt.p5(373558254, i3, -1, "androidx.compose.foundation.pager.rememberPagerBeyondBoundsState (PagerBeyondBoundsModifier.kt:25)");
        }
        boolean z3 = false;
        if ((((i3 & 14) ^ 6) > 4 && composer.p5(pagerState)) || (i3 & 6) == 4) {
            z2 = true;
        } else {
            z2 = false;
        }
        ...
        if (z4 || objIF == Composer.INSTANCE.n()) {
            objIF = new PagerBeyondBoundsState(pagerState, i2);
            composer.o(objIF);
        }
        PagerBeyondBoundsState pagerBeyondBoundsState = (PagerBeyondBoundsState) objIF;
        if (ComposerKt.v()) {
            ComposerKt.M7();
        }
