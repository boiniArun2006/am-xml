...
public final class FocusInteractionKt {
    public static final State n(InteractionSource interactionSource, Composer composer, int i2) {
        boolean z2;
        if (ComposerKt.v()) {
            ComposerKt.p5(-1805515472, i2, -1, "androidx.compose.foundation.interaction.collectIsFocusedAsState (FocusInteraction.kt:63)");
        }
        ...
        if (z2 || objIF2 == companion.n()) {
            objIF2 = new FocusInteractionKt$collectIsFocusedAsState$1$1(interactionSource, mutableState, null);
            composer.o(objIF2);
        }
