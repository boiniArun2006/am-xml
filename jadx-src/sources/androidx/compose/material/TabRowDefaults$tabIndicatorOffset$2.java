...
final class TabRowDefaults$tabIndicatorOffset$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier rl(Modifier modifier, Composer composer, int i2) {
        composer.eF(-398757863);
        if (ComposerKt.v()) {
            ComposerKt.p5(-398757863, i2, -1, "androidx.compose.material.TabRowDefaults.tabIndicatorOffset.<anonymous> (TabRow.kt:393)");
        }
        State stateT = AnimateAsStateKt.t(this.f23410n.getWidth(), AnimationSpecKt.ty(250, 0, EasingKt.nr(), 2, null), null, null, composer, 0, 12);
        final State stateT2 = AnimateAsStateKt.t(this.f23410n.getLeft(), AnimationSpecKt.ty(250, 0, EasingKt.nr(), 2, null), null, null, composer, 0, 12);
        ...
        if (zP5 || objIF == Composer.INSTANCE.n()) {
            objIF = new Function1<Density, IntOffset>() { // from class: androidx.compose.material.TabRowDefaults$tabIndicatorOffset$2$1$1
                {
                    super(1);
                }
