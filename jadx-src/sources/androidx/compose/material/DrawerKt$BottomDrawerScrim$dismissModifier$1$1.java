...
final class DrawerKt$BottomDrawerScrim$dismissModifier$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ Function0 f21896O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f21897n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f21898t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DrawerKt$BottomDrawerScrim$dismissModifier$1$1(Function0 function0, Continuation continuation) {
        super(2, continuation);
        this.f21896O = function0;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        DrawerKt$BottomDrawerScrim$dismissModifier$1$1 drawerKt$BottomDrawerScrim$dismissModifier$1$1 = new DrawerKt$BottomDrawerScrim$dismissModifier$1$1(this.f21896O, continuation);
        drawerKt$BottomDrawerScrim$dismissModifier$1$1.f21898t = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            PointerInputScope pointerInputScope = (PointerInputScope) this.f21898t;
            final Function0 function0 = this.f21896O;
