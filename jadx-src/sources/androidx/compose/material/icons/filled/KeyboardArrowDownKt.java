...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00008\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0001\u0010\u0002\"\u0015\u0010\u0006\u001a\u00020\u0000*\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0001\u0010\u0005¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/graphics/vector/ImageVector;", c.f62177j, "Landroidx/compose/ui/graphics/vector/ImageVector;", "_keyboardArrowDown", "Landroidx/compose/material/icons/Icons$Filled;", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "KeyboardArrowDown", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class KeyboardArrowDownKt {
    ...
    private static ImageVector f23878n;

    public static final ImageVector n(Icons.Filled filled) {
        ImageVector imageVector = f23878n;
        if (imageVector != null) {
            Intrinsics.checkNotNull(imageVector);
            return imageVector;
        }
        ImageVector.Builder builder = new ImageVector.Builder("Filled.KeyboardArrowDown", Dp.KN(24.0f), Dp.KN(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int iN = VectorKt.n();
        ...
        pathBuilder.xMQ(7.41f, 8.59f);
        pathBuilder.Uo(12.0f, 13.17f);
        pathBuilder.KN(4.59f, -4.58f);
        pathBuilder.Uo(18.0f, 10.0f);
