...
public final class DraggableAnchorsElement$inspectableProperties$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    final /* synthetic */ DraggableAnchorsElement f21843n;
    ...
    public final void n(InspectorInfo inspectorInfo) {
        inspectorInfo.getProperties().n("state", this.f21843n.state);
        inspectorInfo.getProperties().n("anchors", this.f21843n.anchors);
        inspectorInfo.getProperties().n("orientation", this.f21843n.orientation);
    }
}
