...
public final class DragGestureDetectorCopyKt {
    ...
    private static final float f21830n;
    private static final float rl;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private static final float f21831t;
    ...
    */
    public static final Object n(AwaitPointerEventScope awaitPointerEventScope, long j2, int i2, Function2 function2, Continuation continuation) {
        ...
        if (continuation instanceof DragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1) {
            ...
            int i7 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21833S;
            if ((i7 & Integer.MIN_VALUE) != 0) {
                dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21833S = i7 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj3 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21834Z;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i8 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21833S;
        int i9 = 1;
        ...
        if (i8 == 0) {
            ...
            f3 = fT;
            fAz = 0.0f;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21835n = function22;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21838t = awaitPointerEventScope2;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21832O = longRef;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.J2 = pointerEventPass2;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21837r = f3;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21836o = fAz;
            dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$12.f21833S = i9;
        ...
        if (i8 != 1) {
            ...
            float f6 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21836o;
            float f7 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21837r;
            ...
            Ref.LongRef longRef4 = (Ref.LongRef) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21832O;
            AwaitPointerEventScope awaitPointerEventScope3 = (AwaitPointerEventScope) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21838t;
            Function2 function23 = (Function2) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21835n;
            ResultKt.throwOnFailure(obj3);
            fAz = f6;
            ...
            if (objPJg != coroutine_suspended) {
                ...
                if (PointerEventKt.nr(pointerInputChange)) {
                    ...
                    if (Math.abs(fAz) < f4) {
                        ...
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21835n = function22;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21838t = awaitPointerEventScope2;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21832O = longRef2;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.J2 = pointerInputChange;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21837r = f4;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21836o = fAz;
                        dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$13.f21833S = 2;
        ...
        float f9 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21836o;
        float f10 = dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21837r;
        Ref.LongRef longRef5 = (Ref.LongRef) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21832O;
        AwaitPointerEventScope awaitPointerEventScope4 = (AwaitPointerEventScope) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21838t;
        Function2 function24 = (Function2) dragGestureDetectorCopyKt$awaitHorizontalPointerSlopOrCancellation$1.f21835n;
        ResultKt.throwOnFailure(obj3);
    ...
    public static final float t(ViewConfiguration viewConfiguration, int i2) {
        return PointerType.KN(i2, PointerType.INSTANCE.rl()) ? viewConfiguration.Uo() * f21831t : viewConfiguration.Uo();
    }
