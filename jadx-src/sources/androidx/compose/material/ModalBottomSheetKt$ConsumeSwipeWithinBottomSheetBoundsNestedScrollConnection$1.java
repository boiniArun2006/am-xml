...
public final class ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    final /* synthetic */ AnchoredDraggableState f22222n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Orientation f22223t;
    ...
    ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1(AnchoredDraggableState anchoredDraggableState, Orientation orientation) {
        this.f22222n = anchoredDraggableState;
        this.f22223t = orientation;
    }

    private final float n(long j2) {
        return this.f22223t == Orientation.f16970t ? Offset.az(j2) : Offset.ty(j2);
    }

    private final long rl(float f3) {
        Orientation orientation = this.f22223t;
    ...
    private final float t(long j2) {
        return this.f22223t == Orientation.f16970t ? Velocity.KN(j2) : Velocity.xMQ(j2);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    public long F(long consumed, long available, int source) {
        return NestedScrollSource.O(source, NestedScrollSource.INSTANCE.rl()) ? rl(this.f22222n.ty(n(available))) : Offset.INSTANCE.t();
    }
    ...
    */
    public Object lS(long j2, Continuation continuation) {
        ...
        if (continuation instanceof ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1) {
            ...
            int i2 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J2;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J2 = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.f22229t;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J2;
        if (i3 == 0) {
            ResultKt.throwOnFailure(obj);
            float fT = t(j2);
            float fG = this.f22222n.g();
            if (fT >= 0.0f || fG <= this.f22222n.HI().O()) {
                j2 = Velocity.INSTANCE.n();
            } else {
                AnchoredDraggableState anchoredDraggableState = this.f22222n;
                modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.f22228n = j2;
                modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.J2 = 1;
                if (anchoredDraggableState.X(fT, modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1) == coroutine_suspended) {
            ...
            j2 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPreFling$1.f22228n;
            ResultKt.throwOnFailure(obj);
        }
    ...
    */
    public Object z(long j2, long j3, Continuation continuation) {
        ...
        if (continuation instanceof ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1) {
            ...
            int i2 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.J2;
            if ((i2 & Integer.MIN_VALUE) != 0) {
                modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.J2 = i2 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.f22226t;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i3 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.J2;
        if (i3 == 0) {
            ResultKt.throwOnFailure(obj);
            AnchoredDraggableState anchoredDraggableState = this.f22222n;
            float fT = t(j3);
            modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.f22225n = j3;
            modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.J2 = 1;
            if (anchoredDraggableState.X(fT, modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i3 != 1) {
            ...
            j3 = modalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1$onPostFling$1.f22225n;
            ResultKt.throwOnFailure(obj);
        }
