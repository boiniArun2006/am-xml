...
final class SnackbarHostKt$SnackbarHost$1$1 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ AccessibilityManager f23023O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f23024n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ SnackbarData f23025t;
    ...
    SnackbarHostKt$SnackbarHost$1$1(SnackbarData snackbarData, AccessibilityManager accessibilityManager, Continuation continuation) {
        ...
        this.f23025t = snackbarData;
        this.f23023O = accessibilityManager;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new SnackbarHostKt$SnackbarHost$1$1(this.f23025t, this.f23023O, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            SnackbarData snackbarData = this.f23025t;
            if (snackbarData != null) {
                SnackbarDuration duration = snackbarData.getDuration();
                if (this.f23025t.getActionLabel() != null) {
                    z2 = true;
                } else {
                    z2 = false;
                }
                long jKN = SnackbarHostKt.KN(duration, z2, this.f23023O);
                this.f23024n = 1;
