...
final class AnchoredDraggableKt$restartable$2 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ Function0 f21078O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f21079n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f21080t;
    ...
    static final class AnonymousClass1<T> implements CN3 {
        ...
        /* JADX INFO: renamed from: O, reason: collision with root package name */
        final /* synthetic */ Function2 f21081O;

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f21082n;

        /* JADX INFO: renamed from: t, reason: collision with root package name */
        final /* synthetic */ vd f21083t;
        ...
        static final class AnonymousClass2 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {
            ...
            /* JADX INFO: renamed from: O, reason: collision with root package name */
            final /* synthetic */ Object f21084O;

            /* JADX INFO: renamed from: n, reason: collision with root package name */
            int f21085n;

            /* JADX INFO: renamed from: t, reason: collision with root package name */
            final /* synthetic */ Function2 f21086t;

            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Object obj, Continuation continuation) {
                return new AnonymousClass2(this.f21086t, this.f21084O, this.J2, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i2 != 0) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    Function2 function2 = this.f21086t;
                    Object obj2 = this.f21084O;
                    this.f21085n = 1;
        ...
        AnonymousClass1(Ref.ObjectRef objectRef, vd vdVar, Function2 function2) {
            this.f21082n = objectRef;
            this.f21083t = vdVar;
            this.f21081O = function2;
        }
        ...
        */
        public final Object rl(Object obj, Continuation continuation) {
            ...
            if (continuation instanceof AnchoredDraggableKt$restartable$2$1$emit$1) {
                ...
                int i2 = anchoredDraggableKt$restartable$2$1$emit$1.f21089o;
                if ((i2 & Integer.MIN_VALUE) != 0) {
                    anchoredDraggableKt$restartable$2$1$emit$1.f21089o = i2 - Integer.MIN_VALUE;
                } else {
            ...
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i3 = anchoredDraggableKt$restartable$2$1$emit$1.f21089o;
            if (i3 == 0) {
                ResultKt.throwOnFailure(obj2);
                xuv xuvVar = (xuv) this.f21082n.element;
                if (xuvVar != null) {
                    xuvVar.cancel((CancellationException) new AnchoredDragFinishedSignal());
                    anchoredDraggableKt$restartable$2$1$emit$1.f21088n = this;
                    anchoredDraggableKt$restartable$2$1$emit$1.f21091t = obj;
                    anchoredDraggableKt$restartable$2$1$emit$1.f21087O = xuvVar;
                    anchoredDraggableKt$restartable$2$1$emit$1.f21089o = 1;
                ...
                obj = anchoredDraggableKt$restartable$2$1$emit$1.f21091t;
                anonymousClass1 = (AnonymousClass1) anchoredDraggableKt$restartable$2$1$emit$1.f21088n;
                ResultKt.throwOnFailure(obj2);
            }
            Ref.ObjectRef objectRef = anonymousClass1.f21082n;
            vd vdVar = anonymousClass1.f21083t;
            objectRef.element = (T) C.nr(vdVar, null, h.J2, new AnonymousClass2(anonymousClass1.f21081O, obj, vdVar, null), 1, null);
            return Unit.INSTANCE;
        }
    }
    ...
    AnchoredDraggableKt$restartable$2(Function0 function0, Function2 function2, Continuation continuation) {
        super(2, continuation);
        this.f21078O = function0;
        this.J2 = function2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        AnchoredDraggableKt$restartable$2 anchoredDraggableKt$restartable$2 = new AnchoredDraggableKt$restartable$2(this.f21078O, this.J2, continuation);
        anchoredDraggableKt$restartable$2.f21080t = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                throw new IllegalStateException(qfEYuUHwj.aLSBOgnb);
            }
        } else {
            ResultKt.throwOnFailure(obj);
            vd vdVar = (vd) this.f21080t;
            Ref.ObjectRef objectRef = new Ref.ObjectRef();
            Wre wreIk = SnapshotStateKt.Ik(this.f21078O);
