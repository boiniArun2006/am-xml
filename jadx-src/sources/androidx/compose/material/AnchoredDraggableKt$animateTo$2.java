...
@DebugMetadata(c = "androidx.compose.material.AnchoredDraggableKt$animateTo$2", f = "AnchoredDraggable.kt", i = {}, l = {693}, m = "invokeSuspend", n = {}, s = {})
final class AnchoredDraggableKt$animateTo$2 extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<Object>, Object, Continuation<? super Unit>, Object> {
    ...
    /* synthetic */ Object f21069O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f21070n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    final /* synthetic */ float f21071o;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ AnchoredDraggableState f21072r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f21073t;
    ...
    AnchoredDraggableKt$animateTo$2(AnchoredDraggableState anchoredDraggableState, float f3, Continuation continuation) {
        ...
        this.f21072r = anchoredDraggableState;
        this.f21071o = f3;
    }
    ...
    public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors draggableAnchors, Object obj, Continuation continuation) {
        AnchoredDraggableKt$animateTo$2 anchoredDraggableKt$animateTo$2 = new AnchoredDraggableKt$animateTo$2(this.f21072r, this.f21071o, continuation);
        anchoredDraggableKt$animateTo$2.f21073t = anchoredDragScope;
        anchoredDraggableKt$animateTo$2.f21069O = draggableAnchors;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            final AnchoredDragScope anchoredDragScope = (AnchoredDragScope) this.f21073t;
            float fT = ((DraggableAnchors) this.f21069O).t(this.J2);
            if (!Float.isNaN(fT)) {
                final Ref.FloatRef floatRef = new Ref.FloatRef();
                if (Float.isNaN(this.f21072r.WPU())) {
                    fWPU = 0.0f;
                } else {
                    fWPU = this.f21072r.WPU();
                }
                float f3 = fWPU;
                floatRef.element = f3;
                float f4 = this.f21071o;
                AnimationSpec animationSpec = this.f21072r.getAnimationSpec();
