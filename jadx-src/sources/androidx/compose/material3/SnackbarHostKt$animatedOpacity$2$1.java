...
final class SnackbarHostKt$animatedOpacity$2$1 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ boolean f27848O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f27849n;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ Function0 f27850r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Animatable f27851t;
    ...
    SnackbarHostKt$animatedOpacity$2$1(Animatable animatable, boolean z2, AnimationSpec animationSpec, Function0 function0, Continuation continuation) {
        ...
        this.f27851t = animatable;
        this.f27848O = z2;
        this.J2 = animationSpec;
        this.f27850r = function0;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new SnackbarHostKt$animatedOpacity$2$1(this.f27851t, this.f27848O, this.J2, this.f27850r, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            Animatable animatable = this.f27851t;
            if (this.f27848O) {
                f3 = 1.0f;
            } else {
                f3 = 0.0f;
        ...
        snackbarHostKt$animatedOpacity$2$1.f27850r.invoke();
