...
final class RangeSliderLogic$captureThumb$1 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ boolean f27160O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f27161n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ RangeSliderLogic f27162t;
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new RangeSliderLogic$captureThumb$1(this.f27162t, this.f27160O, this.J2, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            MutableInteractionSource mutableInteractionSourceN = this.f27162t.n(this.f27160O);
