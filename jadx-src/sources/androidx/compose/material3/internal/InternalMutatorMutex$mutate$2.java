...
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0002\u001a\u00028\u0000\"\u0004\b\u0000\u0010\u0000*\u00020\u0001H\u008a@"}, d2 = {"R", "LGJW/vd;", "<anonymous>"}, k = 3, mv = {1, 8, 0})
...
final class InternalMutatorMutex$mutate$2 extends SuspendLambda implements Function2<vd, Continuation<Object>, Object> {
    ...
    final /* synthetic */ Function1 f29200S;

    /* JADX INFO: renamed from: Z, reason: collision with root package name */
    final /* synthetic */ InternalMutatorMutex f29201Z;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    Object f29202n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    final /* synthetic */ MutatePriority f29203o;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private /* synthetic */ Object f29204r;
    ...
    InternalMutatorMutex$mutate$2(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function1 function1, Continuation continuation) {
        ...
        this.f29203o = mutatePriority;
        this.f29201Z = internalMutatorMutex;
        this.f29200S = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        InternalMutatorMutex$mutate$2 internalMutatorMutex$mutate$2 = new InternalMutatorMutex$mutate$2(this.f29203o, this.f29201Z, this.f29200S, continuation);
        internalMutatorMutex$mutate$2.f29204r = obj;
        ...
        try {
            try {
                if (r12 != 0) {
                    if (r12 != 1) {
                        if (r12 == 2) {
                            internalMutatorMutex2 = (InternalMutatorMutex) this.f29205t;
                            jVar2 = (yB.j) this.f29202n;
                            mutator2 = (InternalMutatorMutex.Mutator) this.f29204r;
                            try {
                    ...
                    internalMutatorMutex = (InternalMutatorMutex) this.f29199O;
                    function1 = (Function1) this.f29205t;
                    yB.j jVar3 = (yB.j) this.f29202n;
                    mutator = (InternalMutatorMutex.Mutator) this.f29204r;
                    ResultKt.throwOnFailure(obj);
                    jVar = jVar3;
                } else {
                    ResultKt.throwOnFailure(obj);
                    vd vdVar = (vd) this.f29204r;
                    MutatePriority mutatePriority = this.f29203o;
                    ...
                    this.f29201Z.J2(mutator3);
                    jVar = this.f29201Z.mutex;
                    Function1 function12 = this.f29200S;
                    InternalMutatorMutex internalMutatorMutex3 = this.f29201Z;
                    this.f29204r = mutator3;
                    this.f29202n = jVar;
                    this.f29205t = function12;
                    this.f29199O = internalMutatorMutex3;
                    this.J2 = 1;
                ...
                this.f29204r = mutator;
                this.f29202n = jVar;
                this.f29205t = internalMutatorMutex;
                this.f29199O = null;
                this.J2 = 2;
