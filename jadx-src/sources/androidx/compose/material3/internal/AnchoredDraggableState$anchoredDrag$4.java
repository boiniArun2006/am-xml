...
final class AnchoredDraggableState$anchoredDrag$4 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ Object f29059O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f29060n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ AnchoredDraggableState f29061t;
    ...
    AnchoredDraggableState$anchoredDrag$4(AnchoredDraggableState anchoredDraggableState, Object obj, Function4 function4, Continuation continuation) {
        ...
        this.f29061t = anchoredDraggableState;
        this.f29059O = obj;
        this.J2 = function4;
    }
    ...
    public final Continuation create(Continuation continuation) {
        return new AnchoredDraggableState$anchoredDrag$4(this.f29061t, this.f29059O, this.J2, continuation);
    }
    ...
    static final class AnonymousClass2<T> extends SuspendLambda implements Function2<Pair<? extends DraggableAnchors<T>, ? extends T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: O, reason: collision with root package name */
        final /* synthetic */ Function4 f29063O;

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        int f29064n;

        /* JADX INFO: renamed from: t, reason: collision with root package name */
        /* synthetic */ Object f29065t;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(Function4 function4, AnchoredDraggableState anchoredDraggableState, Continuation continuation) {
            super(2, continuation);
            this.f29063O = function4;
            this.J2 = anchoredDraggableState;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.f29063O, this.J2, continuation);
            anonymousClass2.f29065t = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            this.f29061t.fD(this.f29059O);
            final AnchoredDraggableState anchoredDraggableState = this.f29061t;
            ...
            AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.J2, this.f29061t, null);
            this.f29060n = 1;
