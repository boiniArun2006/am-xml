...
final class TabRowKt$ScrollableTabRowImpl$1$scope$1$1$tabIndicatorLayout$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    final /* synthetic */ Function4 f28172n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ TabRowKt$ScrollableTabRowImpl$1$scope$1$1 f28173t;
    ...
    public final MeasureResult n(MeasureScope measureScope, Measurable measurable, long j2) {
        return (MeasureResult) this.f28172n.invoke(measureScope, measurable, Constraints.n(j2), this.f28173t.getTabPositions().getValue());
    }
}
