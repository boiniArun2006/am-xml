...
final class ScrollableTabData {
    ...
    private final int rl(TabPosition tabPosition, Density density, int i2, List list) {
        int iHow = density.How(((TabPosition) CollectionsKt.last(list)).t()) + i2;
