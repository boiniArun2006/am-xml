...
public final class ChipElevation {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.mUb(this.elevation, chipElevation.elevation) && Dp.mUb(this.pressedElevation, chipElevation.pressedElevation) && Dp.mUb(this.focusedElevation, chipElevation.focusedElevation) && Dp.mUb(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.mUb(this.disabledElevation, chipElevation.disabledElevation);
    }
    ...
    private final State t(boolean z2, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (ComposerKt.v()) {
            ComposerKt.p5(-2071499570, i2, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2179)");
        }
        ...
        if (z4 || objIF3 == companion.n()) {
            objIF3 = new ChipElevation$animateElevation$1$1(interactionSource, snapshotStateList, null);
            composer.o(objIF3);
        }
        ...
        if (zE22 || objIF5 == companion.n()) {
            ...
            composer.o(chipElevation$animateElevation$2$1);
            objIF5 = chipElevation$animateElevation$2$1;
        } else {
            animatable = animatable3;
        }
    ...
    public final State J2(boolean z2, InteractionSource interactionSource, Composer composer, int i2) {
        if (ComposerKt.v()) {
            ComposerKt.p5(1881877139, i2, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2171)");
        }
