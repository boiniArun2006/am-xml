...
final class DBUtil__DBUtil_androidKt$performInTransactionSuspending$2 extends SuspendLambda implements Function1<Continuation<Object>, Object> {
    ...
    final /* synthetic */ Function1 f41804O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f41805n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ RoomDatabase f41806t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DBUtil__DBUtil_androidKt$performInTransactionSuspending$2(RoomDatabase roomDatabase, Function1 function1, Continuation continuation) {
        super(1, continuation);
        this.f41806t = roomDatabase;
        this.f41804O = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Continuation continuation) {
        return new DBUtil__DBUtil_androidKt$performInTransactionSuspending$2(this.f41806t, this.f41804O, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        RoomDatabase roomDatabase = this.f41806t;
        DBUtil__DBUtil_androidKt$performInTransactionSuspending$2$invokeSuspend$$inlined$internalPerform$1 dBUtil__DBUtil_androidKt$performInTransactionSuspending$2$invokeSuspend$$inlined$internalPerform$1 = new DBUtil__DBUtil_androidKt$performInTransactionSuspending$2$invokeSuspend$$inlined$internalPerform$1(true, false, roomDatabase, null, this.f41804O);
        this.f41805n = 1;
        Object objM7 = roomDatabase.M7(false, dBUtil__DBUtil_androidKt$performInTransactionSuspending$2$invokeSuspend$$inlined$internalPerform$1, this);
