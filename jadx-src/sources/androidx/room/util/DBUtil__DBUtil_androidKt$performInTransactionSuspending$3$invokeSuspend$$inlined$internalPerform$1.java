...
public final class DBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1 extends SuspendLambda implements Function2<Transactor, Continuation<Object>, Object> {
    ...
    /* synthetic */ Object f41819O;

    /* JADX INFO: renamed from: Z, reason: collision with root package name */
    final /* synthetic */ Function1 f41820Z;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    Object f41821n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    final /* synthetic */ RoomDatabase f41822o;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ boolean f41823r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    int f41824t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1(boolean z2, boolean z3, RoomDatabase roomDatabase, Continuation continuation, Function1 function1) {
        super(2, continuation);
        this.J2 = z2;
        this.f41823r = z3;
        this.f41822o = roomDatabase;
        this.f41820Z = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        DBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1 dBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1 = new DBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1(this.J2, this.f41823r, this.f41822o, continuation, this.f41820Z);
        dBUtil__DBUtil_androidKt$performInTransactionSuspending$3$invokeSuspend$$inlined$internalPerform$1.f41819O = obj;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<TransactionScope<Object>, Continuation<Object>, Object> {
        ...
        /* JADX INFO: renamed from: O, reason: collision with root package name */
        final /* synthetic */ Function1 f41825O;

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        int f41826n;

        /* JADX INFO: renamed from: t, reason: collision with root package name */
        private /* synthetic */ Object f41827t;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(Continuation continuation, Function1 function1) {
            super(2, continuation);
            this.f41825O = function1;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(continuation, this.f41825O);
            anonymousClass1.f41827t = obj;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            Function1 function1 = this.f41825O;
            this.f41826n = 1;
            InlineMarker.mark(6);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 3) {
                        ...
                        if (!((Boolean) obj).booleanValue()) {
                            this.f41822o.WPU().aYN();
                        }
                        return obj2;
                    }
                    transactor = (Transactor) this.f41819O;
                    ResultKt.throwOnFailure(obj);
                    if (this.f41823r) {
                        this.f41819O = obj;
                        this.f41824t = 4;
                ...
                sQLiteTransactionType2 = (Transactor.SQLiteTransactionType) this.f41821n;
                transactor2 = (Transactor) this.f41819O;
                ResultKt.throwOnFailure(obj);
                Transactor transactor3 = transactor2;
                sQLiteTransactionType = sQLiteTransactionType2;
                transactor = transactor3;
                AnonymousClass1 anonymousClass1 = new AnonymousClass1(null, this.f41820Z);
                this.f41819O = transactor;
                this.f41821n = null;
                this.f41824t = 3;
            ...
            ResultKt.throwOnFailure(obj);
            Transactor transactor4 = (Transactor) this.f41819O;
            if (this.J2) {
                boolean z2 = this.f41823r;
                if (z2) {
                ...
                if (!z2) {
                    this.f41819O = transactor4;
                    this.f41821n = sQLiteTransactionType;
                    this.f41824t = 1;
                    ...
                    AnonymousClass1 anonymousClass12 = new AnonymousClass1(null, this.f41820Z);
                    this.f41819O = transactor;
                    this.f41821n = null;
                    this.f41824t = 3;
                ...
                Function1 function1 = this.f41820Z;
                this.f41824t = 5;
                InlineMarker.mark(6);
                Object objInvoke = function1.invoke(this);
                InlineMarker.mark(7);
        ...
        if (!((Boolean) obj).booleanValue()) {
            InvalidationTracker invalidationTrackerWPU = this.f41822o.WPU();
            this.f41819O = transactor2;
            this.f41821n = sQLiteTransactionType2;
            this.f41824t = 2;
        }
        Transactor transactor32 = transactor2;
        sQLiteTransactionType = sQLiteTransactionType2;
        transactor = transactor32;
        AnonymousClass1 anonymousClass122 = new AnonymousClass1(null, this.f41820Z);
        this.f41819O = transactor;
        this.f41821n = null;
        this.f41824t = 3;
