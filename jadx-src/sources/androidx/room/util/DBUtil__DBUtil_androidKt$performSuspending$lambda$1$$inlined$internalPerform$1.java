...
public final class DBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1 extends SuspendLambda implements Function2<Transactor, Continuation<Object>, Object> {
    ...
    /* synthetic */ Object f41837O;

    /* JADX INFO: renamed from: Z, reason: collision with root package name */
    final /* synthetic */ Function1 f41838Z;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    Object f41839n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    final /* synthetic */ RoomDatabase f41840o;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ boolean f41841r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    int f41842t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1(boolean z2, boolean z3, RoomDatabase roomDatabase, Continuation continuation, Function1 function1) {
        super(2, continuation);
        this.J2 = z2;
        this.f41841r = z3;
        this.f41840o = roomDatabase;
        this.f41838Z = function1;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        DBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1 dBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1 = new DBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1(this.J2, this.f41841r, this.f41840o, continuation, this.f41838Z);
        dBUtil__DBUtil_androidKt$performSuspending$lambda$1$$inlined$internalPerform$1.f41837O = obj;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<TransactionScope<Object>, Continuation<Object>, Object> {
        ...
        /* JADX INFO: renamed from: O, reason: collision with root package name */
        final /* synthetic */ Function1 f41843O;

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        int f41844n;

        /* JADX INFO: renamed from: t, reason: collision with root package name */
        private /* synthetic */ Object f41845t;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(Continuation continuation, Function1 function1) {
            super(2, continuation);
            this.f41843O = function1;
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation create(Object obj, Continuation continuation) {
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(continuation, this.f41843O);
            anonymousClass1.f41845t = obj;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f41844n == 0) {
                ...
                TransactionScope transactionScope = (TransactionScope) this.f41845t;
                ...
                return this.f41843O.invoke(((RawConnectionAccessor) transactionScope).t());
            }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                    ...
                    if (i2 != 3) {
                        if (i2 == 4) {
                            ...
                            if (!((Boolean) obj).booleanValue()) {
                                this.f41840o.WPU().aYN();
                            }
                            return obj2;
                        }
                        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                    }
                    transactor = (Transactor) this.f41837O;
                    ResultKt.throwOnFailure(obj);
                    if (this.f41841r) {
                        this.f41837O = obj;
                        this.f41842t = 4;
                ...
                sQLiteTransactionType2 = (Transactor.SQLiteTransactionType) this.f41839n;
                transactor3 = (Transactor) this.f41837O;
                ResultKt.throwOnFailure(obj);
                sQLiteTransactionType = sQLiteTransactionType2;
                transactor = transactor3;
                AnonymousClass1 anonymousClass1 = new AnonymousClass1(null, this.f41838Z);
                this.f41837O = transactor;
                this.f41839n = null;
                this.f41842t = 3;
            ...
            sQLiteTransactionType2 = (Transactor.SQLiteTransactionType) this.f41839n;
            transactor2 = (Transactor) this.f41837O;
            ResultKt.throwOnFailure(obj);
        } else {
            ResultKt.throwOnFailure(obj);
            Transactor transactor4 = (Transactor) this.f41837O;
            if (this.J2) {
                boolean z2 = this.f41841r;
                if (z2) {
                ...
                if (!z2) {
                    this.f41837O = transactor4;
                    this.f41839n = sQLiteTransactionType;
                    this.f41842t = 1;
                ...
                AnonymousClass1 anonymousClass12 = new AnonymousClass1(null, this.f41838Z);
                this.f41837O = transactor;
                this.f41839n = null;
                this.f41842t = 3;
            ...
            return this.f41838Z.invoke(((RawConnectionAccessor) transactor4).t());
        }
        if (!((Boolean) obj).booleanValue()) {
            InvalidationTracker invalidationTrackerWPU = this.f41840o.WPU();
            this.f41837O = transactor2;
            this.f41839n = sQLiteTransactionType2;
            this.f41842t = 2;
            if (invalidationTrackerWPU.fD(this) != coroutine_suspended) {
                transactor3 = transactor2;
                sQLiteTransactionType = sQLiteTransactionType2;
                transactor = transactor3;
                AnonymousClass1 anonymousClass122 = new AnonymousClass1(null, this.f41838Z);
                this.f41837O = transactor;
                this.f41839n = null;
                this.f41842t = 3;
        ...
        sQLiteTransactionType = sQLiteTransactionType2;
        transactor = transactor2;
        AnonymousClass1 anonymousClass1222 = new AnonymousClass1(null, this.f41838Z);
        this.f41837O = transactor;
        this.f41839n = null;
        this.f41842t = 3;
