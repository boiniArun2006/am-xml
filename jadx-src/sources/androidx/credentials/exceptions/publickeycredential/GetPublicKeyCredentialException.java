        ...
        public final GetCredentialException n(String type, String msg) {
            ...
            try {
                if (StringsKt.startsWith$default(type, "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION", false, 2, (Object) null)) {
                    return GetPublicKeyCredentialDomException.INSTANCE.n(type, msg);
                }
