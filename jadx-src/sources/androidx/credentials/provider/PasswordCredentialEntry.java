...
public final class PasswordCredentialEntry extends CredentialEntry {
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\n\u001a\u00020\t2\u0006\u0010\u0005\u001a\u00020\u0004H\u0007¢\u0006\u0004\b\n\u0010\u000bJ\u0019\u0010\r\u001a\u0004\u0018\u00010\u00042\u0006\u0010\f\u001a\u00020\tH\u0007¢\u0006\u0004\b\r\u0010\u000e¨\u0006\u000f"}, d2 = {"Landroidx/credentials/provider/PasswordCredentialEntry$Api28Impl;", "", "<init>", "()V", "Landroidx/credentials/provider/PasswordCredentialEntry;", "entry", "", "rl", "(Landroidx/credentials/provider/PasswordCredentialEntry;)Z", "Landroid/app/slice/Slice;", "t", "(Landroidx/credentials/provider/PasswordCredentialEntry;)Landroid/app/slice/Slice;", "slice", com.safedk.android.analytics.brandsafety.creatives.discoveries.c.f62177j, "(Landroid/app/slice/Slice;)Landroidx/credentials/provider/PasswordCredentialEntry;", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @RequiresApi
    @SourceDebugExtension({"SMAP\nPasswordCredentialEntry.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PasswordCredentialEntry.kt\nandroidx/credentials/provider/PasswordCredentialEntry$Api28Impl\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,622:1\n1855#2,2:623\n*S KotlinDebug\n*F\n+ 1 PasswordCredentialEntry.kt\nandroidx/credentials/provider/PasswordCredentialEntry$Api28Impl\n*L\n364#1:623,2\n*E\n"})
    private static final class Api28Impl {

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        public static final Api28Impl f37270n = new Api28Impl();

        public static final PasswordCredentialEntry n(Slice slice) {
            ...
            try {
                ...
                return new PasswordCredentialEntry(text2, text3, text4, action, instantOfEpochMilli, icon, z2, companion.n(bundle, text.toString()), z3, text5, text6, z4, true, z5);
            } catch (Exception e2) {
                Log.i("PasswordCredentialEntry", "fromSlice failed with: " + e2.getMessage());
                return null;
            }
        }

        public static final boolean rl(PasswordCredentialEntry entry) {
            Intrinsics.checkNotNullParameter(entry, "entry");
            return entry.isCreatedFromSlice ? entry.isDefaultIconFromSlice : entry.getIcon().getType() == 2 && entry.getIcon().getResId() == R.drawable.f37033t;
        }

        public static final Slice t(PasswordCredentialEntry entry) {
            Intrinsics.checkNotNullParameter(entry, "entry");
    ...
    public static final class Companion {
        ...
        public final PasswordCredentialEntry n(Slice slice) {
            Intrinsics.checkNotNullParameter(slice, "slice");
        ...
        public final Slice rl(PasswordCredentialEntry entry) {
            Intrinsics.checkNotNullParameter(entry, "entry");
            if (Build.VERSION.SDK_INT >= 28) {
    ...
    @RequiresApi
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Landroidx/credentials/provider/PasswordCredentialEntry$Api34Impl;", "", "<init>", "()V", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    private static final class Api34Impl {

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        public static final Api34Impl f37271n = new Api34Impl();
    ...
    public PasswordCredentialEntry(CharSequence username, CharSequence charSequence, CharSequence typeDisplayName, PendingIntent pendingIntent, Instant instant, Icon icon, boolean z2, BeginGetPasswordOption beginGetPasswordOption, boolean z3, CharSequence charSequence2, CharSequence charSequence3, boolean z4, boolean z5, boolean z6) {
        super("android.credentials.TYPE_PASSWORD_CREDENTIAL", beginGetPasswordOption, charSequence2 == null ? username : charSequence2, z3, charSequence3);
