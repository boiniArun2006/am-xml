            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        int i8 = iArr[i7];
                        float f3 = fArr[i7];
                        int iN = intFloatMap.n(i8);
                        if (iN < 0) {
                            break loop0;
                        }
                        z3 = z4;
                        if (f3 != intFloatMap.values[iN]) {
                            break loop0;
                        }
                    } else {
                        z3 = z4;
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        int i7 = (i2 << 3) + i5;
                        int i8 = iArr[i7];
                        iHashCode += Float.hashCode(fArr[i7]) ^ Integer.hashCode(i8);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
