...
public abstract class IntObjectMap<V> {
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i3; i5++) {
                        if ((255 & j2) < 128) {
                            ...
                            if (obj == null) {
                                if (intObjectMap.rl(i8) != null || !intObjectMap.n(i8)) {
                                    break loop0;
                                }
                            } else if (!Intrinsics.areEqual(obj, intObjectMap.rl(i8))) {
                                return false;
                            }
                        }
                        j2 >>= 8;
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        ...
                        int i8 = iArr[i7];
                        Object obj = objArr[i7];
                        iHashCode += (obj != null ? obj.hashCode() : 0) ^ Integer.hashCode(i8);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object rl(int key) {
        int iNumberOfTrailingZeros;
        int iHashCode = Integer.hashCode(key) * (-862048943);
        int i2 = iHashCode ^ (iHashCode << 16);
        int i3 = i2 & 127;
