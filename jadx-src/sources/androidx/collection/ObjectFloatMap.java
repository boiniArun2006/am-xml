...
@Metadata(d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0016\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\b\u0003\n\u0002\u0010\u0014\n\u0002\b\f\n\u0002\u0018\u0002\n\u0000\b6\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002B\t\b\u0004¢\u0006\u0004\b\u0003\u0010\u0004J\r\u0010\u0006\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\u001d\u0010\u000b\u001a\u00020\t2\u0006\u0010\b\u001a\u00028\u00002\u0006\u0010\n\u001a\u00020\t¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\r\u001a\u00020\u00052\u0006\u0010\b\u001a\u00028\u0000¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u0010\u001a\u00020\u000fH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u001a\u0010\u0013\u001a\u00020\u00052\b\u0010\u0012\u001a\u0004\u0018\u00010\u0002H\u0096\u0002¢\u0006\u0004\b\u0013\u0010\u000eJ\u000f\u0010\u0015\u001a\u00020\u0014H\u0016¢\u0006\u0004\b\u0015\u0010\u0016J\u0017\u0010\u0017\u001a\u00020\u000f2\u0006\u0010\b\u001a\u00028\u0000H\u0001¢\u0006\u0004\b\u0017\u0010\u0018R\u001c\u0010\u001c\u001a\u00020\u00198\u0000@\u0000X\u0081\u000e¢\u0006\f\n\u0004\b\r\u0010\u001a\u0012\u0004\b\u001b\u0010\u0004R$\u0010 \u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u001d8\u0000@\u0000X\u0081\u000e¢\u0006\f\n\u0004\b\u0017\u0010\u001e\u0012\u0004\b\u001f\u0010\u0004R\u001c\u0010%\u001a\u00020!8\u0000@\u0000X\u0081\u000e¢\u0006\f\n\u0004\b\"\u0010#\u0012\u0004\b$\u0010\u0004R\u001c\u0010(\u001a\u00020\u000f8\u0000@\u0000X\u0081\u000e¢\u0006\f\n\u0004\b\u000b\u0010&\u0012\u0004\b'\u0010\u0004R\u001c\u0010+\u001a\u00020\u000f8\u0000@\u0000X\u0081\u000e¢\u0006\f\n\u0004\b)\u0010&\u0012\u0004\b*\u0010\u0004R\u0011\u0010,\u001a\u00020\u000f8F¢\u0006\u0006\u001a\u0004\b\"\u0010\u0011R\u0011\u0010-\u001a\u00020\u000f8F¢\u0006\u0006\u001a\u0004\b)\u0010\u0011\u0082\u0001\u0001.¨\u0006/"}, d2 = {"Landroidx/collection/ObjectFloatMap;", "K", "", "<init>", "()V", "", "J2", "()Z", "key", "", "defaultValue", "nr", "(Ljava/lang/Object;F)F", c.f62177j, "(Ljava/lang/Object;)Z", "", "hashCode", "()I", InneractiveMediationNameConsts.OTHER, "equals", "", "toString", "()Ljava/lang/String;", "rl", "(Ljava/lang/Object;)I", "", "[J", "getMetadata$annotations", TtmlNode.TAG_METADATA, "", "[Ljava/lang/Object;", "getKeys$annotations", IV8ValueMap.FUNCTION_KEYS, "", "t", "[F", "getValues$annotations", IV8ValueMap.FUNCTION_VALUES, "I", "get_capacity$collection$annotations", "_capacity", "O", "get_size$collection$annotations", "_size", "capacity", "size", "Landroidx/collection/MutableObjectFloatMap;", "collection"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public abstract class ObjectFloatMap<K> {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        float f3 = fArr[i7];
                        int iRl = objectFloatMap.rl(obj);
                        if (iRl < 0) {
                            break loop0;
                        }
                        z3 = z4;
                        if (f3 != objectFloatMap.values[iRl]) {
                            break loop0;
                        }
                    } else {
                        z3 = z4;
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        int i7 = (i2 << 3) + i5;
                        Object obj = objArr[i7];
                        iHashCode += Float.hashCode(fArr[i7]) ^ (obj != null ? obj.hashCode() : 0);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
    ...
    */
    ...
    public final float nr(Object key, float defaultValue) {
        int iRl = rl(key);
        if (iRl >= 0) {
