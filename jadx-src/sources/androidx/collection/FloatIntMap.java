            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        float f3 = fArr[i7];
                        int i8 = iArr[i7];
                        int iN = floatIntMap.n(f3);
                        if (iN < 0) {
                            break loop0;
                        }
                        z3 = z4;
                        if (i8 != floatIntMap.values[iN]) {
                            break loop0;
                        }
                    } else {
                        z3 = z4;
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        int i7 = (i2 << 3) + i5;
                        float f3 = fArr[i7];
                        iHashCode += Integer.hashCode(iArr[i7]) ^ Float.hashCode(f3);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
