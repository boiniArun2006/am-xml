...
public abstract class LongObjectMap<V> {
    ...
    */
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        if (obj == null) {
                            if (longObjectMap.rl(j3) != null || !longObjectMap.n(j3)) {
                                break loop0;
                            }
                        } else if (!Intrinsics.areEqual(obj, longObjectMap.rl(j3))) {
                            return false;
                        }
                    } else {
                        z3 = z4;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean n(long key) {
