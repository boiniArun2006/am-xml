            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        long j3 = jArr2[i7];
                        float f3 = fArr[i7];
                        int iN = longFloatMap.n(j3);
                        if (iN < 0 || f3 != longFloatMap.values[iN]) {
                            break loop0;
                        }
                    } else {
                        z3 = z4;
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        int i7 = (i2 << 3) + i5;
                        long j3 = jArr[i7];
                        iHashCode += Float.hashCode(fArr[i7]) ^ Long.hashCode(j3);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
