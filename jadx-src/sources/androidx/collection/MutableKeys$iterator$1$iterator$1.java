...
final class MutableKeys$iterator$1$iterator$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Integer>, Continuation<? super Unit>, Object> {
    ...
    private /* synthetic */ Object f14801S;

    /* JADX INFO: renamed from: Z, reason: collision with root package name */
    int f14802Z;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    final /* synthetic */ MutableKeys f14803g;
    ...
    MutableKeys$iterator$1$iterator$1(MutableKeys mutableKeys, Continuation continuation) {
        super(2, continuation);
        this.f14803g = mutableKeys;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        MutableKeys$iterator$1$iterator$1 mutableKeys$iterator$1$iterator$1 = new MutableKeys$iterator$1$iterator$1(this.f14803g, continuation);
        mutableKeys$iterator$1$iterator$1.f14801S = obj;
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:12:0x0053 -> B:23:0x0099). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:13:0x0055 -> B:14:0x0067). Please report as a decompilation issue!!! */
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            sequenceScope = (SequenceScope) this.f14801S;
            jArr = this.f14803g.parent.metadata;
        ...
        if (i3 != 1) {
            throw new IllegalStateException(aNrWBQYwFf.DZpxdwHot);
        }
        int i5 = this.f14806r;
        int i7 = this.J2;
        long j3 = this.f14805o;
        int i8 = this.f14800O;
        int i9 = this.f14807t;
        long[] jArr2 = (long[]) this.f14804n;
        SequenceScope sequenceScope2 = (SequenceScope) this.f14801S;
        ResultKt.throwOnFailure(obj);
        j3 >>= 8;
        i5++;
        if (i5 < i7) {
