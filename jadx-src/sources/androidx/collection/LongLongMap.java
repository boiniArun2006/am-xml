            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i5 < i3) {
                    if ((255 & j2) < 128) {
                        ...
                        long j3 = jArr2[i7];
                        long j4 = jArr4[i7];
                        int iN = longLongMap.n(j3);
                        if (iN < 0 || j4 != longLongMap.values[iN]) {
                            break loop0;
                        }
                    } else {
                        z3 = z4;
        ...
        while (true) {
            ...
            if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i5 = 0; i5 < i3; i5++) {
                    if ((255 & j2) < 128) {
                        int i7 = (i2 << 3) + i5;
                        iHashCode += Long.hashCode(jArr[i7]) ^ Long.hashCode(jArr2[i7]);
                    }
                    j2 >>= 8;
                }
                if (i3 != 8) {
