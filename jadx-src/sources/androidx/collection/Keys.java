...
final class Keys<K, V> implements Set<K>, KMappedMarker {
    ...
    static final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super K>, Continuation<? super Unit>, Object> {
        ...
        private /* synthetic */ Object f14735g;
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i3 == 0) {
                ...
                sequenceScope = (SequenceScope) this.f14735g;
                ScatterMap scatterMap = Keys.this.parent;
                objArr = scatterMap.com.caoccao.javet.values.reference.IV8ValueMap.FUNCTION_KEYS java.lang.String;
            ...
            int i5 = this.f14737o;
            int i7 = this.f14738r;
            long j3 = this.f14734Z;
            i2 = this.J2;
            int i8 = this.f14732O;
            long[] jArr2 = (long[]) this.f14739t;
            Object[] objArr2 = (Object[]) this.f14736n;
            SequenceScope sequenceScope2 = (SequenceScope) this.f14735g;
            ResultKt.throwOnFailure(obj);
            j3 >>= 8;
            i5++;
            if (i5 < i7) {
                        ...
                        if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                            ...
                            if (i5 < i7) {
                                if ((255 & j3) < 128) {
                                    ...
                                    this.f14735g = sequenceScope2;
                                    this.f14736n = objArr2;
                                    this.f14739t = jArr2;
                                    this.f14732O = i8;
                                    this.J2 = i2;
                                    this.f14734Z = j3;
