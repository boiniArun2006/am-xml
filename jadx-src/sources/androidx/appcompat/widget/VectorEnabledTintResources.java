...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    private static boolean f14448t;
    ...
    public Drawable getDrawable(int i2) {
        ...
        return context != null ? ResourceManagerInternal.Uo().o(context, this, i2) : n(i2);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ float getFraction(int i2, int i3, int i5) {
        return super.getFraction(i2, i3, i5);
    }
