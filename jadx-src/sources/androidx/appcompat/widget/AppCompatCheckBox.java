...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    private final AppCompatTextHelper f14052O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private final AppCompatCompoundButtonHelper f14053n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private final AppCompatBackgroundHelper f14054t;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.f14057t = propertyMapper.mapObject("backgroundTintMode", R.attr.WPU);
            this.nr = propertyMapper.mapObject("buttonTint", R.attr.ViF);
            this.f14055O = propertyMapper.mapObject("buttonTintMode", R.attr.nY);
        ...
        public void readProperties(AppCompatCheckBox appCompatCheckBox, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.rl, appCompatCheckBox.getBackgroundTintList());
            propertyReader.readObject(this.f14057t, appCompatCheckBox.getBackgroundTintMode());
            propertyReader.readObject(this.nr, appCompatCheckBox.getButtonTintList());
            propertyReader.readObject(this.f14055O, appCompatCheckBox.getButtonTintMode());
            propertyReader.readObject(this.J2, appCompatCheckBox.getCompoundDrawableTintList());
            propertyReader.readObject(this.Uo, appCompatCheckBox.getCompoundDrawableTintMode());
        }
    }

    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.iF);
    }

    @Override // android.widget.CompoundButton
    public void setButtonDrawable(Drawable drawable) {
        super.setButtonDrawable(drawable);
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.f14053n;
    ...
    public ColorStateList getSupportBackgroundTintList() {
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f14054t;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f14052O.mUb();
    }

    @Nullable
    @RestrictTo
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f14052O.gh();
    }
    ...
    public void setSupportCompoundDrawablesTintList(@Nullable ColorStateList colorStateList) {
        this.f14052O.WPU(colorStateList);
        this.f14052O.rl();
    }

    @RestrictTo
    public void setSupportCompoundDrawablesTintMode(@Nullable PorterDuff.Mode mode) {
        this.f14052O.aYN(mode);
        this.f14052O.rl();
    }
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatTextHelper appCompatTextHelper = this.f14052O;
