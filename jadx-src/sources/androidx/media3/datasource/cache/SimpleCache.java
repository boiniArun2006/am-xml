...
public final class SimpleCache implements Cache {
    ...
    public synchronized boolean isCached(String str, long j2, long j3) {
        ...
        if (cachedContent != null) {
            if (cachedContent.getCachedBytesLength(j2, j3) >= j3) {
                z2 = true;
            }
        }
        return z2;
        ...
        for (File file2 : fileArr) {
            ...
            if (z2 && name.indexOf(46) == -1) {
                ...
                if (cacheFileMetadataRemove != null) {
                    ...
                    j3 = cacheFileMetadataRemove.lastTouchTimestamp;
                } else {
                    j2 = -1;
                    j3 = -9223372036854775807L;
                }
                SimpleCacheSpan simpleCacheSpanCreateCacheEntry = SimpleCacheSpan.createCacheEntry(file2, j2, j3, this.contentIndex);
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        SimpleCacheSpan lastTouchTimestamp = ((CachedContent) Assertions.checkNotNull(this.contentIndex.get(str))).setLastTouchTimestamp(simpleCacheSpan, jCurrentTimeMillis, z2);
