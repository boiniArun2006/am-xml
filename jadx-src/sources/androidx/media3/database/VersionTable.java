...
public final class VersionTable {
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i2, String str) throws DatabaseIOException {
        ...
        Cursor cursorQuery = sQLiteDatabase.query(TABLE_NAME, new String[]{"version"}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i2, str), null, null, null);
        try {
