...
public class TrackSelectionParameters {
    ...
    public final com.google.common.collect.Ln disabledTrackTypes;
    ...
    public final com.google.common.collect.u overrides;
    public final com.google.common.collect.nKK preferredAudioLanguages;
    public final com.google.common.collect.nKK preferredAudioMimeTypes;
    public final int preferredAudioRoleFlags;
    public final com.google.common.collect.nKK preferredTextLanguages;
    public final int preferredTextRoleFlags;

    @UnstableApi
    public final com.google.common.collect.nKK preferredVideoLanguages;
    public final com.google.common.collect.nKK preferredVideoMimeTypes;
    ...
    public static class Builder {
        ...
        private com.google.common.collect.nKK preferredAudioLanguages;
        private com.google.common.collect.nKK preferredAudioMimeTypes;
        private int preferredAudioRoleFlags;
        private com.google.common.collect.nKK preferredTextLanguages;
        private int preferredTextRoleFlags;
        private com.google.common.collect.nKK preferredVideoLanguages;
        private com.google.common.collect.nKK preferredVideoMimeTypes;
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = com.google.common.collect.nKK.r();
            this.preferredVideoLanguages = com.google.common.collect.nKK.r();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = com.google.common.collect.nKK.r();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = com.google.common.collect.nKK.r();
            this.audioOffloadPreferences = AudioOffloadPreferences.DEFAULT;
            this.preferredTextLanguages = com.google.common.collect.nKK.r();
        ...
        private static com.google.common.collect.nKK normalizeLanguageCodes(String[] strArr) {
        ...
        public Builder setPreferredAudioMimeTypes(String... strArr) {
            this.preferredAudioMimeTypes = com.google.common.collect.nKK.HI(strArr);
            return this;
        }
        ...
        public Builder setPreferredVideoMimeTypes(String... strArr) {
            this.preferredVideoMimeTypes = com.google.common.collect.nKK.HI(strArr);
            return this;
        }
        ...
        protected Builder(Bundle bundle) {
            com.google.common.collect.nKK nkkFromBundleList;
            ...
            int i2 = bundle.getInt(TrackSelectionParameters.FIELD_VIEWPORT_HEIGHT, trackSelectionParameters.viewportHeight);
            this.viewportHeight = i2;
            this.isViewportSizeLimitedByPhysicalDisplaySize = this.viewportWidth == Integer.MAX_VALUE && i2 == Integer.MAX_VALUE && bundle.getBoolean(TrackSelectionParameters.FIELD_IS_VIEWPORT_SIZE_LIMITED_BY_PHYSICAL_DISPLAY_SIZE, trackSelectionParameters.isViewportSizeLimitedByPhysicalDisplaySize);
            ...
            this.preferredVideoMimeTypes = com.google.common.collect.nKK.HI((String[]) t1.Dsr.n(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_MIMETYPES), new String[0]));
            this.preferredVideoLanguages = com.google.common.collect.nKK.HI((String[]) t1.Dsr.n(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioLanguages = normalizeLanguageCodes((String[]) t1.Dsr.n(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioMimeTypes = com.google.common.collect.nKK.HI((String[]) t1.Dsr.n(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_MIME_TYPES), new String[0]));
            this.audioOffloadPreferences = getAudioOffloadPreferencesFromBundle(bundle);
            this.preferredTextLanguages = normalizeLanguageCodes((String[]) t1.Dsr.n(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_TEXT_LANGUAGES), new String[0]));
            ...
            if (parcelableArrayList == null) {
                nkkFromBundleList = com.google.common.collect.nKK.r();
            } else {
                nkkFromBundleList = BundleCollectionUtil.fromBundleList(new t1.CN3() { // from class: androidx.media3.common.V1
                    @Override // t1.CN3
            ...
            this.overrides = new HashMap<>();
            for (int i3 = 0; i3 < nkkFromBundleList.size(); i3++) {
                TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) nkkFromBundleList.get(i3);
                this.overrides.put(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
            }
            int[] iArr = (int[]) t1.Dsr.n(bundle.getIntArray(TrackSelectionParameters.FIELD_DISABLED_TRACK_TYPE), new int[0]);
            this.disabledTrackTypes = new HashSet<>();
            for (int i5 : iArr) {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleArrayList(this.overrides.values(), new t1.CN3() { // from class: androidx.media3.common.T
            @Override // t1.CN3
            public final Object apply(Object obj) {
                return ((TrackSelectionOverride) obj).toBundle();
            }
        }));
        bundle.putIntArray(FIELD_DISABLED_TRACK_TYPE, com.google.common.primitives.Wre.az(this.disabledTrackTypes));
        return bundle;
    }
    ...
    protected TrackSelectionParameters(Builder builder) {
        ...
        this.overrides = com.google.common.collect.u.Uo(builder.overrides);
        this.disabledTrackTypes = com.google.common.collect.Ln.az(builder.disabledTrackTypes);
    }
}
