...
public final class MediaMetadata {
    ...
    @UnstableApi
    public final com.google.common.collect.nKK supportedCommands;
    ...
    public static final class Builder {
        ...
        private com.google.common.collect.nKK supportedCommands;
        ...
        public Builder() {
            this.supportedCommands = com.google.common.collect.nKK.r();
        }
        ...
        public Builder populate(@Nullable MediaMetadata mediaMetadata) {
            if (mediaMetadata != null) {
                ...
                Long l2 = mediaMetadata.durationMs;
                if (l2 != null) {
                    setDurationMs(l2);
                }
        ...
        public Builder setDurationMs(@Nullable Long l2) {
            Assertions.checkArgument(l2 == null || l2.longValue() >= 0);
            this.durationMs = l2;
            return this;
        }
        ...
        public Builder setSupportedCommands(List<String> list) {
            this.supportedCommands = com.google.common.collect.nKK.ty(list);
            return this;
        }
