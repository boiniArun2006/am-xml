...
final class CustomSpanBundler {
    ...
    private static Bundle spanToBundle(Spanned spanned, Object obj, int i2, @Nullable Bundle bundle) {
    ...
    public static void unbundleAndApplyCustomSpan(Bundle bundle, Spannable spannable) {
        ...
        int i3 = bundle.getInt(FIELD_END_INDEX);
        int i5 = bundle.getInt(FIELD_FLAGS);
        int i7 = bundle.getInt(FIELD_TYPE, -1);
        Bundle bundle2 = bundle.getBundle(FIELD_PARAMS);
        if (i7 == 1) {
            spannable.setSpan(RubySpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i2, i3, i5);
            return;
        }
        if (i7 == 2) {
            spannable.setSpan(TextEmphasisSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i2, i3, i5);
        } else if (i7 == 3) {
            spannable.setSpan(new HorizontalTextInVerticalContextSpan(), i2, i3, i5);
        } else {
            if (i7 != 4) {
                return;
            }
            spannable.setSpan(VoiceSpan.fromBundle((Bundle) Assertions.checkNotNull(bundle2)), i2, i3, i5);
        }
    }
