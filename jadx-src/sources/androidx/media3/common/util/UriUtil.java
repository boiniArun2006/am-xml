...
public final class UriUtil {
    ...
    public static String resolve(@Nullable String str, @Nullable String str2) {
        ...
        int i7 = uriIndices2[0] + 2;
        int i8 = uriIndices2[1];
        if (i7 >= i8 || i8 != uriIndices2[2]) {
            int iLastIndexOf = str.lastIndexOf(47, uriIndices2[2] - 1);
            int i9 = iLastIndexOf == -1 ? uriIndices2[1] : iLastIndexOf + 1;
    ...
    public static String getRelativePath(Uri uri, Uri uri2) {
        if (!uri.isOpaque() && !uri2.isOpaque()) {
            ...
            if (scheme != null ? !(scheme2 == null || !AbstractC2372w6.n(scheme, scheme2)) : scheme2 == null) {
                if (Objects.equals(uri.getAuthority(), uri2.getAuthority())) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    for (int i5 = i2; i5 < pathSegments.size(); i5++) {
                        sb.append("../");
                    }
