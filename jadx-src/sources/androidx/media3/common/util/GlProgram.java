...
public final class GlProgram {
    ...
    private static final class Uniform {
        ...
        public void bind(boolean z2) throws GlUtil.GlException {
            int i2 = this.type;
            if (i2 == 5124) {
            ...
            if (i2 == 35678 || i2 == GlProgram.GL_SAMPLER_EXTERNAL_2D_Y2Y_EXT || i2 == 36198) {
                ...
                GlUtil.checkGlError();
                int i3 = this.type;
                GlUtil.bindTexture(i3 == 35678 ? 3553 : 36197, this.texIdValue, (i3 == 35678 || !z2) ? androidx.media3.common.C.TEXTURE_MIN_FILTER_LINEAR : 9728);
                if (this.type == 35678) {
    ...
    public void setSamplerTexIdUniform(String str, int i2, int i3) {
        ((Uniform) Assertions.checkNotNull(this.uniformByName.get(str))).setSamplerTexId(i2, i3);
    }
    ...
    public void setExternalTexturesRequireNearestSampling(boolean z2) {
        this.externalTexturesRequireNearestSampling = z2;
    }

    public void setFloatUniform(String str, float f3) {
        ((Uniform) Assertions.checkNotNull(this.uniformByName.get(str))).setFloat(f3);
    }
    ...
    public void setSamplerTexIdUniform(String str, int i2, int i3, int i5) {
        Uniform uniform = (Uniform) Assertions.checkNotNull(this.uniformByName.get(str));
        uniform.setSamplerTexId(i2, i3);
        uniform.setTexMinFilter(i5);
    }
    ...
    private static void addShader(int i2, int i3, String str) throws GlUtil.GlException {
        ...
        GlUtil.checkGlException(z2, GLES20.glGetShaderInfoLog(iGlCreateShader) + ", source: \n" + str);
    ...
    public GlProgram(String str, String str2) throws GlUtil.GlException {
        ...
        for (int i3 = 0; i3 < iArr3[0]; i3++) {
            Uniform uniformCreate = Uniform.create(this.programId, i3);
            this.uniforms[i3] = uniformCreate;
