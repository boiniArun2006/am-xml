...
public final class NotificationUtil {
    ...
    public static void createNotificationChannel(Context context, String str, @StringRes int i2, @StringRes int i3, int i5) {
        if (Util.SDK_INT >= 26) {
            ...
            Pl.n();
            NotificationChannel notificationChannelN = androidx.browser.trusted.I28.n(str, context.getString(i2), i5);
            if (i3 != 0) {
                notificationChannelN.setDescription(context.getString(i3));
            }
