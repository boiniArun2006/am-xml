...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        public Bundle toBundle(int i2) {
            ...
            int i3 = this.adGroupIndex;
            if (i3 != -1) {
                bundle.putInt(FIELD_AD_GROUP_INDEX, i3);
            }
        ...
        @UnstableApi
        public PositionInfo filterByAvailableCommands(boolean z2, boolean z3) {
            if (z2 && z3) {
                return this;
            }
            return new PositionInfo(this.windowUid, z3 ? this.mediaItemIndex : 0, z2 ? this.mediaItem : null, this.periodUid, z3 ? this.periodIndex : 0, z2 ? this.positionMs : 0L, z2 ? this.contentPositionMs : 0L, z2 ? this.adGroupIndex : -1, z2 ? this.adIndexInAdGroup : -1);
        }
    ...
    void setDeviceVolume(@IntRange int i2, int i3);
