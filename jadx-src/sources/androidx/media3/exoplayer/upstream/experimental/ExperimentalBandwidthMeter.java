...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder setInitialBitrateEstimate(String str) {
            ...
            for (Integer num : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(num.intValue(), ExperimentalBandwidthMeter.getInitialBitrateEstimatesForCountry(strJ2, num.intValue()));
            }
            return this;
        }
    }
    ...
    private static int[] getInitialBitrateCountryGroupAssignment(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 2091:
                ...
                break;
            case 2092:
                b2 = !str.equals(aNrWBQYwFf.mToRmtv) ? (byte) -1 : (byte) 6;
                break;
            case 2094:
            ...
            case 2149:
                ...
                break;
            case 2150:
                b2 = !str.equals("CI") ? (byte) -1 : (byte) 41;
                break;
            case 2152:
            ...
            case 2165:
                ...
                break;
            case 2166:
                b2 = !str.equals(SzFNXybiSxdx.xKSCvNjgKsRgxf) ? (byte) -1 : (byte) 52;
                break;
            case 2167:
            ...
            case 2187:
                ...
                break;
            case 2198:
                b2 = !str.equals(HFAkacKHsU.CXTX) ? (byte) -1 : (byte) 59;
                break;
            case 2206:
            ...
            case 2627:
                ...
                break;
            case 2629:
                b2 = !str.equals(esLNYym.cvkdwKhLHE) ? (byte) -1 : (byte) 183;
                break;
            case 2638:
            ...
            case 2647:
                ...
                break;
            case 2648:
                b2 = !str.equals("SK") ? (byte) -1 : (byte) 193;
                break;
            case 2649:
    ...
    private ExperimentalBandwidthMeter(Context context, Map<Integer, Long> map, TimeToFirstByteEstimator timeToFirstByteEstimator, BandwidthEstimator bandwidthEstimator, boolean z2) {
        ...
        networkTypeObserver.register(new NetworkTypeObserver.Listener() { // from class: androidx.media3.exoplayer.upstream.experimental.j
            @Override // androidx.media3.common.util.NetworkTypeObserver.Listener
            public final void onNetworkTypeChanged(int i2) {
                this.f39816n.onNetworkTypeChanged(i2);
            }
