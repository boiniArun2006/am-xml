...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public static final /* synthetic */ int f39712n = 0;
        private final SsChunkSource.Factory chunkSourceFactory;
    ...
    private void processManifest() {
        ...
        if (jMax2 == Long.MAX_VALUE) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(j2, 0L, 0L, 0L, true, z2, z2, (Object) ssManifest, getMediaItem());
        } else {
            ...
            if (ssManifest2.isLive) {
                ...
                if (jMsToUs < 5000000) {
                    jMsToUs = Math.min(5000000L, j5 / 2);
                }
                singlePeriodTimeline = new SinglePeriodTimeline(-9223372036854775807L, j5, j4, jMsToUs, true, true, true, (Object) this.manifest, getMediaItem());
            } else {
                ...
                long j7 = j6;
                singlePeriodTimeline = new SinglePeriodTimeline(jMax2 + j7, j7, jMax2, 0L, true, false, false, (Object) this.manifest, getMediaItem());
            }
        }
    ...
    private void scheduleManifestRefresh() {
        if (this.manifest.isLive) {
            this.manifestRefreshHandler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.smoothstreaming.n
                @Override // java.lang.Runnable
                public final void run() {
                    this.f39713n.startLoadingManifest();
                }
    ...
    public void startLoadingManifest() {
        ...
        if (this.cmcdConfiguration != null) {
            CmcdData.Factory objectType = new CmcdData.Factory(this.cmcdConfiguration, CmcdData.STREAMING_FORMAT_SS).setObjectType("m");
            SsManifest ssManifest = this.manifest;
            if (ssManifest != null) {
    ...
    @Override // androidx.media3.exoplayer.upstream.Loader.Callback
    public void onLoadStarted(ParsingLoadable<SsManifest> parsingLoadable, long j2, long j3, int i2) {
    ...
    public boolean canUpdateMediaItem(MediaItem mediaItem) {
        ...
        if (localConfiguration2 != null && localConfiguration2.uri.equals(localConfiguration.uri) && localConfiguration2.streamKeys.equals(localConfiguration.streamKeys) && Objects.equals(localConfiguration2.drmConfiguration, localConfiguration.drmConfiguration)) {
            return true;
        }
        return false;
    }
