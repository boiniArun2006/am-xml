...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
        ...
        */
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (iIntValue == 2) {
                ...
                if (str == null) {
                    i2 = 0;
                    builder.setContainerMimeType("application/mp4").setRoleFlags(i2);
                } else {
                    if (str.equals("CAPT")) {
                        i2 = 64;
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (i3 == 2 || i3 == 1) {
                        ...
                        for (int i5 = 0; i5 < formatArr.length; i5++) {
                            formatArr[i5] = formatArr[i5].buildUpon().setDrmInitData(drmInitData).build();
                        }
                    }
                }
            }
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamFragmentStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            long j2 = parseLong(xmlPullParser, KEY_FRAGMENT_REPEAT_COUNT, 1L);
            if (j2 > 1 && this.lastChunkDuration == -9223372036854775807L) {
