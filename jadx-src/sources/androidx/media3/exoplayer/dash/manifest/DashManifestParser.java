...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    protected static long parseDateTime(XmlPullParser xmlPullParser, String str, long j2) throws ParserException {
    ...
    protected static int parseDolbyAC4ChannelConfiguration(XmlPullParser xmlPullParser, String str) {
        ...
        int i2 = Integer.parseInt(attributeValue, 16);
        return (8388608 & i2) != 0 ? parseDolbyAc4ObjectBasedChannelConfiguration(str) : parseDolbyAc4ChannelBasedChannelConfiguration(i2);
    }

    private static int parseDolbyAc4ChannelBasedChannelConfiguration(int i2) {
        int i3 = 0;
        int i5 = 0;
        while (true) {
    ...
    protected static long parseDuration(XmlPullParser xmlPullParser, String str, long j2) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
    ...
    protected static float parseFloat(XmlPullParser xmlPullParser, String str, float f3) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
        return attributeValue == null ? f3 : Float.parseFloat(attributeValue);
    }

    protected static float parseFrameRate(XmlPullParser xmlPullParser, float f3) {
    ...
    protected static int parseInt(XmlPullParser xmlPullParser, String str, int i2) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
    ...
    protected static long parseLastSegmentNumberSupplementalProperty(List<Descriptor> list) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            if (AbstractC2372w6.n("http://dashif.org/guidelines/last-segment-number", descriptor.schemeIdUri)) {
    ...
    protected static long parseLong(XmlPullParser xmlPullParser, String str, long j2) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
    ...
    protected Format buildFormat(@Nullable String str, @Nullable String str2, int i2, int i3, float f3, int i5, int i7, int i8, @Nullable String str3, List<Descriptor> list, List<Descriptor> list2, @Nullable String str4, @Nullable String str5, @Nullable String str6, List<Descriptor> list3, List<Descriptor> list4) {
        String str7 = str5;
        String str8 = str4;
        ...
        Format.Builder language = new Format.Builder().setId(str).setContainerMimeType(str2).setSampleMimeType(sampleMimeType).setCodecs(str8).setPeakBitrate(i8).setSelectionFlags(selectionFlagsFromRoleDescriptors).setRoleFlags(roleFlagsFromRoleDescriptors).setLanguage(str3);
        ...
        if (MimeTypes.isVideo(sampleMimeType)) {
            tileCountVertical.setWidth(i2).setHeight(i3).setFrameRate(f3);
        } else if (MimeTypes.isAudio(sampleMimeType)) {
            tileCountVertical.setChannelCount(i5).setSampleRate(i7);
        } else if (MimeTypes.isText(sampleMimeType)) {
            if ("application/cea-608".equals(sampleMimeType)) {
                cea708AccessibilityChannel = parseCea608AccessibilityChannel(list2);
            } else if (wDgKoYAES.trKrJUanFy.equals(sampleMimeType)) {
    ...
    protected long parseAvailabilityTimeOffsetUs(XmlPullParser xmlPullParser, long j2) {
    ...
    */
    protected Pair<String, DrmInitData.SchemeData> parseContentProtection(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        String str2 = qwlyMfUJj.PvNtSE;
        if (attributeValue2 != null) {
            String strO = AbstractC2372w6.O(attributeValue2);
            strO.getClass();
            switch (strO) {
                ...
                case "urn:mpeg:dash:mp4protection:2011":
                    ...
                    if (!TextUtils.isEmpty(attributeValueIgnorePrefix) && !Id.Predefined.External.AAID.LIMIT_AD_TRACKING_VALUE.equals(attributeValueIgnorePrefix)) {
                        ...
                        Log.w(str2, "Ignoring <ContentProtection> with schemeIdUri=\"urn:mpeg:dash:mp4protection:2011\" (ClearKey) due to missing required default_KID attribute.");
                        uuid = null;
                        str = null;
                        text = str;
                        BuildPsshAtom = str;
        ...
        do {
            ...
            if ((XmlPullParserUtil.isStartTag(xmlPullParser, "clearkey:Laurl") || XmlPullParserUtil.isStartTag(xmlPullParser, "dashif:Laurl")) && xmlPullParser.next() == 4) {
                ...
                if (uuid2 == null) {
                    Log.w(str2, "Skipping malformed cenc:pssh data");
                    uuid = uuid2;
                    BuildPsshAtom = 0;
                    text = text;
                } else {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected RepresentationInfo parseRepresentation(XmlPullParser xmlPullParser, List<BaseUrl> list, @Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, int i2, int i3, float f3, int i5, int i7, @Nullable String str5, List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4, List<Descriptor> list5, @Nullable SegmentBase segmentBase, long j2, long j3, long j4, long j5, long j6, boolean z2) throws XmlPullParserException, IOException {
        String str6;
        ArrayList arrayList;
        int i8;
        ...
        int i10 = parseInt(xmlPullParser3, "bandwidth", -1);
        ...
        int i11 = parseInt(xmlPullParser3, "width", i2);
        int i12 = parseInt(xmlPullParser3, "height", i3);
        float frameRate = parseFrameRate(xmlPullParser3, f3);
        int i13 = parseInt(xmlPullParser3, "audioSamplingRate", i7);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser3, "BaseURL")) {
                ...
                str6 = attributeValue;
                arrayList12.addAll(dashManifestParser.parseBaseUrl(xmlPullParser3, list, z2));
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser3, "AudioChannelConfiguration")) {
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentList")) {
                        ...
                        long availabilityTimeOffsetUs2 = dashManifestParser.parseAvailabilityTimeOffsetUs(xmlPullParser3, j10);
                        arrayList = arrayList13;
                        arrayList5 = arrayList12;
                        i8 = i10;
                        arrayList2 = arrayList9;
                        SegmentBase.SegmentList segmentList = dashManifestParser.parseSegmentList(xmlPullParser3, (SegmentBase.SegmentList) segmentBase4, j2, j3, j11, availabilityTimeOffsetUs2, j6);
                        xmlPullParser2 = xmlPullParser3;
                        str7 = string2;
                        str8 = str9;
                        z3 = z4;
                        ...
                        long j12 = availabilityTimeOffsetUs;
                        i8 = i10;
                        arrayList2 = arrayList9;
                        if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentTemplate")) {
                            long availabilityTimeOffsetUs3 = dashManifestParser.parseAvailabilityTimeOffsetUs(xmlPullParser3, j10);
                            str7 = string2;
                            SegmentBase.SegmentTemplate segmentTemplate = dashManifestParser.parseSegmentTemplate(xmlPullParser3, (SegmentBase.SegmentTemplate) segmentBase4, list5, j2, j3, j12, availabilityTimeOffsetUs3, j6);
                            xmlPullParser2 = xmlPullParser3;
                            str8 = str9;
                            z3 = z4;
        ...
        Format formatBuildFormat = buildFormat(str6, string, i11, i12, frameRate, i9, i13, i8, str5, list2, list3, str7, str12, str11, arrayList21, arrayList20);
    ...
    protected int parseRoleFlagsFromAccessibilityDescriptors(List<Descriptor> list) {
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            if (AbstractC2372w6.n("urn:mpeg:dash:role:2011", descriptor.schemeIdUri)) {
                tvaAudioPurposeCsValue = parseRoleFlagsFromDashRoleScheme(descriptor.value);
            } else if (AbstractC2372w6.n("urn:tva:metadata:cs:AudioPurposeCS:2007", descriptor.schemeIdUri)) {
    ...
    protected int parseRoleFlagsFromProperties(List<Descriptor> list) {
        int i2 = 0;
        for (int i3 = 0; i3 < list.size(); i3++) {
            if (AbstractC2372w6.n("http://dashif.org/guidelines/trickmode", list.get(i3).schemeIdUri)) {
                i2 = 16384;
            }
        }
        return i2;
    ...
    protected Pair<Integer, Integer> parseTileCountFromProperties(List<Descriptor> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            Descriptor descriptor = list.get(i2);
            if ((AbstractC2372w6.n("http://dashif.org/thumbnail_tile", descriptor.schemeIdUri) || AbstractC2372w6.n("http://dashif.org/guidelines/thumbnail_tile", descriptor.schemeIdUri)) && (str = descriptor.value) != null) {
    ...
    protected AdaptationSet buildAdaptationSet(long j2, int i2, List<Representation> list, List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4) {
        return new AdaptationSet(j2, i2, list, list2, list3, list4);
    }

    protected EventMessage buildEvent(String str, String str2, long j2, long j3, byte[] bArr) {
        return new EventMessage(str, str2, j3, j2, bArr);
    }

    protected EventStream buildEventStream(String str, String str2, long j2, long[] jArr, EventMessage[] eventMessageArr) {
        return new EventStream(str, str2, j2, jArr, eventMessageArr);
    }

    protected DashManifest buildMediaPresentationDescription(long j2, long j3, long j4, boolean z2, long j5, long j6, long j7, long j9, @Nullable ProgramInformation programInformation, @Nullable UtcTimingElement utcTimingElement, @Nullable ServiceDescriptionElement serviceDescriptionElement, @Nullable Uri uri, List<Period> list) {
        return new DashManifest(j2, j3, j4, z2, j5, j6, j7, j9, programInformation, utcTimingElement, serviceDescriptionElement, uri, list);
    }

    protected Period buildPeriod(@Nullable String str, long j2, List<AdaptationSet> list, List<EventStream> list2, @Nullable Descriptor descriptor) {
        return new Period(str, j2, list, list2, descriptor);
    }

    protected RangedUri buildRangedUri(String str, long j2, long j3) {
    ...
    protected SegmentBase.SegmentList buildSegmentList(RangedUri rangedUri, long j2, long j3, long j4, long j5, @Nullable List<SegmentBase.SegmentTimelineElement> list, long j6, @Nullable List<RangedUri> list2, long j7, long j9) {
        return new SegmentBase.SegmentList(rangedUri, j2, j3, j4, j5, list, j6, list2, Util.msToUs(j7), Util.msToUs(j9));
    }

    protected SegmentBase.SegmentTemplate buildSegmentTemplate(RangedUri rangedUri, long j2, long j3, long j4, long j5, long j6, List<SegmentBase.SegmentTimelineElement> list, long j7, @Nullable UrlTemplate urlTemplate, @Nullable UrlTemplate urlTemplate2, long j9, long j10) {
        return new SegmentBase.SegmentTemplate(rangedUri, j2, j3, j4, j5, j6, list, j7, urlTemplate, urlTemplate2, Util.msToUs(j9), Util.msToUs(j10));
    }

    protected SegmentBase.SegmentTimelineElement buildSegmentTimelineElement(long j2, long j3) {
        return new SegmentBase.SegmentTimelineElement(j2, j3);
    }

    protected SegmentBase.SingleSegmentBase buildSingleSegmentBase(RangedUri rangedUri, long j2, long j3, long j4, long j5) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x03bb A[LOOP:0: B:3:0x00a2->B:75:0x03bb, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:76:0x036b A[EDGE_INSN: B:76:0x036b->B:69:0x036b BREAK  A[LOOP:0: B:3:0x00a2->B:75:0x03bb], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected AdaptationSet parseAdaptationSet(XmlPullParser xmlPullParser, List<BaseUrl> list, @Nullable SegmentBase segmentBase, long j2, long j3, long j4, long j5, long j6, boolean z2) throws XmlPullParserException, IOException {
        Object obj;
        ...
        long j12 = parseLong(xmlPullParser2, "id", -1L);
        ...
        int i8 = parseInt(xmlPullParser2, "width", -1);
        int i9 = parseInt(xmlPullParser2, "height", -1);
        float frameRate = parseFrameRate(xmlPullParser2, -1.0f);
        int i10 = parseInt(xmlPullParser2, "audioSamplingRate", -1);
        String str7 = "lang";
        ...
        ArrayList<Descriptor> arrayList15 = new ArrayList<>();
        ArrayList arrayList16 = arrayList13;
        ArrayList arrayList17 = new ArrayList();
        ArrayList arrayList18 = new ArrayList();
        ArrayList arrayList19 = new ArrayList();
        ArrayList<Descriptor> arrayList20 = arrayList15;
        ...
        String str11 = null;
        SegmentBase segmentBase2 = segmentBase;
        String str12 = attributeValue3;
        long availabilityTimeOffsetUs = j3;
        while (true) {
            xmlPullParser2.next();
            int i13 = audioChannelConfiguration;
            if (XmlPullParserUtil.isStartTag(xmlPullParser2, "BaseURL")) {
                ...
                arrayList23.addAll(dashManifestParser.parseBaseUrl(xmlPullParser2, list, z2));
                ArrayList arrayList24 = arrayList16;
                arrayList6 = arrayList19;
                arrayList11 = arrayList24;
                audioChannelConfiguration = i13;
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser2, "ContentProtection")) {
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser2, "ContentComponent")) {
                        obj = null;
                        String strCheckLanguageConsistency = checkLanguageConsistency(str10, xmlPullParser2.getAttributeValue(null, str7));
                        ...
                        audioChannelConfiguration = i13;
                        arrayList = arrayList14;
                        str10 = strCheckLanguageConsistency;
                    } else {
                        obj = null;
                        if (XmlPullParserUtil.isStartTag(xmlPullParser2, "Role")) {
                            ...
                            arrayList21.add(parseDescriptor(xmlPullParser2, "SupplementalProperty"));
                        } else {
                            if (XmlPullParserUtil.isStartTag(xmlPullParser2, "Representation")) {
                                ...
                                DashManifestParser dashManifestParser2 = dashManifestParser;
                                int i14 = iCheckContentTypeConsistency2;
                                int i15 = i11;
                                ...
                                String str13 = str10;
                                float f4 = f3;
                                RepresentationInfo representation = dashManifestParser2.parseRepresentation(xmlPullParser3, list2, str5, attributeValue2, str6, str4, i15, i7, f4, audioChannelConfiguration, i10, str13, arrayList18, arrayList17, arrayList12, arrayList31, segmentBase3, j11, j10, j14, j13, j6, z3);
                                str8 = str5;
                                str12 = str6;
                                str9 = str4;
                                i12 = i7;
                                ...
                                i2 = i10;
                                i11 = i15;
                                iCheckContentTypeConsistency = checkContentTypeConsistency(i14, MimeTypes.getTrackType(representation.format.sampleMimeType));
                                arrayList30.add(representation);
                                xmlPullParser2 = xmlPullParser3;
                                availabilityTimeOffsetUs = j14;
                                ...
                                DashManifestParser dashManifestParser3 = dashManifestParser;
                                ...
                                if (XmlPullParserUtil.isStartTag(xmlPullParser4, "SegmentBase")) {
                                    ...
                                    str10 = str2;
                                    audioChannelConfiguration = i3;
                                } else if (XmlPullParserUtil.isStartTag(xmlPullParser4, "SegmentList")) {
                                    long availabilityTimeOffsetUs2 = dashManifestParser3.parseAvailabilityTimeOffsetUs(xmlPullParser4, j9);
                                    arrayList8 = arrayList33;
                                    xmlPullParser2 = xmlPullParser;
                                    segmentTemplate = dashManifestParser3.parseSegmentList(xmlPullParser2, (SegmentBase.SegmentList) segmentTemplate, j5, j2, j7, availabilityTimeOffsetUs2, j6);
                                    availabilityTimeOffsetUs = j7;
                                    arrayList9 = arrayList32;
                                    audioChannelConfiguration = i3;
                                    ...
                                    if (XmlPullParserUtil.isStartTag(xmlPullParser2, "SegmentTemplate")) {
                                        long availabilityTimeOffsetUs3 = dashManifestParser3.parseAvailabilityTimeOffsetUs(xmlPullParser2, j9);
                                        arrayList9 = arrayList32;
                                        segmentTemplate = dashManifestParser3.parseSegmentTemplate(xmlPullParser2, (SegmentBase.SegmentTemplate) segmentTemplate, arrayList9, j5, j2, j7, availabilityTimeOffsetUs3, j6);
                                        availabilityTimeOffsetUs = j7;
                                        iCheckContentTypeConsistency2 = i5;
                                        arrayList11 = arrayList3;
                                        arrayList10 = arrayList4;
                        ...
                        str3 = attributeValue2;
                        j9 = j13;
                        i5 = iCheckContentTypeConsistency2;
                        j7 = j14;
                        str = str7;
                        arrayList9 = arrayList21;
                        arrayList10 = arrayList20;
        ...
        while (i16 < arrayList8.size()) {
            ArrayList<Descriptor> arrayList37 = arrayList10;
            ArrayList arrayList38 = arrayList11;
            String str14 = attributeValue6;
            arrayList36.add(buildRepresentation((RepresentationInfo) arrayList8.get(i16), str14, arrayList38, str11, arrayList, arrayList37));
            i16++;
            attributeValue6 = str14;
            arrayList10 = arrayList37;
            arrayList11 = arrayList38;
        }
        return buildAdaptationSet(j12, iCheckContentTypeConsistency2, arrayList36, arrayList2, arrayList6, arrayList9);
    }
    ...
    protected List<BaseUrl> parseBaseUrl(XmlPullParser xmlPullParser, List<BaseUrl> list, boolean z2) throws XmlPullParserException, IOException {
        ...
        if (UriUtil.isAbsolute(text)) {
            ...
            return rv6.mUb(new BaseUrl(text, attributeValue3, i2, i3));
        }
    ...
    protected Pair<Long, EventMessage> parseEvent(XmlPullParser xmlPullParser, String str, String str2, long j2, long j3, ByteArrayOutputStream byteArrayOutputStream) throws XmlPullParserException, IOException {
        long j4 = parseLong(xmlPullParser, "id", 0L);
        long j5 = parseLong(xmlPullParser, "duration", -9223372036854775807L);
        long j6 = parseLong(xmlPullParser, "presentationTime", 0L);
        long jScaleLargeTimestamp = Util.scaleLargeTimestamp(j5, 1000L, j2);
        long jScaleLargeTimestamp2 = Util.scaleLargeTimestamp(j6 - j3, 1000000L, j2);
        ...
        return Pair.create(lValueOf, buildEvent(str, str2, j4, jScaleLargeTimestamp, eventObject));
    }
    ...
    protected EventStream parseEventStream(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        long j3 = parseLong(xmlPullParser, "timescale", 1L);
        long j4 = parseLong(xmlPullParser, "presentationTimeOffset", 0L);
        ArrayList arrayList = new ArrayList();
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Event")) {
                ...
                str2 = string;
                xmlPullParser2 = xmlPullParser;
                arrayList.add(parseEvent(xmlPullParser2, str2, str, j2, j4, byteArrayOutputStream));
            } else {
                j2 = j3;
                str = string2;
                str2 = string;
        ...
        return buildEventStream(str2, str, j2, jArr, eventMessageArr);
    }
    ...
    */
    protected DashManifest parseMediaPresentationDescription(XmlPullParser xmlPullParser, Uri uri) throws XmlPullParserException, IOException {
        ...
        long j5 = zEquals ? 0L : -9223372036854775807L;
        ArrayList arrayListMUb = rv6.mUb(new BaseUrl(uri.toString(), uri.toString(), zIsDvbProfileDeclared ? 1 : Integer.MIN_VALUE, 1));
        ArrayList arrayList7 = new ArrayList();
        ArrayList arrayList8 = new ArrayList();
        long j6 = zEquals ? -9223372036854775807L : 0L;
        ArrayList arrayList9 = arrayListMUb;
        long availabilityTimeOffsetUs = j5;
        boolean z2 = false;
        boolean z3 = false;
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "BaseURL")) {
                ...
                arrayList8.addAll(dashManifestParser.parseBaseUrl(xmlPullParser, arrayList, zIsDvbProfileDeclared));
            } else {
                arrayList = arrayList9;
                arrayList2 = arrayList7;
                if (XmlPullParserUtil.isStartTag(xmlPullParser, "ProgramInformation")) {
                    ...
                    if (!XmlPullParserUtil.isStartTag(xmlPullParser, "Period") || z2) {
                        ...
                        Pair<Period, Long> period = parsePeriod(xmlPullParser, arrayList5, j2, j3, dateTime, duration4, zIsDvbProfileDeclared);
                        ...
                        if (period2.startMs != -9223372036854775807L) {
                            ...
                            long j7 = jLongValue == -9223372036854775807L ? -9223372036854775807L : period2.startMs + jLongValue;
                            arrayList4 = arrayList10;
                            arrayList4.add(period2);
                            j2 = j7;
                        } else {
                            if (!zEquals) {
                                throw ParserException.createForMalformedManifest("Unable to determine start of period " + arrayList10.size(), null);
                            }
                            arrayList4 = arrayList10;
                            z2 = true;
                        }
                    }
                    availabilityTimeOffsetUs = j3;
                    j6 = j2;
                    if (!XmlPullParserUtil.isEndTag(xmlPullParser, "MPD")) {
                        ...
                        return buildMediaPresentationDescription(dateTime, j4, duration2, zEquals, duration3, duration4, duration5, dateTime2, programInformation, utcTiming, serviceDescription, uriResolveToUri, arrayList4);
                    }
                    dashManifestParser = this;
                    duration3 = duration3;
                    duration4 = duration4;
    ...
    /* JADX WARN: Removed duplicated region for block: B:44:0x01a3 A[LOOP:0: B:7:0x0043->B:44:0x01a3, LOOP_END] */
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 4421. Try increasing type updates limit count.
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected Pair<Period, Long> parsePeriod(XmlPullParser xmlPullParser, List<BaseUrl> list, long j2, long j3, long j4, long j5, boolean z2) throws XmlPullParserException, IOException {
        ArrayList arrayList;
        ArrayList arrayList2;
        long j6;
        long j7;
        ...
        XmlPullParser xmlPullParser3 = xmlPullParser;
        String attributeValue = xmlPullParser3.getAttributeValue(null, "id");
        long duration = parseDuration(xmlPullParser3, TtmlNode.START, j2);
        long j15 = j4 != -9223372036854775807L ? j4 + duration : -9223372036854775807L;
        ...
        while (true) {
            xmlPullParser3.next();
            if (XmlPullParserUtil.isStartTag(xmlPullParser3, znsSxz.qJeHomZx)) {
                if (!z3) {
                    availabilityTimeOffsetUs = dashManifestParser.parseAvailabilityTimeOffsetUs(xmlPullParser3, availabilityTimeOffsetUs);
                    z3 = true;
                }
                ...
                if (XmlPullParserUtil.isStartTag(xmlPullParser3, "AdaptationSet")) {
                    ...
                    long j17 = availabilityTimeOffsetUs;
                    long j18 = j15;
                    long j19 = duration2;
                    AdaptationSet adaptationSet = dashManifestParser.parseAdaptationSet(xmlPullParser3, list2, segmentTemplate, j19, j17, j16, j18, j5, z2);
                    duration2 = j19;
                    j15 = j18;
                    j6 = j16;
                    j7 = j17;
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser3, "EventStream")) {
                        ...
                        if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentBase")) {
                            ...
                            j9 = -9223372036854775807L;
                            segmentBase2 = dashManifestParser.parseSegmentBase(xmlPullParser3, null);
                            ...
                            arrayList3 = arrayList;
                            j9 = -9223372036854775807L;
                            SegmentBase.SegmentList segmentList = dashManifestParser.parseSegmentList(xmlPullParser3, null, j20, j21, j7, availabilityTimeOffsetUs2, j5);
                            duration2 = j21;
                            j15 = j20;
                            j13 = j7;
                            j14 = availabilityTimeOffsetUs2;
                            obj = null;
                            ...
                            if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentTemplate")) {
                                ...
                                obj = null;
                                segmentTemplate = dashManifestParser.parseSegmentTemplate(xmlPullParser3, null, nKK.r(), j15, duration2, j7, availabilityTimeOffsetUs3, j5);
                                j10 = duration2;
                                xmlPullParser2 = xmlPullParser3;
                                j12 = j15;
                                j13 = j7;
                                j14 = availabilityTimeOffsetUs3;
                                descriptor = descriptor2;
                                ...
                                if (!XmlPullParserUtil.isEndTag(xmlPullParser2, "Period")) {
                                    return Pair.create(buildPeriod(attributeValue, duration, arrayList3, arrayList2, descriptor), Long.valueOf(j10));
                                }
                                dashManifestParser = this;
    ...
    protected SegmentBase.SingleSegmentBase parseSegmentBase(XmlPullParser xmlPullParser, @Nullable SegmentBase.SingleSegmentBase singleSegmentBase) throws XmlPullParserException, IOException {
        ...
        long j5 = singleSegmentBase != null ? singleSegmentBase.indexLength : 0L;
        String attributeValue = xmlPullParser.getAttributeValue(null, "indexRange");
        if (attributeValue != null) {
            String[] strArrSplit = attributeValue.split("-");
            j4 = Long.parseLong(strArrSplit[0]);
            j5 = (Long.parseLong(strArrSplit[1]) - j4) + 1;
        }
        long j6 = j5;
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isEndTag(xmlPullParser, "SegmentBase")) {
                return buildSingleSegmentBase(rangedUri, j2, j3, j4, j6);
            }
            initialization = rangedUri;
        }
    }

    protected SegmentBase.SegmentList parseSegmentList(XmlPullParser xmlPullParser, @Nullable SegmentBase.SegmentList segmentList, long j2, long j3, long j4, long j5, long j6) throws XmlPullParserException, IOException {
        long j7;
        long j9 = parseLong(xmlPullParser, "timescale", segmentList != null ? segmentList.timescale : 1L);
        long j10 = parseLong(xmlPullParser, "presentationTimeOffset", segmentList != null ? segmentList.presentationTimeOffset : 0L);
        long j11 = parseLong(xmlPullParser, "duration", segmentList != null ? segmentList.duration : -9223372036854775807L);
        long j12 = parseLong(xmlPullParser, "startNumber", segmentList != null ? segmentList.startNumber : 1L);
        ...
        return buildSegmentList(initialization, j7, j10, j12, j11, segmentTimeline, finalAvailabilityTimeOffset, arrayList, j6, j2);
    }

    protected SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xmlPullParser, @Nullable SegmentBase.SegmentTemplate segmentTemplate, List<Descriptor> list, long j2, long j3, long j4, long j5, long j6) throws XmlPullParserException, IOException {
        long j7;
        DashManifestParser dashManifestParser = this;
        long j9 = parseLong(xmlPullParser, "timescale", segmentTemplate != null ? segmentTemplate.timescale : 1L);
        long j10 = parseLong(xmlPullParser, "presentationTimeOffset", segmentTemplate != null ? segmentTemplate.presentationTimeOffset : 0L);
        long j11 = parseLong(xmlPullParser, "duration", segmentTemplate != null ? segmentTemplate.duration : -9223372036854775807L);
        long j12 = parseLong(xmlPullParser, "startNumber", segmentTemplate != null ? segmentTemplate.startNumber : 1L);
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Initialization")) {
                ...
                j7 = j9;
                segmentTimeline = dashManifestParser.parseSegmentTimeline(xmlPullParser, j7, j3);
            } else {
                j7 = j9;
                maybeSkipTag(xmlPullParser);
            }
        ...
        return buildSegmentTemplate(initialization, j7, j10, j12, lastSegmentNumberSupplementalProperty, j11, segmentTimeline, finalAvailabilityTimeOffset, urlTemplate2, urlTemplate, j6, j2);
    }

    protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j2, long j3) throws XmlPullParserException, IOException {
        ArrayList arrayList = new ArrayList();
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "S")) {
                long j5 = parseLong(xmlPullParser, "t", -9223372036854775807L);
                if (z2) {
                    ArrayList arrayList2 = arrayList;
                    jAddSegmentTimelineElementsToList = addSegmentTimelineElementsToList(arrayList2, jAddSegmentTimelineElementsToList, j4, i2, j5);
                    arrayList = arrayList2;
                }
    ...
    protected ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                j2 = parseLong(xmlPullParser, "target", -9223372036854775807L);
                j3 = parseLong(xmlPullParser, "min", -9223372036854775807L);
                j4 = parseLong(xmlPullParser, "max", -9223372036854775807L);
            } else if (XmlPullParserUtil.isStartTag(xmlPullParser, "PlaybackRate")) {
                f3 = parseFloat(xmlPullParser, "min", -3.4028235E38f);
                f4 = parseFloat(xmlPullParser, "max", -3.4028235E38f);
            }
            long j5 = j2;
            long j6 = j3;
            long j7 = j4;
            ...
            if (XmlPullParserUtil.isEndTag(xmlPullParser, "ServiceDescription")) {
                return new ServiceDescriptionElement(j5, j6, j7, f5, f6);
            }
            j2 = j5;
            j3 = j6;
            j4 = j7;
    ...
    private static int parseDolbyAc4ObjectBasedChannelConfiguration(String str) {
        ...
        List listJ2 = l3D.nr('.').J2(AbstractC2372w6.O(strArrSplitCodecs[0].trim()));
        if (listJ2.size() != 4 || !((String) listJ2.get(0)).equals("ac-4")) {
            return -1;
        }
        String str2 = (String) listJ2.get(3);
        str2.getClass();
        if (!str2.equals("03")) {
            if (!str2.equals("04")) {
                return -1;
