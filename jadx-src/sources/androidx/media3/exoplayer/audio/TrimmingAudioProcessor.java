...
final class TrimmingAudioProcessor extends androidx.media3.common.audio.BaseAudioProcessor {
    ...
    public long getDurationAfterProcessorApplied(long j2) {
        return j2 - Util.sampleCountToDurationUs(this.trimEndFrames + this.trimStartFrames, this.inputAudioFormat.sampleRate);
    }
    ...
    public void queueInput(ByteBuffer byteBuffer) {
        ...
        if (i2 != 0) {
            ...
            int i7 = this.endBufferSize - iConstrainValue;
