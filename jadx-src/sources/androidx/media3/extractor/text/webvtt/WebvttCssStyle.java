...
public final class WebvttCssStyle {
    ...
    private static final int f39906ON = 1;
    ...
    public WebvttCssStyle setFontFamily(@Nullable String str) {
        this.fontFamily = str == null ? null : AbstractC2372w6.O(str);
        return this;
    }
    ...
    public WebvttCssStyle() {
        String str = jhotmBbwMbr.RQGbsIMA;
        this.targetId = str;
        this.targetTag = str;
        this.targetClasses = Collections.EMPTY_SET;
        this.targetVoice = str;
