...
public final class WebvttCueParser {
    ...
    private static final Pattern CUE_SETTING_PATTERN = Pattern.compile(gUxOLwRQBPPLC.aKkJOL);
    ...
    static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = new Comparator() { // from class: androidx.media3.extractor.text.webvtt.j
    ...
    private static final class WebvttCueInfoBuilder {
        ...
        private static float computeLine(float f3, int i2) {
        ...
        private static float deriveMaxSize(int i2, float f3) {
            if (i2 == 0) {
                return 1.0f - f3;
            }
            if (i2 == 1) {
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.w(TAG, pTYaLzzmJSGAPQ.HhsucGPfZV + str);
                return 2;
        }
    }
    ...
    static {
        ...
        map2.put(qwlyMfUJj.HwivM, Integer.valueOf(Color.rgb(255, 0, 255)));
    ...
    private static void applyVoiceSpan(SpannableStringBuilder spannableStringBuilder, String str, int i2, int i3) {
        spannableStringBuilder.setSpan(new VoiceSpan(str), i2, i3, 33);
    }
    ...
    private static void applyRubySpans(SpannableStringBuilder spannableStringBuilder, @Nullable String str, StartTag startTag, List<Element> list, List<WebvttCssStyle> list2) {
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            if (TAG_RUBY_TEXT.equals(((Element) arrayList.get(i3)).startTag.name)) {
                ...
                int i5 = element.startTag.position - length;
                int i7 = element.endPosition - length;
