...
final class TtmlNode {
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i2, int i3, int i5) {
        ...
        if (ttmlStyleResolveStyle != null) {
            TtmlRenderUtil.applyStylesToSpan(spannableStringBuilder2, i2, i3, ttmlStyleResolveStyle, this.parent, map, i5);
    ...
    public static TtmlNode buildNode(@Nullable String str, long j2, long j3, @Nullable TtmlStyle ttmlStyle, @Nullable String[] strArr, String str2, @Nullable String str3, @Nullable TtmlNode ttmlNode) {
        return new TtmlNode(str, null, j2, j3, ttmlStyle, strArr, str2, str3, ttmlNode);
    }
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z2) {
        ...
        if (z2 || zEquals || (zEquals2 && this.imageId != null)) {
        ...
        for (int i2 = 0; i2 < this.children.size(); i2++) {
            this.children.get(i2).getEventTimes(treeSet, z2 || zEquals);
        }
    }
    ...
    public boolean isActive(long j2) {
        ...
        if (j3 != -9223372036854775807L || j2 >= this.endTimeUs) {
            return j3 <= j2 && j2 < this.endTimeUs;
        }
        return true;
    }
        ...
        if (isActive(j2)) {
            ...
            while (true) {
                ...
                if (this.nodeStartsByRegion.containsKey(key)) {
                    iIntValue = this.nodeStartsByRegion.get(key).intValue();
                }
