...
public class MatroskaExtractor implements Extractor {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.n
        @Override // androidx.media3.extractor.ExtractorsFactory
        public final Extractor[] createExtractors() {
            return MatroskaExtractor.rl();
        }
    };
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                if (littleEndianUnsignedInt == 859189832) {
                    return new Pair<>(qfEYuUHwj.MmaPRbCfHSwQ, null);
                }
        ...
        public void initializeOutput(ExtractorOutput extractorOutput, int i2) throws ParserException {
            ...
            switch (str5) {
                ...
                case "V_MPEG4/ISO/ASP":
                    ...
                    str4 = str;
                    int i10 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    ...
                    if (!MimeTypes.isAudio(str4)) {
                        ...
                        float f3 = (this.displayWidth == iIntValue || (i9 = this.displayHeight) == iIntValue) ? -1.0f : (this.height * r7) / (this.width * i9);
                        ...
                        if (this.projectionType == 0 && Float.compare(this.projectionPoseYaw, 0.0f) == 0 && Float.compare(this.projectionPosePitch, 0.0f) == 0) {
                            ...
                            builder.setWidth(this.width).setHeight(this.height).setPixelWidthHeightRatio(f3).setRotationDegrees(i3).setProjectionData(this.projectionData).setStereoMode(this.stereoMode).setColorInfo(colorInfoBuild);
                            i8 = 2;
                        } else {
                            i3 = iIntValue;
                            builder.setWidth(this.width).setHeight(this.height).setPixelWidthHeightRatio(f3).setRotationDegrees(i3).setProjectionData(this.projectionData).setStereoMode(this.stereoMode).setColorInfo(colorInfoBuild);
                    ...
                    Format formatBuild = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack = extractorOutput.track(this.number, i8);
                ...
                case "A_MS/ACM":
                    ...
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        if (pcmEncoding != 0) {
                            ...
                            str4 = str;
                            int i102 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                            builder = new Format.Builder();
                            if (!MimeTypes.isAudio(str4)) {
                            }
                            if (this.name != null) {
                            ...
                            Format formatBuild2 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                            TrackOutput trackOutputTrack2 = extractorOutput.track(this.number, i8);
                    ...
                    str4 = str;
                    int i1022 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22 = extractorOutput.track(this.number, i8);
                ...
                case "A_TRUEHD":
                    ...
                    str4 = str;
                    int i10222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222 = extractorOutput.track(this.number, i8);
                ...
                case "A_VORBIS":
                    ...
                    str4 = str;
                    int i102222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222 = extractorOutput.track(this.number, i8);
                ...
                case "A_MPEG/L2":
                    ...
                    str4 = str;
                    int i1022222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222 = extractorOutput.track(this.number, i8);
                ...
                case "A_MPEG/L3":
                    ...
                    str4 = str;
                    int i10222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_MS/VFW/FOURCC":
                    ...
                    str4 = str;
                    int i102222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_DVBSUB":
                    ...
                    str4 = str;
                    int i1022222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_MPEG4/ISO/AVC":
                    ...
                    str4 = str;
                    int i10222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_VOBSUB":
                    ...
                    str4 = str;
                    int i102222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_DTS/LOSSLESS":
                    ...
                    str4 = str;
                    int i1022222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_AAC":
                    ...
                    str4 = str;
                    int i10222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_AC3":
                    ...
                    str4 = str;
                    int i102222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_DTS/EXPRESS":
                    ...
                    str4 = str;
                    int i1022222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_AV1":
                    ...
                    listSingletonList = bArr3 == null ? null : nKK.o(bArr3);
                    str = "video/av01";
                    str2 = null;
                    i3 = 0;
                    i7 = -1;
                    ...
                    str4 = str;
                    int i10222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_VP8":
                    ...
                    str4 = str;
                    int i102222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_VP9":
                    ...
                    listSingletonList = bArr4 == null ? null : nKK.o(bArr4);
                    ...
                    str4 = str;
                    int i1022222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_HDMV/PGS":
                    ...
                    str4 = str;
                    int i10222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_THEORA":
                    ...
                    str4 = str;
                    int i102222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_PCM/FLOAT/IEEE":
                    if (this.audioBitDepth == 32) {
                        ...
                        str4 = str;
                        int i1022222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str4)) {
                        }
                        if (this.name != null) {
                        }
                        Format formatBuild22222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                        TrackOutput trackOutputTrack22222222222222222222 = extractorOutput.track(this.number, i8);
                    ...
                    str4 = str;
                    int i10222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_PCM/INT/BIG":
                    ...
                    if (i13 == 8) {
                        ...
                        i5 = C.ENCODING_PCM_24BIT_BIG_ENDIAN;
                    } else {
                        if (i13 != 32) {
                            ...
                            str4 = str;
                            int i102222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                            builder = new Format.Builder();
                            if (!MimeTypes.isAudio(str4)) {
                            }
                            if (this.name != null) {
                            }
                            Format formatBuild2222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                            TrackOutput trackOutputTrack2222222222222222222222 = extractorOutput.track(this.number, i8);
                        ...
                        i5 = C.ENCODING_PCM_32BIT_BIG_ENDIAN;
                    }
                    listSingletonList = null;
                    str2 = null;
                    i3 = 0;
                    ...
                    str4 = str;
                    int i1022222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_PCM/INT/LIT":
                    ...
                    if (pcmEncoding2 != 0) {
                        ...
                        str4 = str;
                        int i10222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                        builder = new Format.Builder();
                        if (!MimeTypes.isAudio(str4)) {
                        }
                        if (this.name != null) {
                        }
                        Format formatBuild222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                        TrackOutput trackOutputTrack222222222222222222222222 = extractorOutput.track(this.number, i8);
                    ...
                    str4 = str;
                    int i102222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_TEXT/ASS":
                    ...
                    str4 = str;
                    int i1022222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_MPEGH/ISO/HEVC":
                    ...
                    str4 = str;
                    int i10222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_TEXT/WEBVTT":
                    ...
                    str4 = str;
                    int i102222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "S_TEXT/UTF8":
                    ...
                    str4 = str;
                    int i1022222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "V_MPEG2":
                    ...
                    str4 = str;
                    int i10222222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_EAC3":
                    ...
                    str4 = str;
                    int i102222222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild2222222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i102222222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack2222222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_FLAC":
                    ...
                    str4 = str;
                    int i1022222222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild22222222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i1022222222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack22222222222222222222222222222222 = extractorOutput.track(this.number, i8);
                ...
                case "A_OPUS":
                    ...
                    str4 = str;
                    int i10222222222222222222222222222222222 = (!this.flagForced ? 2 : i3) | (this.flagDefault ? 1 : 0);
                    builder = new Format.Builder();
                    if (!MimeTypes.isAudio(str4)) {
                    }
                    if (this.name != null) {
                    }
                    Format formatBuild222222222222222222222222222222222 = builder.setId(i2).setContainerMimeType(!this.isWebm ? "video/webm" : "video/x-matroska").setSampleMimeType(str4).setMaxInputSize(i7).setLanguage(this.language).setSelectionFlags(i10222222222222222222222222222222222).setInitializationData(listSingletonList).setCodecs(str2).setDrmInitData(this.drmInitData).build();
                    TrackOutput trackOutputTrack222222222222222222222222222222222 = extractorOutput.track(this.number, i8);
    ...
    private SeekMap buildSeekMap(@Nullable LongArray longArray, @Nullable LongArray longArray2) {
        ...
        int i8 = i2;
        while (i8 > 0 && jArrCopyOf3[i8] > this.durationUs) {
            i8--;
        }
        iArrCopyOf[i8] = (int) ((this.segmentContentPosition + this.segmentContentSize) - jArrCopyOf[i8]);
        jArrCopyOf2[i8] = this.durationUs - jArrCopyOf3[i8];
        if (i8 < i2) {
    ...
    */
    ...
    public static /* synthetic */ Extractor[] n(SubtitleParser.Factory factory) {
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.j
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
                return MatroskaExtractor.n(factory);
            }
        };
    }
    ...
    public static /* synthetic */ Extractor[] rl() {
