...
public final class AmrExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.amr.j
    ...
    private void maybeOutputSeekMap(long j2, int i2) {
        ...
        } else if ((i5 & 1) == 0 || !((i3 = this.firstSampleSize) == -1 || i3 == this.currentSampleSize)) {
    ...
    private void maybeOutputFormat() {
        ...
        this.realTrackOutput.format(new Format.Builder().setContainerMimeType(str).setSampleMimeType(z2 ? "audio/amr-wb" : "audio/3gpp").setMaxInputSize(z2 ? frameSizeBytesByTypeWb[8] : frameSizeBytesByTypeNb[7]).setChannelCount(1).setSampleRate(z2 ? 16000 : 8000).build());
    }
        ...
        if (this.currentSampleBytesRemaining == 0) {
            try {
                ...
                if (seekMap instanceof IndexSeekMap) {
                    ...
                    if (!indexSeekMap.isTimeUsInIndex(j2, SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US)) {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (sample == -1) {
            ...
            if (seekMap instanceof IndexSeekMap) {
                ...
                ((IndexSeekMap) seekMap).setDurationUs(j2);
