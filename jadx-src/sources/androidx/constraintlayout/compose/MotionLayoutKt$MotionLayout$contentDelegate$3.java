...
public final class MotionLayoutKt$MotionLayout$contentDelegate$3 extends Lambda implements Function3<MotionLayoutScope, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Ref f34710O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    final /* synthetic */ MutableState f34711n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ InvalidationStrategy f34712t;
    ...
    public final void n(MotionLayoutScope motionLayoutScope, Composer composer, int i2) {
        if (ComposerKt.v()) {
            ComposerKt.p5(1064705982, i2, -1, "androidx.constraintlayout.compose.MotionLayout.<anonymous> (MotionLayout.kt:390)");
        }
        this.f34711n.setValue(Unit.INSTANCE);
        if (this.f34712t.getOnObservedStateChange() == null && this.f34710O.getValue() == CompositionSource.Unknown) {
            this.f34710O.rl(CompositionSource.Content);
        }
