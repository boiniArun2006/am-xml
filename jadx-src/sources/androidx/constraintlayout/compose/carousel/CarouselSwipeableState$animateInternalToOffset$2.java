...
@DebugMetadata(c = "androidx.constraintlayout.compose.carousel.CarouselSwipeableState$animateInternalToOffset$2", f = "CarouselSwipeable.kt", i = {}, l = {Sdk.SDKError.Reason.INVALID_JSON_BID_PAYLOAD_VALUE}, m = "invokeSuspend", n = {}, s = {})
final class CarouselSwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ CarouselSwipeableState f34921O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f34922n;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    final /* synthetic */ AnimationSpec f34923r;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private /* synthetic */ Object f34924t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CarouselSwipeableState$animateInternalToOffset$2(CarouselSwipeableState carouselSwipeableState, float f3, AnimationSpec animationSpec, Continuation continuation) {
        super(2, continuation);
        this.f34921O = carouselSwipeableState;
        this.J2 = f3;
        this.f34923r = animationSpec;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        CarouselSwipeableState$animateInternalToOffset$2 carouselSwipeableState$animateInternalToOffset$2 = new CarouselSwipeableState$animateInternalToOffset$2(this.f34921O, this.J2, this.f34923r, continuation);
        carouselSwipeableState$animateInternalToOffset$2.f34924t = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i2 != 0) {
                ...
                ResultKt.throwOnFailure(obj);
                final DragScope dragScope = (DragScope) this.f34924t;
                final Ref.FloatRef floatRef = new Ref.FloatRef();
                floatRef.element = this.f34921O.absoluteOffset.n();
                this.f34921O.animationTarget.setValue(Boxing.boxFloat(this.J2));
                this.f34921O.iF(true);
                Animatable animatableRl = AnimatableKt.rl(floatRef.element, 0.0f, 2, null);
                Float fBoxFloat = Boxing.boxFloat(this.J2);
                AnimationSpec animationSpec = this.f34923r;
            ...
            this.f34921O.animationTarget.setValue(null);
            this.f34921O.iF(false);
            return Unit.INSTANCE;
        } catch (Throwable th) {
            this.f34921O.animationTarget.setValue(null);
            this.f34921O.iF(false);
