...
public final class ConstraintLayoutKt$ConstraintLayout$measurePolicy$2$1 implements MeasurePolicy {
    ...
    final /* synthetic */ MutableState f34492n;
    final /* synthetic */ int nr;
    final /* synthetic */ Measurer2 rl;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ ConstraintSet f34493t;

    @Override // androidx.compose.ui.layout.MeasurePolicy
    public final MeasureResult rl(MeasureScope measureScope, final List list, long j2) {
        final LinkedHashMap linkedHashMap = new LinkedHashMap();
        this.f34492n.getValue();
        long jR = this.rl.r(j2, measureScope.getLayoutDirection(), this.f34493t, list, linkedHashMap, this.nr);
        int iUo = IntSize.Uo(jR);
        int iJ2 = IntSize.J2(jR);
        final Measurer2 measurer2 = this.rl;
        return MeasureScope.ER(measureScope, iUo, iJ2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.constraintlayout.compose.ConstraintLayoutKt$ConstraintLayout$measurePolicy$2$1.1
