...
public final class MotionLayoutKt$MotionLayout$contentDelegate$2 extends Lambda implements Function3<MotionLayoutScope, Composer, Integer, Unit> {
    ...
    final /* synthetic */ Ref f34707O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    final /* synthetic */ MutableState f34708n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ InvalidationStrategy f34709t;
    ...
    public final void n(MotionLayoutScope motionLayoutScope, Composer composer, int i2) {
        if (ComposerKt.v()) {
            ComposerKt.p5(-23317463, i2, -1, "androidx.constraintlayout.compose.MotionLayout.<anonymous> (MotionLayout.kt:264)");
        }
        this.f34708n.setValue(Unit.INSTANCE);
        if (this.f34709t.getOnObservedStateChange() == null && this.f34707O.getValue() == CompositionSource.Unknown) {
            this.f34707O.rl(CompositionSource.Content);
        }
