...
final class ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1 extends SuspendLambda implements Function2<vd, Continuation<? super Unit>, Object> {

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    final /* synthetic */ UpdateSignalsRequest f40874O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f40875n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ ProtectedSignalsManagerFutures.JavaImpl f40876t;
    ...
    ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1(ProtectedSignalsManagerFutures.JavaImpl javaImpl, UpdateSignalsRequest updateSignalsRequest, Continuation continuation) {
        ...
        this.f40876t = javaImpl;
        this.f40874O = updateSignalsRequest;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1(this.f40876t, this.f40874O, continuation);
    }

    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
    public final Object invoke2(vd vdVar, Continuation continuation) {
        return ((ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1) create(vdVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            ProtectedSignalsManager protectedSignalsManager = this.f40876t.mProtectedSignalsManager;
            Intrinsics.checkNotNull(protectedSignalsManager);
            UpdateSignalsRequest updateSignalsRequest = this.f40874O;
            this.f40875n = 1;
            if (protectedSignalsManager.n(updateSignalsRequest, this) == coroutine_suspended) {
