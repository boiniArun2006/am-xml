...
final class AdSelectionManagerFutures$Api33Ext4JavaImpl$persistAdSelectionResultAsync$1 extends SuspendLambda implements Function2<vd, Continuation<? super AdSelectionOutcome>, Object> {

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    final /* synthetic */ PersistAdSelectionResultRequest f40818O;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    int f40819n;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ AdSelectionManagerFutures.Api33Ext4JavaImpl f40820t;
    ...
    AdSelectionManagerFutures$Api33Ext4JavaImpl$persistAdSelectionResultAsync$1(AdSelectionManagerFutures.Api33Ext4JavaImpl api33Ext4JavaImpl, PersistAdSelectionResultRequest persistAdSelectionResultRequest, Continuation continuation) {
        ...
        this.f40820t = api33Ext4JavaImpl;
        this.f40818O = persistAdSelectionResultRequest;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new AdSelectionManagerFutures$Api33Ext4JavaImpl$persistAdSelectionResultAsync$1(this.f40820t, this.f40818O, continuation);
    }

    /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
    public final Object invoke2(vd vdVar, Continuation continuation) {
        return ((AdSelectionManagerFutures$Api33Ext4JavaImpl$persistAdSelectionResultAsync$1) create(vdVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        AdSelectionManager adSelectionManager = this.f40820t.mAdSelectionManager;
        Intrinsics.checkNotNull(adSelectionManager);
        PersistAdSelectionResultRequest persistAdSelectionResultRequest = this.f40818O;
        this.f40819n = 1;
        Object objRl = adSelectionManager.rl(persistAdSelectionResultRequest, this);
