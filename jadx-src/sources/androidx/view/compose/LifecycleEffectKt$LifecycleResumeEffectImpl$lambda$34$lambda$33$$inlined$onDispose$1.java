...
public final class LifecycleEffectKt$LifecycleResumeEffectImpl$lambda$34$lambda$33$$inlined$onDispose$1 implements DisposableEffectResult {
    ...
    final /* synthetic */ LifecycleOwner f39045n;
    final /* synthetic */ LifecycleEventObserver rl;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    final /* synthetic */ Ref.ObjectRef f39046t;

    @Override // androidx.compose.runtime.DisposableEffectResult
    public void n() {
        this.f39045n.getLifecycle().nr(this.rl);
        LifecyclePauseOrDisposeEffectResult lifecyclePauseOrDisposeEffectResult = (LifecyclePauseOrDisposeEffectResult) this.f39046t.element;
        if (lifecyclePauseOrDisposeEffectResult != null) {
            lifecyclePauseOrDisposeEffectResult.n();
        }
    }
}
