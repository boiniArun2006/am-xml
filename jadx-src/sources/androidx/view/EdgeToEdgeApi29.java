...
class EdgeToEdgeApi29 extends EdgeToEdgeApi28 {
    @Override // androidx.view.EdgeToEdgeApi26, androidx.view.EdgeToEdgeBase, androidx.view.EdgeToEdgeImpl
    @DoNotInline
    public void rl(SystemBarStyle statusBarStyle, SystemBarStyle navigationBarStyle, Window window, View view, boolean statusBarIsDark, boolean navigationBarIsDark) {
        ...
        window.setStatusBarColor(statusBarStyle.O(statusBarIsDark));
        window.setNavigationBarColor(navigationBarStyle.O(navigationBarIsDark));
        window.setStatusBarContrastEnforced(false);
        window.setNavigationBarContrastEnforced(navigationBarStyle.getNightMode() == 0);
        WindowInsetsControllerCompat windowInsetsControllerCompat = new WindowInsetsControllerCompat(window, view);
        windowInsetsControllerCompat.t(!statusBarIsDark);
        windowInsetsControllerCompat.rl(true ^ navigationBarIsDark);
    }
}
