...
public final class Fl extends l3D {
    public static final int $stable = 0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Fl(ShaderSourceLoader sourceLoader) {
        super(sourceLoader, "tex2d", "tex2d_checker_in");
        Intrinsics.checkNotNullParameter(sourceLoader, "sourceLoader");
    }

    public static /* synthetic */ void render$default(Fl fl, C2470N c2470n, g9s g9sVar, float f3, SolidColor solidColor, SolidColor solidColor2, SolidColor solidColor3, float f4, int i2, Object obj) throws OpenGLException {
        if ((i2 & 4) != 0) {
            f3 = 1.0f;
        }
        float f5 = f3;
        ...
        fl.render(c2470n, g9sVar, f5, solidColor4, solidColor5, solidColor3, f4);
    }
