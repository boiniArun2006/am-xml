...
public final class pq extends l3D {
    public static final int $stable = 0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public pq(ShaderSourceLoader sourceLoader) {
        super(sourceLoader, "tex2d", "tex2d_grad_radial");
        Intrinsics.checkNotNullParameter(sourceLoader, "sourceLoader");
    }

    public static /* synthetic */ void render$default(pq pqVar, C2470N c2470n, g9s g9sVar, float f3, Vector2D vector2D, Vector2D vector2D2, SolidColor solidColor, SolidColor solidColor2, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f3 = 1.0f;
        }
        pqVar.render(c2470n, g9sVar, f3, vector2D, vector2D2, solidColor, solidColor2);
    }
