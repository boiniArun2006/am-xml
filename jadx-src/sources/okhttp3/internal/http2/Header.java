...
public final /* data */ class Header {
    ...
    public Header(ByteString byteString, ByteString value) {
        Intrinsics.checkNotNullParameter(byteString, GDEJgAYrPQHfw.uDUexYtqq);
        Intrinsics.checkNotNullParameter(value, "value");
        this.name = byteString;
        this.value = value;
        this.hpackSize = byteString.size() + 32 + value.size();
    }
