...
public final class Route {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = SafeDKWebAppInterface.f62924j, imports = {}))
    ...
    @JvmName(name = SafeDKWebAppInterface.f62924j)
