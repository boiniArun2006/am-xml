...
abstract class I28 {
    ...
    private static final int[][] f7572n = {new int[]{1, 1, 1, 1, 1, 1, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 0, 0, 0, 0, 1}, new int[]{1, 1, 1, 1, 1, 1, 1}};
    ...
    static void qie(bq4.j jVar, int i2, n nVar) throws WriterException {
    ...
    static void Ik(bq4.w6 w6Var, b1b.j jVar) throws WriterException {
        jVar.t(w6Var.J2(), 6);
    ...
    static void J2(b1b.j jVar, int i2, n nVar) throws WriterException {
        boolean zJ2;
        int iO = nVar.O() - 1;
        int iNr = nVar.nr() - 1;
        int i3 = 0;
    ...
    static void ck(bq4.j jVar, int i2, b1b.j jVar2) throws WriterException {
        if (Wre.rl(i2)) {
            int iRl = (jVar.rl() << 3) | i2;
            jVar2.t(iRl, 5);
            jVar2.t(rl(iRl, 1335), 10);
        ...
        throw new WriterException(USEaHtCMH.PMFA);
    }

    static void n(b1b.j jVar, bq4.j jVar2, bq4.w6 w6Var, int i2, n nVar) throws WriterException {
        t(nVar);
        nr(w6Var, nVar);
        qie(jVar2, i2, nVar);
        o(w6Var, nVar);
    ...
    static void nr(bq4.w6 w6Var, n nVar) throws WriterException {
        mUb(nVar);
        O(nVar);
        r(w6Var, nVar);
        gh(nVar);
    ...
    static void o(bq4.w6 w6Var, n nVar) throws WriterException {
        if (w6Var.J2() >= 7) {
            b1b.j jVar = new b1b.j();
            Ik(w6Var, jVar);
            int i2 = 17;
    ...
    private static void r(bq4.w6 w6Var, n nVar) {
        if (w6Var.J2() >= 2) {
            int[] iArr = f7573t[w6Var.J2() - 1];
            for (int i2 : iArr) {
                if (i2 >= 0) {
                    for (int i3 : iArr) {
