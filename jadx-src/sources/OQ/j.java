...
public final class j {
    ...
    int J2(int i2) {
        if (i2 != 0) {
            return this.f7441n[(this.f7440O - this.rl[i2]) - 1];
        }
    ...
    int KN(int i2, int i3) {
        ...
        int[] iArr = this.f7441n;
        int[] iArr2 = this.rl;
        return iArr[(iArr2[i2] + iArr2[i3]) % (this.f7440O - 1)];
    }
    ...
    int t(int i2) {
        return this.f7441n[i2];
    }

    public String toString() {
        return "GF(0x" + Integer.toHexString(this.J2) + ',' + this.f7440O + ')';
    }
    ...
    public j(int i2, int i3, int i5) {
        ...
        for (int i9 = 0; i9 < i3 - 1; i9++) {
            this.rl[this.f7441n[i9]] = i9;
        }
        this.f7442t = new n(this, new int[]{0});
