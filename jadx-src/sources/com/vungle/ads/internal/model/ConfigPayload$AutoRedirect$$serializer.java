...
public final class ConfigPayload$AutoRedirect$$serializer implements vd {
    ...
    public ConfigPayload.AutoRedirect deserialize(I28 decoder) {
        ...
        if (w6VarRl.HI()) {
            ...
            while (z2) {
                ...
                if (iNY == -1) {
                    ...
                    objE3 = w6VarRl.e(descriptor2, 1, fg.f2014n, objE3);
                    i3 |= 2;
                }
            }
            objE2 = objE3;
        ...
        return new ConfigPayload.AutoRedirect(i2, (Boolean) objE, (Long) objE2, (i) null);
    }

    @Override // XA.eO
    public void serialize(gi.Wre encoder, ConfigPayload.AutoRedirect value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        Wre descriptor2 = getDescriptor();
        Ml mlRl = encoder.rl(descriptor2);
        ConfigPayload.AutoRedirect.write$Self(value, mlRl, descriptor2);
        mlRl.t(descriptor2);
    }
    ...
    static {
        ...
        DC dc = new DC("com.vungle.ads.internal.model.ConfigPayload.AutoRedirect", configPayload$AutoRedirect$$serializer, 2);
        dc.HI("allow_auto_redirect", true);
        dc.HI("after_click_ms", true);
        descriptor = dc;
    }

    @Override // Du.vd
    public XA.Ml[] childSerializers() {
        return new XA.Ml[]{j.Z(Dsr.f1956n), j.Z(fg.f2014n)};
    }
