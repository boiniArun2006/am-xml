...
public final /* data */ class NonConsumable {
    ...
    public /* synthetic */ class j implements vd {
        ...
        static {
            ...
            f51427n = jVar;
            rl = 8;
            DC dc = new DC("com.bendingspoons.oracle.models.NonConsumable", jVar, 5);
        ...
        public final NonConsumable deserialize(I28 decoder) {
            int i2;
            String str;
            Set set;
            String str2;
            ...
            Ml[] mlArr = NonConsumable.$childSerializers;
            String strIk2 = null;
            if (w6VarRl.HI()) {
            ...
            w6VarRl.t(wre);
            return new NonConsumable(i2, str, set, str2, list, strIk, (i) null);
        }

        @Override // XA.eO
        /* JADX INFO: renamed from: t, reason: merged with bridge method [inline-methods] */
        public final void serialize(gi.Wre encoder, NonConsumable value) {
            Intrinsics.checkNotNullParameter(encoder, "encoder");
            Intrinsics.checkNotNullParameter(value, "value");
            EJn.Wre wre = descriptor;
            gi.Ml mlRl = encoder.rl(wre);
            NonConsumable.write$Self$oracle_release(value, mlRl, wre);
            mlRl.t(wre);
        }
    ...
    /* JADX INFO: renamed from: com.bendingspoons.oracle.models.NonConsumable$n, reason: from kotlin metadata */
    /* JADX INFO: loaded from: /content/repo2/apk-analysis/Alight motion /classes6.dex */
    ...
    public /* synthetic */ NonConsumable(int i2, String str, Set set, String str2, List list, String str3, i iVar) {
        if (1 != (i2 & 1)) {
            g9.n(i2, 1, j.f51427n.getDescriptor());
        }
        this.id = str;
        if ((i2 & 2) == 0) {
    ...
    public static /* synthetic */ NonConsumable copy$default(NonConsumable nonConsumable, String str, Set set, String str2, List list, String str3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = nonConsumable.id;
        }
        if ((i2 & 2) != 0) {
            set = nonConsumable.features;
        }
        if ((i2 & 4) != 0) {
            str2 = nonConsumable.planId;
        }
        if ((i2 & 8) != 0) {
            list = nonConsumable.secondaryApps;
        }
        if ((i2 & 16) != 0) {
            str3 = nonConsumable.status;
        }
        String str4 = str3;
        String str5 = str2;
        return nonConsumable.copy(str, set, str5, list, str4);
    }
    ...
    public final NonConsumable copy(@Json(name = "product_id") String id, @Json(name = "features") Set<String> features, @Json(name = "plan_id") String planId, @Json(name = "secondary_apps") List<SecondaryApp> secondaryApps, @Json(name = "status") String status) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.id, nonConsumable.id) && Intrinsics.areEqual(this.features, nonConsumable.features) && Intrinsics.areEqual(this.planId, nonConsumable.planId) && Intrinsics.areEqual(this.secondaryApps, nonConsumable.secondaryApps) && Intrinsics.areEqual(this.status, nonConsumable.status);
    }
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$oracle_release(NonConsumable self, gi.Ml output, EJn.Wre serialDesc) {
    ...
    public final void setId(String str) {
        Intrinsics.checkNotNullParameter(str, IYJfqUyym.LoSaAoOtFA);
        this.id = str;
    }
    ...
    public NonConsumable(@Json(name = "product_id") String id, @Json(name = "features") Set<String> features, @Json(name = "plan_id") String str, @Json(name = "secondary_apps") List<SecondaryApp> secondaryApps, @Json(name = "status") String status) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(features, "features");
        Intrinsics.checkNotNullParameter(secondaryApps, "secondaryApps");
        Intrinsics.checkNotNullParameter(status, "status");
