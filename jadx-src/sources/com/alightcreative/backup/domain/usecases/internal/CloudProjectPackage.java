...
final /* data */ class CloudProjectPackage {
    ...
    public CloudProjectPackage(int i2, String amVersionString, String amPackageVersion, String amPlatform, List<String> list, int i3, String title, String medThumbUrl, String amPackageId, Timestamp shareDate, long j2, List<SharedProjectInfo> projects, int i5, int i7, int i8, int i9) {
        ...
        Intrinsics.checkNotNullParameter(list, pTYaLzzmJSGAPQ.HMYmIMsms);
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((Integer.hashCode(this.amVersionCode) * 31) + this.amVersionString.hashCode()) * 31) + this.amPackageVersion.hashCode()) * 31) + this.amPlatform.hashCode()) * 31) + this.requiredEffects.hashCode()) * 31) + Integer.hashCode(this.maxFFVer)) * 31) + this.title.hashCode()) * 31) + this.medThumbUrl.hashCode()) * 31) + this.amPackageId.hashCode()) * 31) + this.shareDate.hashCode()) * 31) + Long.hashCode(this.size)) * 31) + this.projects.hashCode()) * 31) + Integer.hashCode(this.fphs)) * 31) + Integer.hashCode(this.duration)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height);
    }

    public String toString() {
        return "CloudProjectPackage(amVersionCode=" + this.amVersionCode + ", amVersionString=" + this.amVersionString + ", amPackageVersion=" + this.amPackageVersion + ", amPlatform=" + this.amPlatform + ", requiredEffects=" + this.requiredEffects + ", maxFFVer=" + this.maxFFVer + ", title=" + this.title + ", medThumbUrl=" + this.medThumbUrl + ", amPackageId=" + this.amPackageId + ", shareDate=" + this.shareDate + ", size=" + this.size + ", projects=" + this.projects + ", fphs=" + this.fphs + ", duration=" + this.duration + ", width=" + this.width + ", height=" + this.height + ")";
    }
