...
public final class b implements f0 {
    ...
    public final o f53635b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final com.fyber.inneractive.sdk.flow.endcard.loaders.listeners.a f53636c;
    ...
    public final void a(Object obj, Exception exc, boolean z2) {
        ...
        if (str != null && exc == null) {
            IAlog.c("%s loaded FMP End-Card icon %s", "IconCallback", this.f53637d);
            p pVar = this.f53634a;
            pVar.f53647k = str;
            pVar.b(this.f53636c);
            return;
        }
        if (TextUtils.isEmpty(this.f53634a.f53647k)) {
            o oVar = this.f53635b;
