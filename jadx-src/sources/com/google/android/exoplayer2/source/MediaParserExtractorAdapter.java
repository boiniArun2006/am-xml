...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    public static final ProgressiveMediaExtractor.Factory FACTORY = new ProgressiveMediaExtractor.Factory() { // from class: com.google.android.exoplayer2.source.Dsr
    ...
    public void seek(long j2, long j3) {
        ...
        this.mediaParser.seek(androidx.media3.exoplayer.source.C.n(androidx.media3.exoplayer.source.C.n(seekPoints.second).position == j2 ? seekPoints.second : seekPoints.first));
    }
