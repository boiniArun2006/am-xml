...
public final class JpegExtractor implements Extractor {
    ...
    private j mp4ExtractorStartOffsetExtractorInput;
    ...
    private static MotionPhotoMetadata getMotionPhotoMetadata(String str, long j2) throws IOException {
        MotionPhotoDescription motionPhotoDescriptionN;
        if (j2 == -1 || (motionPhotoDescriptionN = n.n(str)) == null) {
            return null;
        }
        return motionPhotoDescriptionN.n(j2);
    }
    ...
    private void sniffMotionPhotoVideo(ExtractorInput extractorInput) throws IOException {
        ...
        j jVar = new j(extractorInput, this.mp4StartPosition);
        this.mp4ExtractorStartOffsetExtractorInput = jVar;
        if (!this.mp4Extractor.sniff(jVar)) {
            endReadingWithImageTrack();
        } else {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (this.mp4ExtractorStartOffsetExtractorInput == null || extractorInput != this.lastExtractorInput) {
            ...
            this.mp4ExtractorStartOffsetExtractorInput = new j(extractorInput, this.mp4StartPosition);
        }
