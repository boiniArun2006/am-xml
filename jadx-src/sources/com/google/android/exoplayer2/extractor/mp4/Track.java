...
public final class Track {
    ...
    public Track(int i2, int i3, long j2, long j3, long j4, Format format, int i5, @Nullable TrackEncryptionBox[] trackEncryptionBoxArr, int i7, @Nullable long[] jArr, @Nullable long[] jArr2) {
        this.id = i2;
        this.type = i3;
        this.timescale = j2;
