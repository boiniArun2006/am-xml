                ...
                if (bits2 == 2) {
                    ...
                    if (bits4 == 3) {
                        while (parsableBitArray.getBytePosition() < bytePosition3) {
                            bytesAsString = parsableBitArray.readBytesAsString(parsableBitArray.readBits(8), I28.f73395n);
                    ...
                    bytesAsString2 = parsableBitArray.readBytesAsString(bits3, I28.f73395n);
                }
