...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    private static final class n implements DownloadCursor {

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        private final Cursor f57993n;
        ...
        public int getCount() {
            return this.f57993n.getCount();
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public Download getDownload() {
            return DefaultDownloadIndex.getDownloadForCurrentRow(this.f57993n);
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public int getPosition() {
            return this.f57993n.getPosition();
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public boolean isClosed() {
            return this.f57993n.isClosed();
        }

        @Override // com.google.android.exoplayer2.offline.DownloadCursor
        public boolean moveToPosition(int i2) {
            return this.f57993n.moveToPosition(i2);
        }
    }
    ...
    private void putDownloadInternal(Download download, SQLiteDatabase sQLiteDatabase) {
        ...
        contentValues.put(LHbnkhI.KJqaAPMb, Integer.valueOf(download.failureReason));
        contentValues.put(COLUMN_PERCENT_DOWNLOADED, Float.valueOf(download.getPercentDownloaded()));
        contentValues.put(jhotmBbwMbr.XpjbZFqTOkpMZxL, Long.valueOf(download.getBytesDownloaded()));
    ...
    public DownloadCursor getDownloads(int... iArr) throws DatabaseIOException {
        ensureInitialized();
        return new n(getCursor(getStateQuery(iArr), null));
    }
