...
public final class DownloadRequest implements Parcelable {
    public static final Parcelable.Creator<DownloadRequest> CREATOR = new j();
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            ...
            return new DownloadRequest(str, uri, str2, listR, this.keySetId, this.customCacheKey, this.data, null);
        }
    ...
    /* synthetic */ DownloadRequest(String str, Uri uri, String str2, List list, byte[] bArr, String str3, byte[] bArr2, j jVar) {
