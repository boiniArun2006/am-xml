...
final class zzpt {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b2, byte b4, char[] cArr, int i2) throws zznn {
        if (b2 < -62 || zze(b4)) {
    ...
    static /* bridge */ /* synthetic */ void zza(byte b2, byte b4, byte b5, byte b6, char[] cArr, int i2) throws zznn {
    ...
    */
    static /* bridge */ /* synthetic */ void zzb(byte b2, byte b4, byte b5, char[] cArr, int i2) throws zznn {
        if (!zze(b4)) {
            if (b2 == -32) {
                if (b4 >= -96) {
                    b2 = -32;
