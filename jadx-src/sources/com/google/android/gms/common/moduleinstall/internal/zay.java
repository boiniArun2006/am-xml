...
public final class zay extends GoogleApi implements ModuleInstallClient {
    ...
    public final Task<ModuleInstallResponse> installModules(ModuleInstallRequest moduleInstallRequest) {
        ListenerHolder listenerHolderCreateListenerHolder;
        ...
        if (listenerExecutor == null) {
            listenerHolderCreateListenerHolder = registerListener(listener, InstallStatusListener.class.getSimpleName());
        } else {
            listenerHolderCreateListenerHolder = ListenerHolders.createListenerHolder(listener, listenerExecutor, InstallStatusListener.class.getSimpleName());
        }
        ...
        builder2.withHolder(listenerHolderCreateListenerHolder);
