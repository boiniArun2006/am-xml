...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) @InstallState int i3, @Nullable @SafeParcelable.Param(id = 3) Long l2, @Nullable @SafeParcelable.Param(id = 4) Long l5, @SafeParcelable.Param(id = 5) int i5) {
        ...
        this.zad = l5;
        this.zae = i5;
        if (l2 != null && l5 != null && l5.longValue() != 0) {
            progressInfo = new ProgressInfo(l2.longValue(), l5.longValue());
        } else {
            progressInfo = null;
        }
