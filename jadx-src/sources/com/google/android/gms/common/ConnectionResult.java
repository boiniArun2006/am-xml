...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    ConnectionResult(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) int i3, @Nullable @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(id = 4) String str, @Nullable @SafeParcelable.Param(id = 5) Integer num) {
        this.zza = i2;
        this.zzb = i3;
    ...
    @KeepForSdk
    public ConnectionResult(int i2, @Nullable PendingIntent pendingIntent, @Nullable String str, @Nullable Integer num) {
        this(1, i2, pendingIntent, str, num);
    }
}
