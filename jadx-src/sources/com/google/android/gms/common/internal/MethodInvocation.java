...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    @Deprecated
    public MethodInvocation(int i2, int i3, int i5, long j2, long j3, @Nullable String str, @Nullable String str2, int i7) {
        this(i2, i3, i5, j2, j3, str, str2, i7, -1);
    }

    @SafeParcelable.Constructor
    public MethodInvocation(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) int i3, @SafeParcelable.Param(id = 3) int i5, @SafeParcelable.Param(id = 4) long j2, @SafeParcelable.Param(id = 5) long j3, @Nullable @SafeParcelable.Param(id = 6) String str, @Nullable @SafeParcelable.Param(id = 7) String str2, @SafeParcelable.Param(id = 8) int i7, @SafeParcelable.Param(id = 9) int i8) {
        this.zaa = i2;
        this.zab = i3;
        this.zac = i5;
        this.zad = j2;
