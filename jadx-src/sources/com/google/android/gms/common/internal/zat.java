...
public final class zat extends AbstractSafeParcelable {
    ...
    zat(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) Account account, @SafeParcelable.Param(id = 3) int i3, @Nullable @SafeParcelable.Param(id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zaa = i2;
        this.zab = account;
        this.zac = i3;
