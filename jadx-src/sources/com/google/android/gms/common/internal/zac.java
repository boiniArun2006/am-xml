...
public final class zac {
    ...
    public static String zae(Context context, int i2) {
        String strZah = i2 == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i2);
    ...
    private static String zah(Context context, String str) {
        ...
        synchronized (simpleArrayMap) {
            try {
                Locale localeNr = ConfigurationCompat.n(context.getResources().getConfiguration()).nr(0);
                if (!localeNr.equals(zab)) {
    ...
    public static String zac(Context context, int i2) {
        ...
        if (i2 != 1) {
            ...
            return resources.getString(R.string.common_google_play_services_update_text, strZaa);
        }
