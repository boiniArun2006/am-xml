...
import androidx.browser.trusted.I28;
...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(@NonNull Context context, int i2) {
        zae(context, i2, null, getErrorResolutionPendingIntent(context, i2, 0, c.f62177j));
    }

    @Nullable
    final Dialog zaa(@NonNull Context context, int i2, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        if (i2 == 0) {
            return null;
        }
    ...
    final void zae(Context context, int i2, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        int i3;
        String str2;
        ...
        NotificationCompat.Builder builderFD = new NotificationCompat.Builder(context).WPU(true).xMQ(true).ck(strZae).fD(new NotificationCompat.BigTextStyle().KN(strZad));
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            builderFD.iF(context.getApplicationInfo().icon).nY(2);
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                builderFD.n(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
            } else {
                builderFD.ty(pendingIntent);
            }
        } else {
            builderFD.iF(android.R.drawable.stat_sys_warning).e(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).N(System.currentTimeMillis()).ty(pendingIntent).HI(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(I28.n("com.google.android.gms.availability", string, 4));
        ...
        Notification notificationT = builderFD.t();
        if (i2 != 1 && i2 != 2 && i2 != 3) {
            i3 = 39789;
        } else {
        ...
        notificationManager.notify(i3, notificationT);
    }
