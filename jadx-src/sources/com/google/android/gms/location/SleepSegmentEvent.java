...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    public SleepSegmentEvent(@SafeParcelable.Param(id = 1) long j2, @SafeParcelable.Param(id = 2) long j3, @SafeParcelable.Param(id = 3) int i2, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) int i5) {
        boolean z2;
        if (j2 <= j3) {
            z2 = true;
        } else {
