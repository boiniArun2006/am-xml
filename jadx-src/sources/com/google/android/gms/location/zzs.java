...
public final class zzs extends AbstractSafeParcelable {
    ...
    zzs(@SafeParcelable.Param(id = 1) boolean z2, @SafeParcelable.Param(id = 2) long j2, @SafeParcelable.Param(id = 3) float f3, @SafeParcelable.Param(id = 4) long j3, @SafeParcelable.Param(id = 5) int i2) {
        this.zza = z2;
        this.zzb = j2;
        this.zzc = f3;
        this.zzd = j3;
