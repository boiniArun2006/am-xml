...
public class FusedLocationProviderClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    private final Task<Void> zze(final com.google.android.gms.internal.location.zzba zzbaVar, final LocationCallback locationCallback, Looper looper, final zzan zzanVar, int i2) {
        final ListenerHolder listenerHolderCreateListenerHolder = ListenerHolders.createListenerHolder(locationCallback, com.google.android.gms.internal.location.zzbj.zza(looper), LocationCallback.class.getSimpleName());
        ...
        }).unregister(zzakVar).withHolder(listenerHolderCreateListenerHolder).setMethodKey(i2).build());
    }
    ...
    public Task<Location> getCurrentLocation(int i2, @NonNull final CancellationToken cancellationToken) {
        ...
        locationRequestCreate.setPriority(i2);
