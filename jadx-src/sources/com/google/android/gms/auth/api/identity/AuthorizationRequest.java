...
public class AuthorizationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = V8ValueBoolean.FALSE, getter = "getOptOutIncludingGrantedScopes", id = 10)
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setOptOutIncludingGrantedScopes(boolean z2) {
            this.zbj = z2;
            return this;
        }
    ...
    public static Builder zba(@NonNull AuthorizationRequest authorizationRequest) {
        ...
        if (resourceParameters != null) {
            for (String str : resourceParameters.keySet()) {
                ...
                while (true) {
                    if (i2 < length) {
                        resourceParameter = resourceParameterArrValues[i2];
