...
public final class DynamiteModule {
    ...
    public interface VersionPolicy {
        ...
        public interface IVersions {
            int zza(@NonNull Context context, @NonNull String str, boolean z2) throws LoadingException;
    ...
    */
    public static DynamiteModule load(@NonNull Context context, @NonNull VersionPolicy versionPolicy, @NonNull String str) throws LoadingException {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(str).length() + 26 + String.valueOf(i5).length() + 19 + String.valueOf(str).length() + 1 + String.valueOf(i7).length());
            ...
            int i8 = selectionResultSelectModule.selection;
            if (i8 != 0) {
                if (i8 != -1) {
                    if (i8 == 1 || selectionResultSelectModule.remoteVersion != 0) {
                        if (i8 != -1) {
                        ...
                        try {
                            try {
                                i3 = selectionResultSelectModule.remoteVersion;
                                ...
                                i2 = selectionResultSelectModule.localVersion;
                                if (i2 != 0 || versionPolicy.selectModule(r42, str, new zzo(i2, 0)).selection != -1) {
                        ...
                        try {
                            ...
                            if (bool.booleanValue()) {
                                ...
                                if (z2) {
                                    ...
                                    iObjectWrapperZze2 = zzqVar.zzf(ObjectWrapper.wrap(applicationContext2), str, i3, ObjectWrapper.wrap(cursor2));
                                } else {
                                    Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                                    iObjectWrapperZze2 = zzqVar.zze(ObjectWrapper.wrap(applicationContext2), str, i3, ObjectWrapper.wrap(cursor2));
                                }
                                ...
                                StringBuilder sb5 = new StringBuilder(String.valueOf(str).length() + 40 + String.valueOf(i3).length());
                                ...
                                if (iZzi >= 3) {
                                    ...
                                    iObjectWrapperZze = zzpVarZzg.zzk(ObjectWrapper.wrap(context), str, i3, ObjectWrapper.wrap(zznVar4.zza));
                                } else if (iZzi == 2) {
                                    Log.w("DynamiteModule", "IDynamite loader version = 2");
                                    iObjectWrapperZze = zzpVarZzg.zzg(ObjectWrapper.wrap(context), str, i3);
                                } else {
                                    Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                                    iObjectWrapperZze = zzpVarZzg.zze(ObjectWrapper.wrap(context), str, i3);
                                }
            ...
            int i9 = selectionResultSelectModule.localVersion;
    ...
    */
    public static int zza(@NonNull Context context, @NonNull String str, boolean z2) {
        ...
        try {
            synchronized (DynamiteModule.class) {
                        ...
                        if (classLoader == ClassLoader.getSystemClassLoader()) {
                            ...
                            if (!zze) {
                                ...
                                if (bool2.equals(null)) {
                                    ...
                                    try {
                                        int iZzc = zzc(context, str, z2, true);
                                        String str2 = zzd;
                                        if (str2 != null && !str2.isEmpty()) {
                                            ...
                                            if (classLoaderZza == null) {
                                                if (Build.VERSION.SDK_INT >= 29) {
                                                    ...
                                                    classLoaderZza = j.n(str3, ClassLoader.getSystemClassLoader());
                                                } else {
                                                    String str4 = zzd;
                ...
                if (bool.booleanValue()) {
                    try {
                        return zzc(context, str, z2, false);
                    } catch (LoadingException e3) {
                        ...
                        try {
                            ...
                            if (iZzi >= 3) {
                                ...
                                if (zznVar == null || (cursor = zznVar.zza) == null) {
                                    Cursor cursor2 = (Cursor) ObjectWrapper.unwrap(zzpVarZzg.zzj(ObjectWrapper.wrap(context), str, z2, ((Long) zzi.get()).longValue()));
                                    if (cursor2 != null) {
                                        try {
                                            if (cursor2.moveToFirst()) {
                                                int i2 = cursor2.getInt(0);
                                                cursor = (i2 <= 0 || !zzd(cursor2)) ? cursor2 : null;
                                                if (cursor != null) {
                                                    cursor.close();
                                                }
                                                iZzf = i2;
                                ...
                                iZzf = zzpVarZzg.zzh(ObjectWrapper.wrap(context), str, z2);
                            } else {
                                Log.w("DynamiteModule", "IDynamite loader version < 2, falling back to getModuleVersion2");
                                iZzf = zzpVarZzg.zzf(ObjectWrapper.wrap(context), str, z2);
                            }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Not initialized variable reg: 8, insn: 0x0148: MOVE (r2 I:??[OBJECT, ARRAY]) = (r8 I:??[OBJECT, ARRAY]) (LINE:328), block:B:92:0x0148 */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private static int zzc(Context context, String str, boolean z2, boolean z3) throws Throwable {
        Throwable th;
        Exception exc;
        Cursor cursor;
        Cursor cursorQuery;
        ...
        try {
            try {
                boolean z4 = true;
                Uri uriBuild = new Uri.Builder().scheme(AppLovinEventTypes.USER_VIEWED_CONTENT).authority("com.google.android.gms.chimera").path(true != z2 ? l.f62634O : "api_force_staging").appendPath(str).appendQueryParameter("requestStartUptime", String.valueOf(((Long) zzi.get()).longValue())).build();
                    ...
                    if (matrixCursor != null) {
                        try {
                            if (matrixCursor.moveToFirst()) {
                                int i2 = matrixCursor.getInt(0);
                                if (i2 > 0) {
                                    synchronized (DynamiteModule.class) {
                                        try {
                                            zzd = matrixCursor.getString(2);
                                            int columnIndex = matrixCursor.getColumnIndex(IYJfqUyym.OhJ);
                                            if (columnIndex >= 0) {
                    ...
                    try {
                        ...
                        for (int i3 = 0; i3 < count; i3++) {
                            ...
                            for (int i5 = 0; i5 < columnCount; i5++) {
                                int type = cursorQuery.getType(i5);
                                if (type == 0) {
                                    objArr4[i5] = null;
                                } else if (type == 1) {
                                    objArr4[i5] = Long.valueOf(cursorQuery.getLong(i5));
                                } else if (type == 2) {
                                    objArr4[i5] = Double.valueOf(cursorQuery.getDouble(i5));
                                } else if (type == 3) {
                                    objArr4[i5] = cursorQuery.getString(i5);
                                } else {
                                    if (type != 4) {
                                        throw new RemoteException("Unknown column type");
                                    }
                                    objArr4[i5] = cursorQuery.getBlob(i5);
                                }
                            }
