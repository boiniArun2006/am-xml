...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        ConditionalUserProperty(@NonNull Bundle bundle) {
            ...
            this.mName = (String) zzjg.zzb(bundle, AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, null);
    ...
    @VisibleForTesting
    @WorkerThread
    protected Map<String, Object> getUserProperties(@NonNull String str, @NonNull @Size String str2, boolean z2) {
        return this.zzb.zzd(str, str2, z2);
    }
    ...
    public void logEventInternalNoInterceptor(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle, long j2) {
        this.zzb.zzb(str, str2, bundle, j2);
    }
