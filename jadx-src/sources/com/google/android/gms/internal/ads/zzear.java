...
public final class zzear extends zzfyq {
    ...
    zzear(Context context) {
        super("FlickDetector", l.f62638S);
        this.zzc = 0.0f;
    ...
    public final void zzd(SensorEvent sensorEvent) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkz)).booleanValue()) {
            ...
            if (fFloatValue > f3 + ((Float) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbgvVar)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            ...
            if (this.zzg && this.zzh) {
                ...
                if (zzeaqVar != null) {
                    if (i2 == ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzkC)).intValue()) {
