...
public final class zzhis {
    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhirVarZze = zzg(zzhirVarZze, zzhirVarZze2, a2, bigIntegerZzc);
                zzhirVarZze2 = zzf(zzhirVarZze2, a2, bigIntegerZzc);
            } else {
                zzhirVarZze2 = zzg(zzhirVarZze, zzhirVarZze2, a2, bigIntegerZzc);
                zzhirVarZze = zzf(zzhirVarZze, a2, bigIntegerZzc);
            }
        }
        if (zzhirVarZze.zza()) {
    ...
    static zzhir zze(ECPoint eCPoint, BigInteger bigInteger) {
    ...
    static zzhir zzf(zzhir zzhirVar, BigInteger bigInteger, BigInteger bigInteger2) {
    ...
    static zzhir zzg(zzhir zzhirVar, zzhir zzhirVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzhirVar.zza()) {
            return zzhirVar2;
        }
        if (zzhirVar2.zza()) {
        ...
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            ...
            return zzf(zzhirVar, bigInteger, bigInteger2);
        }
