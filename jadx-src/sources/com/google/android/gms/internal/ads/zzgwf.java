...
final class zzgwf extends zzgui {
    ...
    private zzgwf(Object obj, Object[] objArr, int i2) {
        this.zzc = obj;
        this.zzb = objArr;
        this.zzd = i2;
    }
    ...
    */
            ...
            if (i2 == 1) {
                ...
                if (obj4 != null) {
                    if (obj4 instanceof byte[]) {
                        ...
                        int iZza = zzgty.zza(obj.hashCode());
                        while (true) {
                            int i3 = iZza & length;
                        ...
                        int iZza2 = zzgty.zza(obj.hashCode());
                        while (true) {
                        ...
                        int iZza3 = zzgty.zza(obj.hashCode());
                        while (true) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    static zzgwf zzk(int i2, Object[] objArr, zzguh zzguhVar) {
        boolean z2;
        int i3;
        char c2;
        ?? r3;
        ...
        zzgrc.zzn(i7, objArrCopyOf.length >> 1, "index");
        int iZzn = zzgup.zzn(i7);
        char c5 = 2;
        if (i7 != 1) {
            int i9 = iZzn - 1;
            if (iZzn <= 128) {
                ...
                while (i10 < i7) {
                    ...
                    zzgtb.zza(obj3, obj4);
                    int iZza = zzgty.zza(obj3.hashCode());
                    while (true) {
                        int i14 = iZza & i9;
                        z3 = z6;
                        i5 = i8;
                        ...
                        if (i15 == 255) {
                            ...
                            if (obj3.equals(objArrCopyOf[i15 == true ? 1 : 0])) {
                                ...
                                zzgug zzgugVar4 = new zzgug(obj3, obj4, obj5);
                ...
                if (iZzn <= 32768) {
                    ...
                    for (int i18 = 0; i18 < i7; i18++) {
                        ...
                        zzgtb.zza(obj6, obj7);
                        int iZza2 = zzgty.zza(obj6.hashCode());
                        while (true) {
                            int i21 = iZza2 & i9;
                            ...
                            if (c6 == 65535) {
                                ...
                                if (obj6.equals(objArrCopyOf[c6])) {
                                    ...
                                    zzgug zzgugVar5 = new zzgug(obj6, obj7, obj8);
                    ...
                    if (i17 == i7) {
                        ...
                        r32 = new Object[]{sArr, Integer.valueOf(i17), zzgugVar3};
                        z5 = z2;
                    }
                } else {
                    int[] iArr = new int[iZzn];
                    Arrays.fill(iArr, -1);
                    int i23 = 0;
                    int i24 = 0;
                    while (i23 < i7) {
                        ...
                        int iZza3 = zzgty.zza(obj9.hashCode());
                        while (true) {
                            int i27 = iZza3 & i9;
                            int i28 = iArr[i27];
                            if (i28 == -1) {
                                ...
                                if (obj9.equals(objArrCopyOf[i28])) {
                                    ...
                                    zzgug zzgugVar6 = new zzgug(obj9, obj10, obj11);
            ...
            if (z4) {
                ...
                zzgug zzgugVar7 = (zzgug) objArr3[c2];
                if (zzguhVar == null) {
                    throw zzgugVar7.zza();
                }
        ...
        return new zzgwf(r332, objArrCopyOf, i7);
    }
