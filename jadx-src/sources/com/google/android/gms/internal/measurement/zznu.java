...
final class zznu extends zzkt implements RandomAccess {
    ...
    private zznu(Object[] objArr, int i2, boolean z2) {
        super(z2);
        this.zzc = objArr;
        this.zzd = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzmn zzg(int i2) {
        if (i2 >= this.zzd) {
            return new zznu(i2 == 0 ? zza : Arrays.copyOf(this.zzc, i2), this.zzd, true);
        }
