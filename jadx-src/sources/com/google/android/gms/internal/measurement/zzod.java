...
class zzod extends AbstractMap {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            if (!zzd(i3).equals(zzodVar.zzd(i3))) {
                return false;
            }
        }
        if (i2 != size) {
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i5 = 0;
        if (i3 >= 0) {
            int iCompareTo = comparable.compareTo(((zzoa) this.zza[i3]).zza());
            if (iCompareTo > 0) {
                return -(i2 + 1);
            }
            if (iCompareTo == 0) {
    ...
    public final Object zzg(int i2) {
        zzh();
        Object value = ((zzoa) this.zza[i2]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i3] = new zzoa(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i2] = new zzoa(this, comparable, obj);
        this.zzb++;
        return null;
    }
