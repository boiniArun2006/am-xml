...
final class zzop {
    ...
    static /* synthetic */ void zzb(byte b2, byte b4, char[] cArr, int i2) throws zzmq {
        if (b2 < -62 || zze(b4)) {
    ...
    */
    static /* synthetic */ void zzc(byte b2, byte b4, byte b5, char[] cArr, int i2) throws zzmq {
        if (!zze(b4)) {
            if (b2 == -32) {
                if (b4 >= -96) {
                    b2 = -32;
    ...
    static /* synthetic */ void zzd(byte b2, byte b4, byte b5, byte b6, char[] cArr, int i2) throws zzmq {
