...
final class zzjq {
    ...
    private static Field zzB() {
        ...
        Field fieldZzC2 = zzC(Buffer.class, SafeDKWebAppInterface.f62924j);
    ...
    public static void zzD(Object obj, long j2, byte b2) {
        zzjp zzjpVar = zzf;
        long j3 = (-4) & j2;
        int i2 = zzjpVar.zza.getInt(obj, j3);
        int i3 = ((~((int) j2)) & 3) << 3;
        zzjpVar.zza.putInt(obj, j3, ((255 & b2) << i3) | (i2 & (~(255 << i3))));
    }
    ...
    public static void zzE(Object obj, long j2, byte b2) {
        ...
        long j3 = (-4) & j2;
        int i2 = (((int) j2) & 3) << 3;
        zzjpVar.zza.putInt(obj, j3, ((255 & b2) << i2) | (zzjpVar.zza.getInt(obj, j3) & (~(255 << i2))));
    }
    ...
    static void zzp(Object obj, long j2, float f3) {
        zzf.zzf(obj, j2, f3);
    }
