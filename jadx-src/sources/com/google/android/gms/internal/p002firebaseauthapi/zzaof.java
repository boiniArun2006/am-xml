...
interface zzaof {
    ...
    void zza(int i2, float f3) throws IOException;

    void zza(int i2, int i3) throws IOException;

    void zza(int i2, long j2) throws IOException;

    void zza(int i2, zzajp zzajpVar) throws IOException;

    <K, V> void zza(int i2, zzalx<K, V> zzalxVar, Map<K, V> map) throws IOException;

    void zza(int i2, Object obj) throws IOException;

    @Deprecated
    void zza(int i2, Object obj, zzamv zzamvVar) throws IOException;

    void zza(int i2, String str) throws IOException;

    void zza(int i2, List<zzajp> list) throws IOException;

    @Deprecated
    void zza(int i2, List<?> list, zzamv zzamvVar) throws IOException;
    ...
    void zzb(int i2, Object obj, zzamv zzamvVar) throws IOException;

    void zzb(int i2, List<String> list) throws IOException;

    void zzb(int i2, List<?> list, zzamv zzamvVar) throws IOException;
