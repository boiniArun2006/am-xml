...
interface zzams {
    ...
    <T> void zza(T t3, zzamv<T> zzamvVar, zzakk zzakkVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzamv<T> zzamvVar, zzakk zzakkVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzalx<K, V> zzalxVar, zzakk zzakkVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t3, zzamv<T> zzamvVar, zzakk zzakkVar) throws IOException;

    void zzb(List<zzajp> list) throws IOException;

    <T> void zzb(List<T> list, zzamv<T> zzamvVar, zzakk zzakkVar) throws IOException;
