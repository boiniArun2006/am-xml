...
public final class zzni {
    ...
    private static zznl zza(zznl zznlVar, zznl zznlVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod3 = zznlVar.zzb.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zznlVar2.zzb.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zznlVar.zzc.multiply(zznlVar2.zzd).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zznlVar2.zzc.multiply(zznlVar.zzd).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zznl.zza : zza(zznlVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger bigIntegerAdd = zznlVar.zzd.add(zznlVar2.zzd);
        return new zznl(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
    ...
    private static zznl zza(zznl zznlVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerAdd = zznlVar.zzb.add(bigIntegerMod2);
        ...
        BigInteger bigIntegerAdd3 = zznlVar.zzc.add(zznlVar.zzd);
        return new zznl(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }
    ...
    private static zznl zza(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger bigIntegerMod = new BigInteger(1, zzqg.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zznl(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        if (bigInteger.signum() == 1) {
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                zznl zznlVarZza = zza(ECPoint.POINT_INFINITY, bigIntegerZza);
                zznl zznlVarZza2 = zza(generator, bigIntegerZza);
                for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
                    if (bigInteger.testBit(iBitLength)) {
                        zznlVarZza = zza(zznlVarZza, zznlVarZza2, a2, bigIntegerZza);
                        zznlVarZza2 = zza(zznlVarZza2, a2, bigIntegerZza);
                    } else {
                        zznlVarZza2 = zza(zznlVarZza, zznlVarZza2, a2, bigIntegerZza);
                        zznlVarZza = zza(zznlVarZza, a2, bigIntegerZza);
                    }
                }
                if (zznlVarZza.zza()) {
                    eCPoint = ECPoint.POINT_INFINITY;
                } else {
                    BigInteger bigIntegerModInverse = zznlVarZza.zzd.modInverse(bigIntegerZza);
                    BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerZza);
                    eCPoint = new ECPoint(zznlVarZza.zzb.multiply(bigIntegerMod).mod(bigIntegerZza), zznlVarZza.zzc.multiply(bigIntegerMod).mod(bigIntegerZza).multiply(bigIntegerModInverse).mod(bigIntegerZza));
                }
                zza(eCPoint, curve);
                return eCPoint;
            }
