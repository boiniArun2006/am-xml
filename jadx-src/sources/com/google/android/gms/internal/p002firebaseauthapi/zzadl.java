...
@VisibleForTesting
final class zzadl extends zzaex<AuthResult, InterfaceC2316p> {
    private final zzait zzu;

    public zzadl(AuthCredential authCredential, @Nullable String str) {
        super(2);
        Preconditions.checkNotNull(authCredential, "credential cannot be null");
        this.zzu = OU.n(authCredential, str);
    }
