...
public final class zzf {
    ...
    public final void zza(@Nullable WebView webView) {
        ...
        if (packageInfo != null) {
            try {
                ...
                com.google.android.gms.ads.internal.zzt.zzh().zzg(e2, "PawAppSignalGenerator.initialize");
            }
        }
        ...
        if (((Boolean) zzbjj.zzb.zze()).booleanValue() && WebViewFeature.n("DOCUMENT_START_SCRIPT") && webView != null) {
            WebViewCompat.n(webView, String.format(Locale.getDefault(), (String) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzlk), zzb()), zzgup.zzi("*"));
        }
    }
    ...
    zzf(Context context, zzbgo zzbgoVar, List list, VersionInfoParcel versionInfoParcel) {
        this.zza = context;
