...
public final class zzbp {
                ...
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            ...
                            while (i2 < length) {
                                bundleArr[i2] = !jSONArray.isNull(i2) ? zzl(jSONArray.optJSONObject(i2)) : null;
                                i2++;
                            }
    ...
    public static String zzm(@Nullable zzfiw zzfiwVar) {
        ...
        try {
            ...
            int i2 = zze.zza;
            com.google.android.gms.ads.internal.util.client.zzo.zzg("Error when writing JSON.", e2);
            return null;
        }
    }
    ...
    public static boolean zzj(boolean z2, JSONObject jSONObject, String... strArr) {
        JSONObject jSONObjectZzo = zzo(jSONObject, strArr);
        if (jSONObjectZzo == null) {
            return false;
        }
    ...
    public static String zzk(String str, JSONObject jSONObject, String... strArr) {
        ...
        return jSONObjectZzo.optString(strArr[0], "");
    }
}
