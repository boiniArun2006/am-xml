...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private final Builder addPathSegments(String pathSegments, boolean alreadyEncoded) {
            ...
            int i2 = 0;
            while (true) {
                int iDelimiterOffset = Util.delimiterOffset(pathSegments, jhotmBbwMbr.FeweNnuk, i2, pathSegments.length());
        ...
        public final Builder setEncodedPathSegment(int index, String encodedPathSegment) {
            ...
            throw new IllegalArgumentException((QTafcm.GRWueYjZuMpO + encodedPathSegment).toString());
        }
        ...
        */
        ...
        public final Builder username(String username) {
            ...
            this.encodedUsername = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, username, 0, 0, Apsps.sorSulf, false, false, false, false, null, 251, null);
            return this;
        }
    ...
    public static final class Companion {
        ...
        public final HttpUrl m89deprecated_get(String url) {
        ...
        public final HttpUrl m92deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
