...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(RealCall call, List<? extends Interceptor> interceptors, int i2, Exchange exchange, Request request, int i3, int i5, int i7) {
    ...
    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i2, Exchange exchange, Request request, int i3, int i5, int i7, int i8, Object obj) {
        if ((i8 & 1) != 0) {
        ...
        if ((i8 & 16) != 0) {
            i5 = realInterceptorChain.readTimeoutMillis;
        }
        if ((i8 & 32) != 0) {
        ...
        int i9 = i5;
        int i10 = i7;
        return realInterceptorChain.copy$okhttp(i2, exchange, request, i3, i9, i10);
    }
