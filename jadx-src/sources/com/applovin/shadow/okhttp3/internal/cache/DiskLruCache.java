...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final synchronized void completeEdit$okhttp(Editor editor, boolean success) throws IOException {
        ...
        for (int i7 = 0; i7 < i5; i7++) {
            File file = entry.getDirtyFiles$okhttp().get(i7);
            if (!success || entry.getZombie()) {
                this.fileSystem.delete(file);
            } else if (this.fileSystem.exists(file)) {
                File file2 = entry.getCleanFiles$okhttp().get(i7);
                this.fileSystem.rename(file, file2);
                long j2 = entry.getLengths()[i7];
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) line, ' ', i2, false, 4, (Object) null);
        if (iIndexOf$default2 == -1) {
            ...
            strSubstring = line.substring(i2, iIndexOf$default2);
