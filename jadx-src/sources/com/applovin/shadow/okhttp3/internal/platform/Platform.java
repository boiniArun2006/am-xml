...
public class Platform {
    ...
    public static final class Companion {
        ...
        private final boolean isOpenJSSEPreferred() {
            return Intrinsics.areEqual(aNrWBQYwFf.EUdrVvBC, Security.getProviders()[0].getName());
        }
