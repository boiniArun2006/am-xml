...
public final class ConscryptPlatform extends Platform {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ boolean atLeastVersion$default(Companion companion, int i2, int i3, int i5, int i7, Object obj) {
            if ((i7 & 2) != 0) {
                i3 = 0;
            }
            if ((i7 & 4) != 0) {
            ...
            return companion.atLeastVersion(i2, i3, i5);
        }
