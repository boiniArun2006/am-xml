...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        public final int readInt(int firstByte, int prefixMask) throws IOException {
            ...
            while (true) {
                int i5 = readByte();
                if ((i5 & 128) == 0) {
                    return prefixMask + (i5 << i3);
                }
                prefixMask += (i5 & 127) << i3;
                i3 += 7;
            }
        }
        ...
        public /* synthetic */ Reader(Source source, int i2, int i3, int i5, DefaultConstructorMarker defaultConstructorMarker) {
            this(source, i2, (i5 & 4) != 0 ? i2 : i3);
        }
    }
    ...
    public static final class Writer {
        ...
        private final int evictToRecoverBytes(int bytesToRecover) {
            ...
            if (bytesToRecover > 0) {
                ...
                int i7 = this.nextHeaderIndex;
                Arrays.fill(headerArr2, i7 + 1, i7 + 1 + i3, (Object) null);
                this.nextHeaderIndex += i3;
            }
            return i3;
        }
                    ...
                    while (true) {
                        ...
                        if (Intrinsics.areEqual(header2.name, asciiLowercase)) {
                            ...
                            if (Intrinsics.areEqual(header3.value, byteString)) {
                                length2 = Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length + (i5 - this.nextHeaderIndex);
                                break;
                            } else if (length == -1) {
                                length = (i5 - this.nextHeaderIndex) + Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length;
                            }
                        }
                        i5++;
                    }
    ...
    static {
        ...
        Header header6 = new Header(byteString3, g.f62375e);
        Header header7 = new Header(byteString3, "https");
        ByteString byteString4 = Header.RESPONSE_STATUS;
        STATIC_HEADER_TABLE = new Header[]{header, header2, header3, header4, header5, header6, header7, new Header(byteString4, "200"), new Header(byteString4, "204"), new Header(byteString4, "206"), new Header(byteString4, "304"), new Header(byteString4, "400"), new Header(byteString4, "404"), new Header(byteString4, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header(InneractiveMediationDefs.KEY_AGE, ""), new Header("allow", ""), new Header(YjqZUJsVmhcjko.IWm, ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header("date", ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header(gUxOLwRQBPPLC.gedqytszyyzwFZ, ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
