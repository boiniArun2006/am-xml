...
public final class Relay {
    ...
    public static final class Companion {
        ...
        public final Relay edit(File file, Source upstream, ByteString metadata, long bufferMaxSize) throws IOException {
            Intrinsics.checkNotNullParameter(file, inFlMLxL.yVyufaciisoZY);
        ...
        public long read(Buffer sink, long byteCount) throws IOException {
            ...
            synchronized (relay) {
                ...
                try {
                    ...
                    fileOperator2.write(Relay.this.getUpstreamPos() + Relay.FILE_HEADER_SIZE, Relay.this.getUpstreamBuffer().m156clone(), j2);
