...
public final class Path {
    ...
    public static final com.applovin.shadow.okio.Path commonResolve(com.applovin.shadow.okio.Path path, String child, boolean z2) {
    ...
    public static final com.applovin.shadow.okio.Path commonToPath(String str, boolean z2) {
    ...
    public static final com.applovin.shadow.okio.Path toPath(Buffer buffer, boolean z2) throws EOFException {
    ...
    public static final com.applovin.shadow.okio.Path commonResolve(com.applovin.shadow.okio.Path path, ByteString child, boolean z2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(child, "child");
    ...
    public static final com.applovin.shadow.okio.Path commonResolve(com.applovin.shadow.okio.Path path, Buffer child, boolean z2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(child, "child");
        return commonResolve(path, toPath(child, false), z2);
    }

    public static final com.applovin.shadow.okio.Path commonResolve(com.applovin.shadow.okio.Path path, com.applovin.shadow.okio.Path child, boolean z2) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(child, "child");
