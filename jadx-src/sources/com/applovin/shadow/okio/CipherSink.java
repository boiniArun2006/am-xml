...
public final class CipherSink implements Sink {
    ...
    private final int update(Buffer source, long remaining) throws IOException, ShortBufferException {
        ...
        Segment segmentWritableSegment$okio = buffer.writableSegment$okio(outputSize);
        int iUpdate = this.cipher.update(segment.data, segment.pos, i2, segmentWritableSegment$okio.data, segmentWritableSegment$okio.limit);
        ...
        source.setSize$okio(source.size() - ((long) i2));
        int i5 = segment.pos + i2;
        segment.pos = i5;
        if (i5 == segment.limit) {
