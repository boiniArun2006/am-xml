...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\u0015\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\b\u0018\u0000 \u00152\b\u0012\u0004\u0012\u00020\u00020\u00012\u00060\u0003j\u0002`\u0004:\u0001\u0015B\u001f\b\u0002\u0012\u000e\u0010\u0005\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b¢\u0006\u0002\u0010\tJ\u0011\u0010\u0013\u001a\u00020\u00022\u0006\u0010\u0014\u001a\u00020\u000eH\u0096\u0002R\u001e\u0010\u0005\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0006X\u0080\u0004¢\u0006\n\n\u0002\u0010\f\u001a\u0004\b\n\u0010\u000bR\u0014\u0010\r\u001a\u00020\u000e8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0007\u001a\u00020\bX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u0016"}, d2 = {"Lcom/applovin/shadow/okio/Options;", "Lkotlin/collections/AbstractList;", "Lcom/applovin/shadow/okio/ByteString;", "Ljava/util/RandomAccess;", "Lkotlin/collections/RandomAccess;", "byteStrings", "", "trie", "", "([Lokio/ByteString;[I)V", "getByteStrings$okio", "()[Lokio/ByteString;", "[Lcom/applovin/shadow/okio/ByteString;", "size", "", "getSize", "()I", "getTrie$okio", "()[I", "get", "index", "Companion", "com.applovin.shadow.okio"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        */
        public final Options of(ByteString... byteStrings) throws IOException {
            ...
            int i5 = 0;
            while (i3 < length) {
                listMutableListOf.set(CollectionsKt.binarySearch$default(mutableList, byteStrings[i3], 0, 0, 6, (Object) null), Integer.valueOf(i5));
                i3++;
                i5++;
            }
            ...
            while (i7 < mutableList.size()) {
                ByteString byteString2 = (ByteString) mutableList.get(i7);
                int i8 = i7 + 1;
                int i9 = i8;
                while (i9 < mutableList.size()) {
                    ByteString byteString3 = (ByteString) mutableList.get(i9);
                    if (byteString3.startsWith(byteString2)) {
                        ...
                        if (((Number) listMutableListOf.get(i9)).intValue() > ((Number) listMutableListOf.get(i7)).intValue()) {
                            mutableList.remove(i9);
                            listMutableListOf.remove(i9);
                        } else {
                            i9++;
                        }
                    }
