...
public final class C1820SegmentedByteString extends ByteString {
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        while (offset < i2) {
            ...
            int i5 = getDirectory()[iSegment] - i3;
            int i7 = getDirectory()[getSegments().length + iSegment];
            int iMin = Math.min(i2, i5 + i3) - offset;
            if (!other.rangeEquals(otherOffset, getSegments()[iSegment], i7 + (offset - i3), iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
    ...
    public C1820SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        long j2 = byteCount;
        SegmentedByteString.checkOffsetAndCount(size(), offset, j2);
        SegmentedByteString.checkOffsetAndCount(target.length, targetOffset, j2);
        int i2 = byteCount + offset;
        int iSegment = com.applovin.shadow.okio.internal.SegmentedByteString.segment(this, offset);
        while (offset < i2) {
            int i3 = iSegment == 0 ? 0 : getDirectory()[iSegment - 1];
            ...
            int iMin = Math.min(i2, i5 + i3) - offset;
            int i8 = i7 + (offset - i3);
            ArraysKt.copyInto(getSegments()[iSegment], target, targetOffset, i8, i8 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iSegment++;
        }
    ...
    public ByteString digest$okio(String algorithm) throws NoSuchAlgorithmException {
        ...
        while (i2 < length) {
            ...
            messageDigest.update(getSegments()[i2], i5, i7 - i3);
            i2++;
            i3 = i7;
        }
    ...
    public ByteString hmac$okio(String algorithm, ByteString key) throws NoSuchAlgorithmException {
        ...
        try {
            ...
            while (i2 < length) {
                int i5 = getDirectory()[length + i2];
                int i7 = getDirectory()[i2];
                mac.update(getSegments()[i2], i5, i7 - i3);
                i2++;
                i3 = i7;
            }
    ...
    public void write(OutputStream out) throws IOException {
        ...
        while (i2 < length) {
            int i5 = getDirectory()[length + i2];
            int i7 = getDirectory()[i2];
            out.write(getSegments()[i2], i5, i7 - i3);
            i2++;
            i3 = i7;
        }
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        ...
        while (offset < i2) {
            ...
            int iMin = Math.min(i2, i5 + i3) - offset;
            int i8 = i7 + (offset - i3);
            Segment segment = new Segment(getSegments()[iSegment], i8, i8 + iMin, true, false);
    ...
    public byte internalGet$okio(int pos) {
        ...
        if (iSegment == 0) {
            ...
            i2 = getDirectory()[iSegment - 1];
        }
        return getSegments()[iSegment][(pos - i2) + getDirectory()[getSegments().length + iSegment]];
    }
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        if (beginIndex >= 0) {
            if (iResolveDefaultParameter <= size()) {
                int i2 = iResolveDefaultParameter - beginIndex;
                if (i2 >= 0) {
                    ...
                    if (iSegment <= iSegment2) {
                        ...
                        int i7 = 0;
                        while (true) {
                            iArr[i7] = Math.min(getDirectory()[i5] - beginIndex, i2);
                            int i8 = i7 + 1;
                            iArr[i7 + bArr.length] = getDirectory()[getSegments().length + i5];
                            if (i5 == iSegment2) {
                                break;
                            }
                            i5++;
    ...
    public byte[] toByteArray() {
        ...
        while (i2 < length) {
            ...
            int i8 = getDirectory()[i2];
            int i9 = i8 - i3;
            ArraysKt.copyInto(getSegments()[i2], bArr, i5, i7, i7 + i9);
            i5 += i9;
            i2++;
            i3 = i8;
        }
    ...
    public boolean rangeEquals(int offset, byte[] other, int otherOffset, int byteCount) {
        ...
        while (offset < i2) {
            ...
            int i7 = getDirectory()[getSegments().length + iSegment];
            int iMin = Math.min(i2, i5 + i3) - offset;
            if (!SegmentedByteString.arrayRangeEquals(getSegments()[iSegment], i7 + (offset - i3), other, otherOffset, iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
