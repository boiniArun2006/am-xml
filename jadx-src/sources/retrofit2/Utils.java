...
final class Utils {
    ...
    static RuntimeException parameterError(Method method, Throwable th, int i2, String str, Object... objArr) {
        return methodError(method, th, str + " (" + Platform.reflection.describeMethodParameter(method, i2) + ")", objArr);
    }
    ...
    static RuntimeException parameterError(Method method, int i2, String str, Object... objArr) {
        return methodError(method, str + " (" + Platform.reflection.describeMethodParameter(method, i2) + ")", objArr);
    }
