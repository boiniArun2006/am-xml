    ...
    static final class Builder {
                ...
                for (Annotation annotation : annotationArr) {
                    ...
                    if (parameterAnnotation != null) {
                        if (parameterHandler != null) {
                            throw Utils.parameterError(this.method, i2, FijIa.reFZgkJ, new Object[0]);
                        }
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i2, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (!(annotation instanceof Part)) {
                if (annotation instanceof PartMap) {
                    ...
                    if (String.class == parameterUpperBound4) {
                        ...
                        return new ParameterHandler.PartMap(this.method, i2, this.retrofit.requestBodyConverter(parameterUpperBound5, annotationArr, this.methodAnnotations), ((PartMap) annotation).encoding());
                    }
                    throw Utils.parameterError(this.method, i2, "@PartMap keys must be of type String: " + parameterUpperBound4, new Object[0]);
                }
                ...
                for (int i3 = i2 - 1; i3 >= 0; i3--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType9)) {
                        throw Utils.parameterError(this.method, i2, "@Tag type " + rawType9.getName() + " is duplicate of " + Platform.reflection.describeMethodParameter(this.method, i3) + " and would always overwrite its value.", new Object[0]);
                    }
                }
            ...
            if (strValue5.isEmpty()) {
                ...
                throw Utils.parameterError(this.method, i2, rawType10.getSimpleName() + " must include generic type (e.g., " + rawType10.getSimpleName() + "<String>)", new Object[0]);
            }
            ...
            if (!Iterable.class.isAssignableFrom(rawType10)) {
                ...
                Class<?> clsBoxIfPrimitive = boxIfPrimitive(rawType10.getComponentType());
            ...
            if (type instanceof ParameterizedType) {
                ...
                return new ParameterHandler.Part(this.method, i2, headersOf, this.retrofit.requestBodyConverter(parameterUpperBound6, annotationArr, this.methodAnnotations)).iterable();
            }
            throw Utils.parameterError(this.method, i2, rawType10.getSimpleName() + " must include generic type (e.g., " + rawType10.getSimpleName() + "<String>)", new Object[0]);
        }
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof PUT) {
                parseHttpMethodAndPath(g.f61256f, ((PUT) annotation).value(), true);
                return;
            }
