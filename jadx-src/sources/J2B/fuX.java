...
public class fuX {
    ...
    private static fuX f4427n = new fuX();

    class j implements Runnable {

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        final /* synthetic */ WebView f4429n;

        /* JADX INFO: renamed from: t, reason: collision with root package name */
        final /* synthetic */ String f4430t;
        ...
        public void run() {
            fuX.this.ck(this.f4429n, this.f4430t);
        }
    }
    ...
    public boolean ck(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                upM.Ml.t("Unable to inject javascript: " + e2.getMessage());
            }
        }
        return false;
    }
    ...
    void KN(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            upM.Ml.n("The WebView is null for " + str);
            return;
        }
