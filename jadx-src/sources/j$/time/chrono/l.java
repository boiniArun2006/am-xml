...
public final class l extends AbstractC2181a implements Serializable {

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final l f68962n;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private volatile transient boolean f68963e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private transient int[] f68964f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private transient int f68965g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private transient int f68966h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private transient int f68967i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private transient int f68968j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private transient int f68969k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private transient int f68970l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private transient int f68971m;

    static {
        l lVar = new l();
        f68962n = lVar;
        AbstractC2181a.L(lVar, "Hijrah");
        AbstractC2181a.L(lVar, "islamic");
    }
    ...
    private void e0() {
        ...
        try {
            ...
            this.f68967i = 15600;
            this.f68965g = epochDay;
            int[] iArrG0 = g0(epochDay, map);
            this.f68964f = iArrG0;
            this.f68966h = iArrG0[3612];
            for (int i3 = 1300; i3 < 1600; i3++) {
                int iO0 = o0(i3, 12);
                this.f68970l = Math.min(this.f68970l, iO0);
                this.f68971m = Math.max(this.f68971m, iO0);
            }
            this.f68963e = true;
        } catch (Exception e2) {
            throw new DateTimeException("Unable to initialize HijrahCalendar: Hijrah-umalqura", e2);
        }
    }
    ...
    public final ChronoLocalDate P() {
        return n.d0(this, LocalDate.f0(Clock.b()).h(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final ChronoLocalDate v(TemporalAccessor temporalAccessor) {
        ...
        return n.d0(this, temporalAccessor.h(j$.time.temporal.a.EPOCH_DAY));
    }

    @Override // j$.time.chrono.Chronology
    public final boolean E(long j2) {
        e0();
        return j2 >= ((long) h0(0)) && j2 <= ((long) (h0(this.f68964f.length - 1) - 1)) && o0((int) j2, 12) > 354;
    }
    ...
    public final j$.time.temporal.s Z(j$.time.temporal.a aVar) {
        e0();
        if (aVar != null) {
            switch (k.f68961a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.s.k(1L, this.f68968j, this.f68969k);
                case 2:
                    return j$.time.temporal.s.j(1L, this.f68971m);
                case 3:
                    return j$.time.temporal.s.j(1L, 5L);
                case 4:
                case 5:
                    return j$.time.temporal.s.j(h0(0), h0(this.f68964f.length - 1) - 1);
                case 6:
    ...
    public final ChronoLocalDate U(Map map, j$.time.format.D d2) {
        return (n) super.U(map, d2);
    }

    final int[] k0(int i2) {
        e0();
        if (i2 < this.f68965g || i2 >= this.f68966h) {
            throw new DateTimeException("Hijrah date out of range");
        }
        int iBinarySearch = Arrays.binarySearch(this.f68964f, i2);
        if (iBinarySearch < 0) {
            iBinarySearch = (-iBinarySearch) - 2;
        }
        return new int[]{h0(iBinarySearch), ((this.f68967i + iBinarySearch) % 12) + 1, (i2 - this.f68964f[iBinarySearch]) + 1};
    }

    final long j0(int i2, int i3, int i5) {
        e0();
        if (i3 < 1 || i3 > 12) {
            throw new DateTimeException("Invalid Hijrah month: " + i3);
        }
        int i7 = (i3 - 1) + ((i2 * 12) - this.f68967i);
        if (i7 < 0 || i7 >= this.f68964f.length) {
            throw new DateTimeException("Invalid Hijrah date, year: " + i2 + ", month: " + i3);
        }
        if (i5 < 1 || i5 > l0(i2, i3)) {
            throw new DateTimeException("Invalid Hijrah day of month: " + i5);
        }
        return (i5 - 1) + this.f68964f[i7];
    }

    final int i0(int i2, int i3) {
        return o0(i2, i3 - 1);
    }
    ...
    final int f0(long j2) {
        if (j2 >= h0(0) && j2 <= h0(this.f68964f.length - 1) - 1) {
            return (int) j2;
        }
    ...
    private int h0(int i2) {
        return (i2 + this.f68967i) / 12;
    }

    private int o0(int i2, int i3) {
        int i5 = (i2 * 12) - this.f68967i;
        int[] iArr = this.f68964f;
        return iArr[i3 + i5] - iArr[i5];
    }

    final int l0(int i2, int i3) {
        int i5 = (i3 - 1) + ((i2 * 12) - this.f68967i);
        if (i5 >= 0) {
            int[] iArr = this.f68964f;
            if (i5 < iArr.length) {
    ...
    private int[] g0(int i2, HashMap map) {
        int[] iArr = new int[3613];
        this.f68968j = Integer.MAX_VALUE;
        this.f68969k = Integer.MIN_VALUE;
        int i3 = 0;
        for (int i5 = 1300; i5 <= 1600; i5++) {
            int[] iArr2 = (int[]) map.get(Integer.valueOf(i5));
            int i7 = 0;
            while (i7 < 12) {
                int i8 = iArr2[i7];
                int i9 = i3 + 1;
                ...
                i2 += i8;
                this.f68968j = Math.min(this.f68968j, i8);
                this.f68969k = Math.max(this.f68969k, i8);
                i7++;
                i3 = i9;
            }
        }
