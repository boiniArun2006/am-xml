...
public final class w6 {
    ...
    private final int f1061n;
    private final int nr;
    private final int[] rl;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private final n[] f1062t;

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    private static final int[] f1060O = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};
    private static final w6[] J2 = n();

    public static final class j {

        /* JADX INFO: renamed from: n, reason: collision with root package name */
        private final int f1063n;
        private final int rl;
    ...
    public int rl() {
        return (this.f1061n * 4) + 17;
    }

    public n t(Cwp.j jVar) {
        return this.f1062t[jVar.ordinal()];
    }

    public String toString() {
        return String.valueOf(this.f1061n);
    }
