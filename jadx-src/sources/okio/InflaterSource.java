...
public final class InflaterSource implements Source {
    ...
    public final boolean refill() throws IOException {
        ...
        int i3 = segment.pos;
        int i5 = i2 - i3;
        this.bufferBytesHeldByInflater = i5;
        this.inflater.setInput(segment.data, i3, i5);
        return false;
    }
