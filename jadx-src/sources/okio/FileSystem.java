...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m1937write$default(FileSystem fileSystem, Path file, boolean z2, Function1 writerAction, int i2, Object obj) throws IOException {
        ?? r42;
        if (obj != null) {
    ...
    public final <T> T m1938read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        ?? r52;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m1939write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        ?? r52;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
