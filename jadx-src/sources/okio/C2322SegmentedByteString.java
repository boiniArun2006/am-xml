...
public final class C2322SegmentedByteString extends ByteString {
    ...
    public C2322SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        Intrinsics.checkNotNullParameter(buffer, yioUaKMByL.rQiVPsqecJ);
