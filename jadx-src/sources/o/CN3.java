...
public abstract class CN3 {
    ...
    */
    public static final void t(final Function0 onCloseIconClicked, Modifier modifier, PaddingValues paddingValues, Composer composer, final int i2, final int i3) {
        int i5;
        Modifier modifier2;
        int i7;
        ...
        Composer composerKN = composer.KN(985729067);
        if ((i3 & 1) != 0) {
            i5 = i2 | 6;
        } else if ((i2 & 6) == 0) {
            i5 = (composerKN.E2(onCloseIconClicked) ? 4 : 2) | i2;
        } else {
            i5 = i2;
        }
        int i8 = i3 & 2;
        if (i8 != 0) {
            ...
            if (i7 != 0) {
                ...
                if ((i5 & 147) == 146 && composerKN.xMQ()) {
                    ...
                    if (ComposerKt.v()) {
                        ComposerKt.p5(985729067, i5, -1, "com.alightcreative.monetization.ui.components.buttons.PaywallCloseIcon (PaywallCloseIcon.kt:20)");
                    }
                    ...
                    Modifier modifierN = BoxScopeInstance.f17448n.n(modifier4, companion2.HI());
                    composerKN.eF(-1815401751);
                    z2 = (i5 & 14) != 4;
                    objIF = composerKN.iF();
                    if (!z2 || objIF == Composer.INSTANCE.n()) {
                        objIF = new Function0() { // from class: o.I28
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                return CN3.nr(onCloseIconClicked);
                            }
                        };
                        composerKN.o(objIF);
                    }
                    ...
                    ImageKt.n(PainterResources_androidKt.t(2131231542, composerKN, 6), null, PaddingKt.KN(companion, paddingValuesN), null, null, 0.0f, null, composerKN, 48, b.f61769v);
                    composerKN.XQ();
                    composerKN.XQ();
                    if (ComposerKt.v()) {
                        ComposerKt.M7();
                ...
                if (scopeUpdateScopeGh != null) {
                    scopeUpdateScopeGh.n(new Function2() { // from class: o.Wre
                        @Override // kotlin.jvm.functions.Function2
                        public final Object invoke(Object obj, Object obj2) {
                            return CN3.O(onCloseIconClicked, modifier3, paddingValues3, i2, i3, (Composer) obj, ((Integer) obj2).intValue());
                        }
                    });
                    return;
                }
            ...
            if ((i5 & 147) == 146) {
                ...
                if (!composerN.getInserting()) {
                    ...
                    Modifier modifierN2 = BoxScopeInstance.f17448n.n(modifier4, companion22.HI());
                    composerKN.eF(-1815401751);
                    if ((i5 & 14) != 4) {
                    }
                    objIF = composerKN.iF();
                    if (!z2) {
                        ...
                        if (!composerN2.getInserting()) {
                            ...
                            ImageKt.n(PainterResources_androidKt.t(2131231542, composerKN, 6), null, PaddingKt.KN(companion4, paddingValuesN), null, null, 0.0f, null, composerKN, 48, b.f61769v);
                            composerKN.XQ();
                            composerKN.XQ();
                            if (ComposerKt.v()) {
                            }
